"""
Bamboohr Api MCP Server - Pydantic Models
...
__all__ = [
    ...
    "GetCompanyProfileIntegrationsRequest",
    "GetCountriesOptionsRequest",
    "GetDataFromDatasetRequest",
    "GetDatasetsRequest",
    "GetDatasetsV12Request",
    ...
    "ListMemberBenefitEventsRequest",
    "ListReportsRequest",
    "ListTabularFieldsRequest",
    "ListTimeOffPoliciesRequest",
    "ListTimeOffRequestsRequest",
    "ListTimeOffTypesRequest",
    "ListTimesheetEntriesRequest",
    "ListTrainingCategoriesRequest",
    "ListTrainingTypesRequest",
    "ListUsersRequest",
    "ListWebhooksRequest",
    "ListWhosOutRequest",
...
class ListWebhooksRequest(StrictModel):
...
class CreateWebhookRequestBody(StrictModel):
    name: str = Field(default=..., description="A human-readable display name for the webhook, used to identify it in the BambooHR interface.")
    monitor_fields: list[str] | None = Field(default=None, validation_alias="monitorFields", serialization_alias="monitorFields", description="List of employee field IDs or aliases to watch for changes. Required when `events` includes `employee.updated` or `employee_with_fields.updated`, or when `events` is omitted entirely (since the default event set includes `employee_with_fields.updated`). At least one field must be provided in those cases.")
    post_fields: dict[str, Any] | None = Field(default=None, validation_alias="postFields", serialization_alias="postFields", description="A mapping of employee field IDs or aliases to the corresponding key names that will appear in the webhook payload body. Omit or send an empty object to exclude additional field data from payloads.")
    url: str = Field(default=..., description="The HTTPS destination URL where webhook payloads will be delivered. Must begin with `https://`.")
    format_: Literal["json", "form-encoded"] = Field(default=..., validation_alias="format", serialization_alias="format", description="The serialization format for webhook payloads sent to the destination URL. Must be either `json` or `form-encoded`.")
    include_company_domain: bool | None = Field(default=None, validation_alias="includeCompanyDomain", serialization_alias="includeCompanyDomain", description="When `true`, the company's BambooHR domain is appended to the webhook request header, useful for identifying the source tenant in multi-company integrations.")
    events: list[Literal["employee_with_fields.updated", "employee_with_fields.created", "employee_with_fields.deleted", "company-integrations.updated", "employee.created", "employee.updated", "employee.deleted", "company.updated", "company.deleted"]] | None = Field(default=None, description="List of event types that trigger this webhook. Defaults to `['employee_with_fields.updated', 'employee_with_fields.deleted', 'employee_with_fields.created']` if omitted. `employee_with_fields.*` events and `employee.*` events cannot be mixed in the same webhook.")
...
class UpdateWebhookRequestPath(StrictModel):
    id_: int = Field(default=..., validation_alias="id", serialization_alias="id", description="The unique numeric identifier of the webhook to update.")
class UpdateWebhookRequestBody(StrictModel):
    name: str = Field(default=..., description="A human-readable label for the webhook used for identification purposes.")
    monitor_fields: list[str] | None = Field(default=None, validation_alias="monitorFields", serialization_alias="monitorFields", description="List of employee field identifiers to watch for changes. Required when events includes employee.updated or employee_with_fields.updated; at least one field must be specified in those cases. Order is not significant.")
    post_fields: dict[str, Any] | None = Field(default=None, validation_alias="postFields", serialization_alias="postFields", description="A mapping of BambooHR field IDs or aliases to the corresponding key names that will appear in the outgoing webhook payload. Send an empty object or omit entirely to exclude additional fields from the payload.")
    url: str = Field(default=..., description="The destination URL that will receive webhook POST requests. Must begin with https://.")
    format_: Literal["json", "form-encoded"] = Field(default=..., validation_alias="format", serialization_alias="format", description="The serialization format used for the outgoing webhook payload. Must be either json or form-encoded.")
    include_company_domain: bool | None = Field(default=None, validation_alias="includeCompanyDomain", serialization_alias="includeCompanyDomain", description="When true, the company's BambooHR domain is appended to the webhook request header for identification.")
...
# Operation: list_webhook_monitor_fields
class GetMonitorFieldsRequest(StrictModel):
...
# Operation: list_webhook_post_fields
class GetPostFieldsRequest(StrictModel):
...
class GetDatasetsRequest(StrictModel):
...
# Operation: list_datasets_v1_2
class GetDatasetsV12Request(StrictModel):
...
# Operation: list_applicant_statuses
class GetStatusesRequest(StrictModel):
...
# Operation: list_job_locations
class GetCompanyLocationsRequest(StrictModel):
...
# Operation: list_hiring_leads
class GetHiringLeadsRequest(StrictModel):
...
# Operation: list_company_benefits
class ListCompanyBenefitsRequest(StrictModel):
...
# Operation: list_member_benefit_events
class ListMemberBenefitEventsRequest(StrictModel):
...
# Operation: list_benefit_deduction_types
class ListBenefitDeductionTypesRequest(StrictModel):
...
class GetCompanyInformationRequest(StrictModel):
...
# Operation: list_enabled_integrations
class GetCompanyProfileIntegrationsRequest(StrictModel):
...
# Operation: check_goal_creation_permission
class GetGoalCreationPermissionRequestPath(StrictModel):
    employee_id: str = Field(default=..., validation_alias="employeeId", serialization_alias="employeeId", description="The unique identifier of the employee for whom goal creation permission is being checked.")
class GetGoalCreationPermissionRequest(StrictModel):
    ...
    path: GetGoalCreationPermissionRequestPath
...
class GetCountriesOptionsRequest(StrictModel):
...
# Operation: list_employee_fields
class ListFieldsRequest(StrictModel):
...
# Operation: list_benefit_coverages
class ListBenefitCoveragesRequest(StrictModel):
...
# Operation: list_company_files
class ListCompanyFilesRequest(StrictModel):
...
# Operation: list_tabular_fields
class ListTabularFieldsRequest(StrictModel):
...
# Operation: list_time_off_policies
class ListTimeOffPoliciesRequest(StrictModel):
...
# Operation: list_training_types
class ListTrainingTypesRequest(StrictModel):
...
# Operation: list_training_categories
class ListTrainingCategoriesRequest(StrictModel):
