...
"""
BambooHR MCP Server
Generated: 2026-04-09 17:15:03 UTC
...
try:
    _auth_handlers["RegistrationAccessToken"] = _auth.BearerTokenAuth(env_var="BEARER_TOKEN", token_format="Bearer")
    logging.info("Authentication configured: RegistrationAccessToken")
except ValueError as e:
    # Extract credential names from error message (first sentence before "Leave empty")
    error_msg = str(e).split("Leave empty")[0].strip()
    logging.warning(f"Credentials for RegistrationAccessToken not configured: {error_msg}")
    _auth_handlers["RegistrationAccessToken"] = None
try:
...
try:
    _auth_handlers["Api7RegistrationKey"] = _auth.APIKeyAuth(env_var="API_KEY", location="header", param_name="X-API7-REGISTRATION-KEY")
    logging.info("Authentication configured: Api7RegistrationKey")
except ValueError as e:
    # Extract credential names from error message (first sentence before "Leave empty")
    error_msg = str(e).split("Leave empty")[0].strip()
    logging.warning(f"Credentials for Api7RegistrationKey not configured: {error_msg}")
    _auth_handlers["Api7RegistrationKey"] = None
...
# Tags: Time Tracking, Public API
@mcp.tool()
async def get_break(id_: str = Field(..., alias="id", description="The unique identifier of the time tracking break to retrieve, provided as a UUID.")) -> dict[str, Any]:
...
# Tags: Time Tracking, Public API
@mcp.tool()
async def delete_break(id_: str = Field(..., alias="id", description="The unique identifier of the break to delete, provided as a UUID.")) -> dict[str, Any]:
...
# Tags: Time Tracking, Public API
@mcp.tool()
async def delete_break_policy(id_: str = Field(..., alias="id", description="The unique identifier of the break policy to delete, provided as a UUID.")) -> dict[str, Any]:
...
# Tags: Time Tracking, Public API
@mcp.tool()
async def delete_clock_entries(clock_entry_ids: list[int] = Field(..., alias="clockEntryIds", description="List of one or more clock entry IDs to delete. At least one ID must be provided; order does not matter.", min_length=1)) -> dict[str, Any]:
...
# Tags: Time Tracking, Public API
@mcp.tool()
async def delete_hour_entries(hour_entry_ids: list[int] = Field(..., alias="hourEntryIds", description="List of one or more timesheet hour entry IDs to delete. At least one ID must be provided; order does not affect the outcome.", min_length=1)) -> dict[str, Any]:
...
# Tags: Time Tracking, Public API
@mcp.tool()
async def bulk_upsert_clock_entries(entries: list[_models.ClockEntrySchema] = Field(..., description="Array of one or more clock entry objects to create or update. Each entry without an ID will be created as a new record; each entry with an existing ID will update the matching record. Must contain at least one entry.", min_length=1)) -> dict[str, Any]:
...
# Tags: Time Tracking, Public API
@mcp.tool()
async def bulk_upsert_timesheet_entries(hours: list[_models.HourEntrySchema] = Field(..., description="Array of hour entry objects to create or update. Each entry without an ID will be created as a new record; each entry with an existing ID will update the matching record. Order is not significant.")) -> dict[str, Any]:
...
# Tags: Webhooks, Public API
@mcp.tool()
async def get_webhook(id_: int = Field(..., alias="id", description="The unique numeric identifier of the webhook to retrieve.")) -> dict[str, Any]:
...
# Tags: Webhooks, Public API
@mcp.tool()
async def delete_webhook(id_: int = Field(..., alias="id", description="The unique numeric identifier of the webhook to delete. Must correspond to a webhook owned by the authenticated API key.")) -> dict[str, Any]:
...
# Tags: Webhooks, Public API
@mcp.tool()
async def list_webhook_logs(id_: int = Field(..., alias="id", description="The unique numeric identifier of the webhook whose delivery logs should be retrieved.")) -> dict[str, Any]:
...
# Tags: Webhooks, Public API
@mcp.tool()
async def list_webhook_monitor_fields() -> dict[str, Any]:
...
# Tags: Webhooks, Public API
@mcp.tool()
async def list_webhook_post_fields() -> dict[str, Any]:
...
# Tags: Datasets, Public API
@mcp.tool()
async def list_datasets_v1_2() -> dict[str, Any]:
...
# Tags: Public API, Applicant Tracking
@mcp.tool()
async def list_applicant_statuses() -> dict[str, Any]:
...
# Tags: Public API, Applicant Tracking
@mcp.tool()
async def list_job_locations() -> dict[str, Any]:
...
# Tags: Public API, Applicant Tracking
@mcp.tool()
async def list_hiring_leads() -> dict[str, Any]:
...
@mcp.tool()
async def list_company_benefits() -> dict[str, Any]:
...
# Tags: Benefits, Public API
@mcp.tool()
async def list_member_benefit_events() -> dict[str, Any]:
...
# Tags: Benefits, Public API
@mcp.tool()
async def list_benefit_deduction_types() -> dict[str, Any]:
...
@mcp.tool()
async def list_enabled_integrations() -> dict[str, Any]:
...
@mcp.tool()
async def download_company_file(file_id: int = Field(..., alias="fileId", description="The unique identifier of the company file to download.")) -> dict[str, Any]:
...
# Tags: Company Files, Public API
@mcp.tool()
async def delete_company_file(file_id: int = Field(..., alias="fileId", description="The unique numeric identifier of the company file to delete. Must correspond to an existing file the caller has write access to.")) -> dict[str, Any]:
...
# Tags: Goals, Public API
@mcp.tool()
async def get_goal_filters(employee_id: int = Field(..., alias="employeeId", description="The unique identifier of the employee whose goal filter counts should be retrieved.")) -> dict[str, Any]:
...
@mcp.tool()
async def get_time_tracking_record(id_: str = Field(..., alias="id", description="The unique identifier of the time tracking record to retrieve, as assigned when the record was originally created.")) -> dict[str, Any]:
...
# Tags: Public API, Hours
@mcp.tool()
async def upsert_hour_records(body: list[_models.TimeTrackingRecord] | None = Field(None, description="Array of hour record objects to create or update; each item should include the relevant time tracking fields. Order is not significant, but each item's result is returned individually so partial failures can be identified per record.")) -> dict[str, Any]:
...
# Tags: Public API, Hours
@mcp.tool()
async def delete_time_tracking_record(id_: str = Field(..., alias="id", description="The unique identifier of the time tracking record to delete, up to 36 characters in length (e.g., a UUID). Both not-found and malformed ID values will return a 400 error.")) -> dict[str, Any]:
...
@mcp.tool()
async def list_country_states(country_id: int = Field(..., alias="countryId", description="The numeric ID of the country whose states or provinces to retrieve. Obtain valid country IDs from the list_countries operation.")) -> dict[str, Any]:
...
# Tags: Account Information, Public API
@mcp.tool()
async def list_employee_fields() -> dict[str, Any]:
...
# Tags: Account Information, Public API
@mcp.tool()
async def list_users(status: str | None = Field(None, description="Comma-separated list of account statuses to filter results by; only users matching at least one of the provided statuses are returned. Omitting this parameter or providing no recognized values returns users of all statuses.")) -> dict[str, Any]:
...
# Tags: Employee Files, Public API
@mcp.tool()
async def create_employee_file_categories(body: list[str] | None = Field(None, description="A list of category name strings to create. Each name must be non-empty and must not already exist. Order is not significant.")) -> dict[str, Any]:
...
# Tags: Company Files, Public API
@mcp.tool()
async def create_file_categories(body: list[str] | None = Field(None, description="An array of category name strings to create. Each entry must be a non-empty, unique name that is not reserved. Order is not significant.")) -> dict[str, Any]:
...
@mcp.tool()
async def list_employee_time_off_policies(employee_id: int = Field(..., alias="employeeId", description="The unique identifier of the employee whose assigned time off policies should be retrieved.")) -> dict[str, Any]:
...
# Tags: Time Off, Public API
@mcp.tool()
async def list_employee_time_off_policies_extended(employee_id: int = Field(..., alias="employeeId", description="The unique identifier of the employee whose time off policies should be retrieved.")) -> dict[str, Any]:
...
# Tags: Public API, Applicant Tracking
@mcp.tool()
async def get_application(application_id: int = Field(..., alias="applicationId", description="The unique identifier of the job application to retrieve.")) -> dict[str, Any]:
...
# Tags: Benefits, Public API
@mcp.tool()
async def list_benefit_coverages() -> dict[str, Any]:
...
# Tags: Benefits, Public API
@mcp.tool()
async def get_employee_dependent(id_: int = Field(..., alias="id", description="The unique numeric identifier of the employee dependent record to retrieve.")) -> dict[str, Any]:
...
# Tags: Benefits, Public API
@mcp.tool()
async def list_employee_dependents(employeeid: int | None = Field(None, description="Filters the results to dependents belonging to a specific employee. When omitted, dependents for all employees in the company are returned.")) -> dict[str, Any]:
...
# Tags: Employees, Public API
@mcp.tool()
async def get_employee_directory(only_current: bool | None = Field(None, alias="onlyCurrent", description="Controls whether only active employees are returned. Set to false to include terminated employees alongside active ones.")) -> dict[str, Any]:
...
# Tags: Company Files, Public API
@mcp.tool()
async def list_company_files() -> dict[str, Any]:
...
# Tags: Employee Files, Public API
@mcp.tool()
async def list_employee_files(id_: int = Field(..., alias="id", description="The unique identifier of the employee whose files are being listed. Only files and categories the caller is permitted to view will be returned.")) -> dict[str, Any]:
...
# Tags: Account Information, Public API
@mcp.tool()
async def list_list_fields(format_: Literal["json"] | None = Field(None, alias="format", description="Specifies the response format as JSON, serving as an alternative to setting the Accept header on the request.")) -> dict[str, Any]:
...
# Tags: Account Information, Public API
@mcp.tool()
async def list_tabular_fields() -> dict[str, Any]:
...
# Tags: Time Off, Public API
@mcp.tool()
async def list_time_off_policies() -> dict[str, Any]:
...
# Tags: Time Off, Public API
@mcp.tool()
async def list_time_off_types(mode: Literal["request"] | None = Field(None, description="Controls filtering of returned time off types. When set to 'request', results are limited to only the types the authenticated employee has permission to request.")) -> dict[str, Any]:
...
# Tags: Training, Public API
@mcp.tool()
async def delete_training_type(training_type_id: int = Field(..., alias="trainingTypeId", description="The unique numeric identifier of the training type to delete. All associated employee trainings must be removed before this operation can succeed.")) -> dict[str, Any]:
...
# Tags: Training, Public API
@mcp.tool()
async def list_training_categories() -> dict[str, Any]:
...
# Tags: Training, Public API
@mcp.tool()
async def create_training_category(name: str = Field(..., description="The display name for the new training category, used to identify and organize training content.")) -> dict[str, Any]:
...
# Tags: Training, Public API
@mcp.tool()
async def delete_training_category(training_category_id: int = Field(..., alias="trainingCategoryId", description="The unique identifier of the training category to delete.")) -> dict[str, Any]:
...
# Tags: Training, Public API
@mcp.tool()
async def delete_training_record(employee_training_record_id: int = Field(..., alias="employeeTrainingRecordId", description="The unique identifier of the employee training record to delete.")) -> dict[str, Any]:
