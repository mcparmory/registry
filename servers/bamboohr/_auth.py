...
class OAuth2Auth:
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://{companyDomain}.bamboohr.com/token.php")
        self.auth_url = self._resolve_url_template("https://{companyDomain}.bamboohr.com/authorize.php")
