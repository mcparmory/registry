"""
Authentication module for AgentQL API MCP server.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    ...
    "get_usage_v1_usage_get": [["APIKeyHeader"]],
    "create_browser_session_v1": [["APIKeyHeader"]],
    "list_session_usage_v1": [["APIKeyHeader"]],
    "query_webpage_data_legacy": [["APIKeyHeader"]],
    "get_usage_usage_get": [["APIKeyHeader"]],
