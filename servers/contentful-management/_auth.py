"""
Authentication module for CMA - Contentful Management API MCP server.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    ...
    "list_editor_interfaces": [["bearerAuth"]],
    "get_editor_interface": [["bearerAuth"]],
    "update_editor_interface": [["bearerAuth"]],
    "list_extensions": [["bearerAuth"]],
    "create_extension": [["bearerAuth"]],
    ...
    "create_access_token": [["bearerAuth"]],
    ...
    "create_app_definition": [["bearerAuth"]],
    "get_app_definition": [["bearerAuth"]],
    "update_app_definition": [["bearerAuth"]],
    "delete_app_definition": [["bearerAuth"]],
    "get_app_upload": [["bearerAuth"]],
    "create_app_upload": [["bearerAuth"]],
    "list_app_bundles": [["bearerAuth"]],
    "create_app_bundle": [["bearerAuth"]],
    "get_app_bundle": [["bearerAuth"]],
    "delete_app_bundle": [["bearerAuth"]],
    "get_app_event_subscription": [["bearerAuth"]],
    "update_app_event_subscription": [["bearerAuth"]],
    "delete_app_event_subscription": [["bearerAuth"]],
    "get_app_signing_secret": [["bearerAuth"]],
    "set_app_signing_secret": [["bearerAuth"]],
    "revoke_app_signing_secret": [["bearerAuth"]],
    "create_app_signed_request": [["bearerAuth"]],
    "list_app_keys": [["bearerAuth"]],
    "create_app_key": [["bearerAuth"]],
    "get_app_key": [["bearerAuth"]],
    "delete_app_key": [["bearerAuth"]],
    "list_app_installations": [["bearerAuth"]],
    "get_app_installation": [["bearerAuth"]],
    "install_app": [["bearerAuth"]],
