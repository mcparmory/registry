...
Generated: 2026-03-26 20:12:24 UTC
...
async def list_access_requests(
    target: str = Field(..., description="The globally unique identifier of the target object for which to retrieve pending access requests.", examples=['1331']),
    user: str | None = Field(None, description="Filters results to access requests submitted by a specific user. Accepts the literal string 'me' for the authenticated user, a user's email address, or a user's globally unique identifier.", examples=['me'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_access_requests", "GET", "/access_requests", _request_id)
    ...
    _auth = _get_auth_for_operation("list_access_requests")
...
async def request_access(
    target: str = Field(..., description="The unique global ID (gid) of the private object you are requesting access to. Supports projects and portfolios.", examples=['12345']),
    message: str | None = Field(None, description="An optional message to accompany the access request, allowing the requester to provide context or justification for why access is needed.", examples=["I'm looking to request access to this item."])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("request_access", "POST", "/access_requests", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("request_access")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Access requests
@mcp.tool()
async def approve_access_request(access_request_gid: str = Field(..., description="The globally unique identifier of the access request to approve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("approve_access_request", "POST", "/access_requests/{access_request_gid}/approve", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("approve_access_request")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Access requests
@mcp.tool()
async def reject_access_request(access_request_gid: str = Field(..., description="The globally unique identifier of the access request to reject.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("reject_access_request", "POST", "/access_requests/{access_request_gid}/reject", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("reject_access_request")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Allocations
@mcp.tool()
async def get_allocation(allocation_gid: str = Field(..., description="The globally unique identifier for the allocation you want to retrieve.", examples=['77688'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_allocation", "GET", "/allocations/{allocation_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_allocation")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_allocation(
    allocation_gid: str = Field(..., description="The globally unique identifier of the allocation to update.", examples=['77688']),
    ...
    # Log invocation
    _log_tool_invocation("update_allocation", "PUT", "/allocations/{allocation_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_allocation")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Allocations
@mcp.tool()
async def delete_allocation(allocation_gid: str = Field(..., description="The globally unique identifier of the allocation to delete.", examples=['77688'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_allocation", "DELETE", "/allocations/{allocation_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_allocation")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_allocations(
    parent: str | None = Field(None, description="The unique identifier of the project to filter allocations by, returning only allocations associated with that project.", examples=['77688']),
    assignee: str | None = Field(None, description="The unique identifier of the user or placeholder to filter allocations by, returning only allocations assigned to that individual or placeholder resource.", examples=['12345']),
    workspace: str | None = Field(None, description="The unique identifier of the workspace to scope the allocation results to, limiting results to allocations within that workspace.", examples=['98765'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_allocations", "GET", "/allocations", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_allocations")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_allocation(data: _models.CreateAllocationBodyData | None = Field(None, description="The allocation data to create, including all relevant fields for the new allocation record.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_allocation", "POST", "/allocations", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_allocation")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Attachments
@mcp.tool()
async def get_attachment(attachment_gid: str = Field(..., description="The globally unique identifier of the attachment to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_attachment", "GET", "/attachments/{attachment_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_attachment")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Attachments
@mcp.tool()
async def delete_attachment(attachment_gid: str = Field(..., description="The globally unique identifier (GID) of the attachment to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_attachment", "DELETE", "/attachments/{attachment_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_attachment")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Attachments
@mcp.tool()
async def list_attachments(parent: str = Field(..., description="The globally unique identifier (GID) of the parent object whose attachments you want to retrieve. Must reference a project, project brief, or task.", examples=['159874'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_attachments", "GET", "/attachments", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_attachments")
    _http_headers.update(_auth.get("headers", {}))
...
async def upload_attachment(
    resource_subtype: Literal["asana", "external"] | None = Field(None, description="Specifies the attachment type. Use 'asana' for direct file uploads or 'external' for linking an external URL resource. When set to 'external', the 'parent', 'name', and 'url' fields are also required.", examples=['external']),
    file_: str | None = Field(None, alias="file", description="The binary file content to upload. Required when 'resource_subtype' is 'asana' (direct file upload). Files from third-party services such as Dropbox, Box, Vimeo, or Google Drive cannot be attached via the API.", json_schema_extra={'format': 'binary'}),
    ...
    # Log invocation
    _log_tool_invocation("upload_attachment", "POST", "/attachments", _request_id)
...
async def list_audit_log_events(
    workspace_gid: str = Field(..., description="The globally unique identifier for the workspace or organization whose audit log events you want to retrieve.", examples=['12345']),
    start_at: str | None = Field(None, description="Restricts results to events created at or after this timestamp. Must be provided in ISO 8601 date-time format. Note that events before October 8th, 2021 are not available.", json_schema_extra={'format': 'date-time'}),
    end_at: str | None = Field(None, description="Restricts results to events created strictly before this timestamp (exclusive upper bound). Must be provided in ISO 8601 date-time format.", json_schema_extra={'format': 'date-time'}),
    ...
    limit: int | None = Field(None, description="The number of audit log events to return per page. Must be between 1 and 100 inclusive. Use the offset from the previous response to retrieve the next page of results.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_audit_log_events", "GET", "/workspaces/{workspace_gid}/audit_log_events", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_audit_log_events")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Batch API
@mcp.tool()
async def execute_batch_requests(actions: list[_models.BatchRequestAction] | None = Field(None, description="An array of individual API action objects to execute in parallel, where each item specifies the HTTP method, relative URL, and any request body or query parameters for that sub-request.")) -> dict[str, Any]:
    """Submit multiple API requests to Asana in parallel within a single call, reducing round-trips and improving performance for bulk operations."""

    # Construct request model with validation
    try:
        _request = _models.CreateBatchRequest(
            body=_models.CreateBatchRequestBody(data=_models.CreateBatchRequestBodyData(actions=actions) if any(v is not None for v in [actions]) else None)
        )
    except pydantic.ValidationError as _validation_err:
        logging.error(f"Parameter validation failed for execute_batch_requests: {_validation_err}")
        raise ValueError(f"Invalid parameters: {_validation_err.errors()}") from _validation_err
    ...
    # Log invocation
    _log_tool_invocation("execute_batch_requests", "POST", "/batch", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("execute_batch_requests")
    _http_headers.update(_auth.get("headers", {}))

    # Execute request (returns normalized dict and status code)
    _response_data, _ = await _execute_tool_request(
        tool_name="execute_batch_requests",
        method="POST",
        path=_http_path,
        request_id=_request_id,
        body=_http_body,
...
# Tags: Budgets
@mcp.tool()
async def list_budgets(parent: str = Field(..., description="The globally unique identifier of the parent object whose budgets should be retrieved. Currently only project identifiers are supported as valid parents.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_budgets", "GET", "/budgets", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_budgets")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_budget(data: _models.BudgetRequest | None = Field(None, description="The budget object containing all required fields to define the new budget, such as name, amount, currency, and associated scope or time period.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_budget", "POST", "/budgets", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_budget")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Budgets
@mcp.tool()
async def get_budget(budget_gid: str = Field(..., description="The globally unique identifier of the budget to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_budget", "GET", "/budgets/{budget_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_budget")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_budget(
    budget_gid: str = Field(..., description="The globally unique identifier of the budget to update.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("update_budget", "PUT", "/budgets/{budget_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_budget")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Budgets
@mcp.tool()
async def delete_budget(budget_gid: str = Field(..., description="The globally unique identifier of the budget to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_budget", "DELETE", "/budgets/{budget_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_budget")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_project_custom_field_settings(
    project_gid: str = Field(..., description="The globally unique identifier of the project whose custom field settings you want to retrieve.", examples=['1331']),
    limit: int | None = Field(None, description="The number of custom field settings to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_project_custom_field_settings", "GET", "/projects/{project_gid}/custom_field_settings", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_project_custom_field_settings")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_portfolio_custom_field_settings(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio whose custom field settings you want to retrieve.", examples=['12345']),
    limit: int | None = Field(None, description="The number of custom field setting objects to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_portfolio_custom_field_settings", "GET", "/portfolios/{portfolio_gid}/custom_field_settings", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_portfolio_custom_field_settings")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_goal_custom_field_settings(
    goal_gid: str = Field(..., description="The globally unique identifier of the goal whose custom field settings you want to retrieve.", examples=['12345']),
    limit: int | None = Field(None, description="The number of custom field settings to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_goal_custom_field_settings", "GET", "/goals/{goal_gid}/custom_field_settings", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_goal_custom_field_settings")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Custom field settings
@mcp.tool()
async def list_team_custom_field_settings(team_gid: str = Field(..., description="The globally unique identifier for the team whose custom field settings you want to retrieve.", examples=['159874'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_team_custom_field_settings", "GET", "/teams/{team_gid}/custom_field_settings", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_team_custom_field_settings")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_custom_field(data: _models.CustomFieldCreateRequest | None = Field(None, description="The request body containing the custom field definition, including required properties such as workspace, name, and type (one of: text, enum, multi_enum, number, date, or people).")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_custom_field", "POST", "/custom_fields", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_custom_field")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Custom fields
@mcp.tool()
async def get_custom_field(custom_field_gid: str = Field(..., description="The globally unique identifier of the custom field to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_custom_field", "GET", "/custom_fields/{custom_field_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_custom_field")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_custom_field(
    custom_field_gid: str = Field(..., description="The globally unique identifier of the custom field to update.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("update_custom_field", "PUT", "/custom_fields/{custom_field_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_custom_field")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Custom fields
@mcp.tool()
async def delete_custom_field(custom_field_gid: str = Field(..., description="The globally unique identifier of the custom field to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_custom_field", "DELETE", "/custom_fields/{custom_field_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_custom_field")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_workspace_custom_fields(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization whose custom fields you want to retrieve.", examples=['12345']),
    limit: int | None = Field(None, description="The number of custom field records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_custom_fields", "GET", "/workspaces/{workspace_gid}/custom_fields", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_custom_fields")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_enum_option(
    custom_field_gid: str = Field(..., description="The globally unique identifier of the custom field to which the new enum option will be added.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("create_enum_option", "POST", "/custom_fields/{custom_field_gid}/enum_options", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_enum_option")
    _http_headers.update(_auth.get("headers", {}))
...
async def reorder_enum_option(
    custom_field_gid: str = Field(..., description="The globally unique identifier of the custom field whose enum options are being reordered.", examples=['12345']),
    enum_option: str | None = Field(None, description="The unique identifier of the enum option to move to a new position within the custom field.", examples=['97285']),
    before_enum_option: str | None = Field(None, description="The unique identifier of an existing enum option in this custom field; the target enum option will be inserted immediately before it. Mutually exclusive with after_enum_option.", examples=['12345']),
    after_enum_option: str | None = Field(None, description="The unique identifier of an existing enum option in this custom field; the target enum option will be inserted immediately after it. Mutually exclusive with before_enum_option.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("reorder_enum_option", "POST", "/custom_fields/{custom_field_gid}/enum_options/insert", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("reorder_enum_option")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_enum_option(
    enum_option_gid: str = Field(..., description="The globally unique identifier of the enum option to update.", examples=['124578']),
    name: str | None = Field(None, description="The display name of the enum option as it appears in the custom field.", examples=['Low']),
    enabled: bool | None = Field(None, description="Controls whether this enum option is selectable by users on the custom field. At least one option must remain enabled on the field.", examples=[True]),
    color: str | None = Field(None, description="The color associated with the enum option for visual identification. Defaults to none if not specified.", examples=['blue'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_enum_option", "PUT", "/enum_options/{enum_option_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_enum_option")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_custom_types(
    project: str = Field(..., description="The globally unique identifier of the project whose associated custom types you want to retrieve.", examples=['1331']),
    limit: int | None = Field(None, description="The number of custom types to return per page. Accepts values between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_custom_types", "GET", "/custom_types", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_custom_types")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Custom types
@mcp.tool()
async def get_custom_type(custom_type_gid: str = Field(..., description="The globally unique identifier of the custom type to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_custom_type", "GET", "/custom_types/{custom_type_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_custom_type")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_resource_events(
    resource: str = Field(..., description="The unique ID of the resource (task, project, or goal) whose events you want to retrieve.", examples=['12345']),
    sync: str | None = Field(None, description="A sync token from a previous response used to fetch only new events since that point in time. Omit on the first request to receive a fresh sync token; if the token has expired (HTTP 412), use the new token returned in that error response to resume.", examples=['de4774f6915eae04714ca93bb2f5ee81'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_resource_events", "GET", "/events", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_resource_events")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Exports
@mcp.tool()
async def export_graph(parent: str | None = Field(None, description="The globally unique ID of the parent object (goal, project, portfolio, or team) whose graph data should be exported.", examples=['181636'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("export_graph", "POST", "/exports/graph", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("export_graph")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_resource_export(
    workspace: str | None = Field(None, description="The GID of the workspace whose resources will be exported. Only one in-progress export is permitted per workspace at a time.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("create_resource_export", "POST", "/exports/resource", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_resource_export")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_goal_relationship(goal_relationship_gid: str = Field(..., description="The unique identifier of the goal relationship to retrieve. This ID is returned when a goal relationship is created or listed.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_goal_relationship", "GET", "/goal_relationships/{goal_relationship_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_goal_relationship")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_goal_relationship(
    goal_relationship_gid: str = Field(..., description="The globally unique identifier of the goal relationship to update.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("update_goal_relationship", "PUT", "/goal_relationships/{goal_relationship_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_goal_relationship")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_goal_relationships(
    supported_goal: str = Field(..., description="The globally unique identifier of the supported goal whose relationships you want to retrieve. This is a required field that scopes the results to a specific goal.", examples=['12345']),
    limit: int | None = Field(None, description="The maximum number of goal relationship records to return per page, between 1 and 100.", ge=1, le=100, examples=[50]),
    resource_subtype: str | None = Field(None, description="Filters the returned goal relationships to only those matching the specified resource subtype, such as a subgoal relationship.", examples=['subgoal'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_goal_relationships", "GET", "/goal_relationships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_goal_relationships")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_goal_supporting_relationship(
    goal_gid: str = Field(..., description="The unique identifier of the parent goal to which the supporting resource will be linked.", examples=['12345']),
    supporting_resource: str = Field(..., description="The unique identifier of the resource to add as a supporting relationship to the parent goal. Must be the GID of a goal, project, task, or portfolio.", examples=['12345']),
    insert_before: str | None = Field(None, description="The GID of an existing subgoal of the parent goal; the new subgoal will be inserted immediately before it. Cannot be used together with `insert_after`. Only supported when adding a subgoal.", examples=['1331']),
    insert_after: str | None = Field(None, description="The GID of an existing subgoal of the parent goal; the new subgoal will be inserted immediately after it. Cannot be used together with `insert_before`. Only supported when adding a subgoal.", examples=['1331']),
    contribution_weight: float | None = Field(None, description="A weight between 0 and 1 (inclusive) that determines how much the supporting resource's progress contributes to the parent goal's overall progress. Must be greater than 0 for the supporting resource to count toward automatically calculated parent goal metrics. Defaults to 0.", examples=[0])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_goal_supporting_relationship", "POST", "/goals/{goal_gid}/addSupportingRelationship", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_goal_supporting_relationship")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_goal_supporting_relationship(
    goal_gid: str = Field(..., description="The unique identifier of the parent goal from which the supporting relationship will be removed.", examples=['12345']),
    supporting_resource: str = Field(..., description="The unique identifier of the supporting resource to unlink from the parent goal; must be the identifier of a goal, project, task, or portfolio.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_goal_supporting_relationship", "POST", "/goals/{goal_gid}/removeSupportingRelationship", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_goal_supporting_relationship")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Goals
@mcp.tool()
async def get_goal(goal_gid: str = Field(..., description="The globally unique identifier of the goal to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_goal", "GET", "/goals/{goal_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_goal")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_goal(
    goal_gid: str = Field(..., description="The globally unique identifier of the goal to update.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("update_goal", "PUT", "/goals/{goal_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_goal")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Goals
@mcp.tool()
async def delete_goal(goal_gid: str = Field(..., description="The globally unique identifier of the goal to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_goal", "DELETE", "/goals/{goal_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_goal")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_goals(
    portfolio: str | None = Field(None, description="The globally unique identifier of a portfolio to filter goals that support it.", examples=['159874']),
    project: str | None = Field(None, description="The globally unique identifier of a project to filter goals that support it.", examples=['512241']),
    task: str | None = Field(None, description="The globally unique identifier of a task to filter goals that support it.", examples=['78424']),
    is_workspace_level: bool | None = Field(None, description="When true, filters results to only workspace-level goals. Must be used together with the workspace parameter.", examples=[False]),
    team: str | None = Field(None, description="The globally unique identifier of a team to filter goals belonging to that team.", examples=['31326']),
    workspace: str | None = Field(None, description="The globally unique identifier of a workspace to filter goals within that workspace.", examples=['31326']),
    time_periods: list[str] | None = Field(None, description="A comma-separated list of globally unique time period identifiers to filter goals associated with those periods. Order is not significant.", examples=['221693,506165'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_goals", "GET", "/goals", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_goals")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_goal(data: _models.GoalRequest | None = Field(None, description="The goal object containing the details for the new goal, such as name, owner, due date, and associated workspace or team.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_goal", "POST", "/goals", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_goal")
    _http_headers.update(_auth.get("headers", {}))
...
async def set_goal_metric(
    goal_gid: str = Field(..., description="The globally unique identifier of the goal to which the metric will be attached.", examples=['12345']),
    precision: int | None = Field(None, description="Only applicable for metrics of type Number. Specifies the number of decimal places to display, where 0 means integer values, 1 rounds to the nearest tenth, and so on. Must be between 0 and 6 inclusive. Note: for percentage format, the precision applies to the raw decimal value before conversion to a percentage display.", examples=[2]),
    ...
    currency_code: str | None = Field(None, description="The ISO 4217 currency code used to format the metric value. Only applicable when the unit is set to 'currency'; otherwise this field is null.", examples=['EUR']),
    initial_number_value: float | None = Field(None, description="The starting value of the numeric goal metric, representing the baseline from which progress is measured.", examples=[5.2]),
    target_number_value: float | None = Field(None, description="The target value the numeric goal metric must reach to be considered complete. Must differ from the initial value.", examples=[10.2]),
    current_number_value: float | None = Field(None, description="The current value of the numeric goal metric, reflecting progress made so far between the initial and target values.", examples=[8.12]),
    progress_source: Literal["manual", "subgoal_progress", "project_task_completion", "project_milestone_completion", "task_completion", "external"] | None = Field(None, description="Defines how the goal's progress value is calculated. Choose 'manual' for user-entered progress, one of the automatic options to derive progress from subgoals, projects, or tasks, or 'external' for integration-managed progress from a source such as Salesforce.", examples=['manual']),
    is_custom_weight: bool | None = Field(None, description="Only applicable when progress_source is 'subgoal_progress', 'project_task_completion', 'project_milestone_completion', or 'task_completion'. When true, each supporting object's custom weight is used in the progress calculation; when false, all supporting objects are treated as equally weighted.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("set_goal_metric", "POST", "/goals/{goal_gid}/setMetric", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("set_goal_metric")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_goal_metric_value(
    goal_gid: str = Field(..., description="The globally unique identifier of the goal whose metric value you want to update.", examples=['12345']),
    current_number_value: float | None = Field(None, description="The new current value to record for the goal's numeric metric, reflecting the latest progress toward the goal's target.", examples=[8.12])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_goal_metric_value", "POST", "/goals/{goal_gid}/setMetricCurrentValue", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_goal_metric_value")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_goal_followers(
    goal_gid: str = Field(..., description="The unique identifier of the goal to which followers will be added.", examples=['12345']),
    followers: list[str] = Field(..., description="A list of users to add as followers to the goal. Each item can be the string 'me' to reference the authenticated user, a user's email address, or a user's GID. Order is not significant.", examples=[['13579', '321654']])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_goal_followers", "POST", "/goals/{goal_gid}/addFollowers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_goal_followers")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_goal_followers(
    goal_gid: str = Field(..., description="The globally unique identifier of the goal from which followers will be removed.", examples=['12345']),
    followers: list[str] = Field(..., description="A list of users to remove as followers from the goal. Each item can be the string 'me' to reference the authenticated user, a user's email address, or a user's globally unique identifier (gid). Order is not significant.", examples=[['13579', '321654']])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_goal_followers", "POST", "/goals/{goal_gid}/removeFollowers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_goal_followers")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Goals
@mcp.tool()
async def list_parent_goals(goal_gid: str = Field(..., description="The globally unique identifier of the goal whose parent goals you want to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_parent_goals", "GET", "/goals/{goal_gid}/parentGoals", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_parent_goals")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_custom_field_to_goal(
    goal_gid: str = Field(..., description="The globally unique identifier of the goal to which the custom field setting will be added.", examples=['12345']),
    ...
    is_important: bool | None = Field(None, description="When set to true, marks this custom field as important for the goal, causing it to be prominently displayed in list views of the goal.", examples=[True]),
    insert_before: str | None = Field(None, description="The GID of an existing custom field setting on this goal before which the new custom field setting will be inserted to control display order. Cannot be used together with insert_after.", examples=['1331']),
    insert_after: str | None = Field(None, description="The GID of an existing custom field setting on this goal after which the new custom field setting will be inserted to control display order. Cannot be used together with insert_before.", examples=['1331'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_custom_field_to_goal", "POST", "/goals/{goal_gid}/addCustomFieldSetting", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_custom_field_to_goal")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_custom_field_from_goal(
    goal_gid: str = Field(..., description="The globally unique identifier of the goal from which the custom field setting will be removed.", examples=['12345']),
    custom_field: str = Field(..., description="The globally unique identifier of the custom field to remove from the goal.", examples=['14916'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_custom_field_from_goal", "POST", "/goals/{goal_gid}/removeCustomFieldSetting", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_custom_field_from_goal")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Jobs
@mcp.tool()
async def get_job(job_gid: str = Field(..., description="The globally unique identifier of the job to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_job", "GET", "/jobs/{job_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_job")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_memberships(
    parent: str | None = Field(None, description="The globally unique identifier of the parent resource to retrieve memberships for; accepted parent types are goal, project, portfolio, custom_type, or custom_field. Optional when both member and resource_subtype are provided together.", examples=['159874']),
    member: str | None = Field(None, description="The globally unique identifier of a user or team to filter memberships by; when combined with resource_subtype and no parent is specified, returns all memberships of that subtype for this member.", examples=['1061493']),
    resource_subtype: Literal["project_membership"] | None = Field(None, description="Specifies the membership subtype to return; required when parent is absent, and must be paired with a member GID to retrieve all memberships of that type for the given member.", examples=['project_membership'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_memberships", "GET", "/memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_memberships")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_membership(data: _models.CreateMembershipRequest | None = Field(None, description="The membership details including the resource to join (goal, project, portfolio, custom type, or custom field) and the member to add (Team or User).")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_membership", "POST", "/memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_membership")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Memberships
@mcp.tool()
async def get_membership(membership_gid: str = Field(..., description="The globally unique identifier of the membership record to retrieve, applicable across all membership types (project, goal, portfolio, custom type, or custom field).", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_membership", "GET", "/memberships/{membership_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_membership")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_membership(
    membership_gid: str = Field(..., description="The globally unique identifier of the membership to update.", examples=['12345']),
    access_level: str | None = Field(None, description="The access level to assign to the member. Valid values vary by resource type: goals support 'viewer', 'commenter', 'editor', or 'admin'; projects support 'admin', 'editor', or 'commenter'; portfolios support 'admin', 'editor', or 'viewer'; custom fields support 'admin', 'editor', or 'user'.", examples=['editor'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_membership", "PUT", "/memberships/{membership_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_membership")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Memberships
@mcp.tool()
async def delete_membership(membership_gid: str = Field(..., description="The globally unique identifier of the membership to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_membership", "DELETE", "/memberships/{membership_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_membership")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def create_organization_export(organization: str | None = Field(None, description="The globally unique identifier of the workspace or organization to export.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_organization_export", "POST", "/organization_exports", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_organization_export")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Organization exports
@mcp.tool()
async def get_organization_export(organization_export_gid: str = Field(..., description="The globally unique identifier of the organization export request to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_organization_export", "GET", "/organization_exports/{organization_export_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_organization_export")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_portfolio_memberships(
    portfolio: str | None = Field(None, description="The unique identifier of the portfolio to filter memberships by. Required unless filtering by workspace and user.", examples=['12345']),
    workspace: str | None = Field(None, description="The unique identifier of the workspace to filter memberships by. Must be combined with a user identifier when specified.", examples=['12345']),
    user: str | None = Field(None, description="Identifies the user whose memberships to filter by. Accepts the string 'me' for the current user, a user's email address, or a user's global ID (gid).", examples=['me']),
    limit: int | None = Field(None, description="The number of membership records to return per page. Accepts values between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_portfolio_memberships", "GET", "/portfolio_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_portfolio_memberships")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Portfolio memberships
@mcp.tool()
async def get_portfolio_membership(portfolio_membership_gid: str = Field(..., description="The unique identifier (GID) of the portfolio membership to retrieve.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_portfolio_membership", "GET", "/portfolio_memberships/{portfolio_membership_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_portfolio_membership")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_portfolio_memberships_for_portfolio(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio whose memberships you want to retrieve.", examples=['12345']),
    user: str | None = Field(None, description="Filters memberships to a specific user. Accepts the string 'me' for the authenticated user, a user's email address, or a user's globally unique identifier.", examples=['me']),
    limit: int | None = Field(None, description="The number of membership records to return per page. Must be between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_portfolio_memberships_for_portfolio", "GET", "/portfolios/{portfolio_gid}/portfolio_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_portfolio_memberships_for_portfolio")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_portfolios(
    workspace: str = Field(..., description="The unique identifier of the workspace or organization used to filter the returned portfolios.", examples=['1331']),
    owner: str | None = Field(None, description="The unique identifier of the user whose portfolios should be returned. Standard API users are limited to their own portfolios; Service Accounts may specify any user or omit this parameter to retrieve all portfolios in the workspace.", examples=['14916'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_portfolios", "GET", "/portfolios", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_portfolios")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_portfolio(data: _models.PortfolioRequest | None = Field(None, description="Request body containing the portfolio details, including the name and workspace to create the portfolio in.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_portfolio", "POST", "/portfolios", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_portfolio")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Portfolios
@mcp.tool()
async def get_portfolio(portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_portfolio", "GET", "/portfolios/{portfolio_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_portfolio")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_portfolio(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio to update.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("update_portfolio", "PUT", "/portfolios/{portfolio_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_portfolio")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Portfolios
@mcp.tool()
async def delete_portfolio(portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_portfolio", "DELETE", "/portfolios/{portfolio_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_portfolio")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_portfolio_items(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio whose items you want to retrieve.", examples=['12345']),
    limit: int | None = Field(None, description="The number of items to return per page, allowing pagination through large portfolios. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_portfolio_items", "GET", "/portfolios/{portfolio_gid}/items", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_portfolio_items")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_portfolio_item(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio to which the item will be added.", examples=['12345']),
    item: str = Field(..., description="The globally unique identifier of the project or item to add to the portfolio.", examples=['1331']),
    insert_before: str | None = Field(None, description="The ID of an existing portfolio item before which the new item will be inserted. Cannot be used together with insert_after.", examples=['1331']),
    insert_after: str | None = Field(None, description="The ID of an existing portfolio item after which the new item will be inserted. Cannot be used together with insert_before.", examples=['1331'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_portfolio_item", "POST", "/portfolios/{portfolio_gid}/addItem", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_portfolio_item")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_portfolio_item(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio from which the item will be removed.", examples=['12345']),
    item: str = Field(..., description="The globally unique identifier of the item to remove from the portfolio.", examples=['1331'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_portfolio_item", "POST", "/portfolios/{portfolio_gid}/removeItem", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_portfolio_item")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_custom_field_to_portfolio(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio to which the custom field setting will be added.", examples=['12345']),
    ...
    is_important: bool | None = Field(None, description="When set to true, marks this custom field as important for the portfolio, causing it to be prominently displayed in list views of the portfolio's items.", examples=[True]),
    insert_before: str | None = Field(None, description="The GID of an existing custom field setting on this portfolio before which the new custom field setting will be inserted to control ordering. Cannot be used together with insert_after.", examples=['1331']),
    insert_after: str | None = Field(None, description="The GID of an existing custom field setting on this portfolio after which the new custom field setting will be inserted to control ordering. Cannot be used together with insert_before.", examples=['1331'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_custom_field_to_portfolio", "POST", "/portfolios/{portfolio_gid}/addCustomFieldSetting", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_custom_field_to_portfolio")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_portfolio_custom_field(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio from which the custom field setting will be removed.", examples=['12345']),
    custom_field: str = Field(..., description="The globally unique identifier of the custom field to detach from the portfolio.", examples=['14916'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_portfolio_custom_field", "POST", "/portfolios/{portfolio_gid}/removeCustomFieldSetting", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_portfolio_custom_field")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_portfolio_members(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio to which members will be added.", examples=['12345']),
    members: str = Field(..., description="A comma-separated list of user identifiers to add as portfolio members; each identifier can be the string 'me', a user's email address, or a user's globally unique identifier (gid). Order is not significant.", examples=['521621,621373'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_portfolio_members", "POST", "/portfolios/{portfolio_gid}/addMembers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_portfolio_members")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_portfolio_members(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio from which members will be removed.", examples=['12345']),
    members: str = Field(..., description="A comma-separated list of user identifiers to remove from the portfolio. Each identifier can be the string 'me' (current user), a user's email address, or a user's globally unique identifier (gid).", examples=['521621,621373'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_portfolio_members", "POST", "/portfolios/{portfolio_gid}/removeMembers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_portfolio_members")
    _http_headers.update(_auth.get("headers", {}))
...
async def duplicate_portfolio(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio to duplicate.", examples=['12345']),
    name: str | None = Field(None, description="The display name to assign to the newly duplicated portfolio.", examples=['New Portfolio Name']),
    include: str | None = Field(None, description="A comma-separated list of optional elements to copy into the duplicate portfolio. Custom field settings and views are always included automatically. Valid values are: description, members, permissions, templates, rules, child_projects, child_portfolios.", examples=[['description,members,permissions,templates,rules,child_projects,child_portfolios']])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("duplicate_portfolio", "POST", "/portfolios/{portfolio_gid}/duplicate", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("duplicate_portfolio")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Project briefs
@mcp.tool()
async def get_project_brief(project_brief_gid: str = Field(..., description="The globally unique identifier for the project brief to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_project_brief", "GET", "/project_briefs/{project_brief_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_project_brief")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_project_brief(
    project_brief_gid: str = Field(..., description="The globally unique identifier of the project brief to update.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("update_project_brief", "PUT", "/project_briefs/{project_brief_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_project_brief")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Project briefs
@mcp.tool()
async def delete_project_brief(project_brief_gid: str = Field(..., description="The globally unique identifier of the project brief to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_project_brief", "DELETE", "/project_briefs/{project_brief_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_project_brief")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_project_brief(
    project_gid: str = Field(..., description="The globally unique identifier of the project for which the brief will be created.", examples=['1331']),
    ...
    # Log invocation
    _log_tool_invocation("create_project_brief", "POST", "/projects/{project_gid}/project_briefs", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_project_brief")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_project_membership(project_membership_gid: str = Field(..., description="The unique identifier (GID) of the project membership record to retrieve.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_project_membership", "GET", "/project_memberships/{project_membership_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_project_membership")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_project_memberships(
    project_gid: str = Field(..., description="The globally unique identifier of the project whose memberships you want to retrieve.", examples=['1331']),
    user: str | None = Field(None, description="Filter memberships to a specific user, identified by their GID, email address, or the keyword 'me' to refer to the authenticated user.", examples=['me']),
    limit: int | None = Field(None, description="The number of membership records to return per page, between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_project_memberships", "GET", "/projects/{project_gid}/project_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_project_memberships")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_project_portfolio_setting(project_portfolio_setting_gid: str = Field(..., description="The globally unique identifier of the project portfolio setting to retrieve.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_project_portfolio_setting", "GET", "/project_portfolio_settings/{project_portfolio_setting_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_project_portfolio_setting")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_project_portfolio_setting(
    project_portfolio_setting_gid: str = Field(..., description="The globally unique identifier of the project portfolio setting to update.", examples=['1331']),
    is_access_control_inherited: bool | None = Field(None, description="Controls whether portfolio members automatically inherit access to the associated project; when true, portfolio membership grants project access.", examples=[True])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_project_portfolio_setting", "PUT", "/project_portfolio_settings/{project_portfolio_setting_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_project_portfolio_setting")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_project_portfolio_settings(
    project_gid: str = Field(..., description="The globally unique identifier of the project whose portfolio settings you want to retrieve.", examples=['1331']),
    limit: int | None = Field(None, description="The number of portfolio settings to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_project_portfolio_settings", "GET", "/projects/{project_gid}/project_portfolio_settings", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_project_portfolio_settings")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Project portfolio settings
@mcp.tool()
async def list_portfolio_project_settings(
    portfolio_gid: str = Field(..., description="The globally unique identifier of the portfolio whose project portfolio settings you want to retrieve.", examples=['12345']),
    limit: int | None = Field(None, description="The number of project portfolio settings to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    """Retrieves all project portfolio settings for a specified portfolio, returned as a compact representation. Requires the project_portfolio_settings:read scope."""

    # Construct request model with validation
    try:
        _request = _models.GetProjectPortfolioSettingsForPortfolioRequest(
            path=_models.GetProjectPortfolioSettingsForPortfolioRequestPath(portfolio_gid=portfolio_gid),
            query=_models.GetProjectPortfolioSettingsForPortfolioRequestQuery(limit=limit)
        )
    except pydantic.ValidationError as _validation_err:
        logging.error(f"Parameter validation failed for list_portfolio_project_settings: {_validation_err}")
        raise ValueError(f"Invalid parameters: {_validation_err.errors()}") from _validation_err
    ...
    # Log invocation
    _log_tool_invocation("list_portfolio_project_settings", "GET", "/portfolios/{portfolio_gid}/project_portfolio_settings", _request_id)

    # Extract parameters for API call
    _http_path = _build_path("/portfolios/{portfolio_gid}/project_portfolio_settings", _request.path.model_dump(by_alias=True)) if _request.path else "/portfolios/{portfolio_gid}/project_portfolio_settings"
    _http_query = _request.query.model_dump(by_alias=True, exclude_none=True) if _request.query else {}
    _http_headers = {}

    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_portfolio_project_settings")
    _http_headers.update(_auth.get("headers", {}))

    # Execute request (returns normalized dict and status code)
    _response_data, _ = await _execute_tool_request(
        tool_name="list_portfolio_project_settings",
        method="GET",
        path=_http_path,
        request_id=_request_id,
        params=_http_query,
...
@mcp.tool()
async def get_project_status(project_status_gid: str = Field(..., description="The unique global identifier of the project status update to retrieve.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_project_status", "GET", "/project_statuses/{project_status_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_project_status")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Project statuses
@mcp.tool()
async def delete_project_status(project_status_gid: str = Field(..., description="The unique identifier of the project status update to delete.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_project_status", "DELETE", "/project_statuses/{project_status_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_project_status")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_project_statuses(project_gid: str = Field(..., description="Globally unique identifier for the project.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_project_statuses", "GET", "/projects/{project_gid}/project_statuses", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_project_statuses")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_project_status(
    project_gid: str = Field(..., description="The globally unique identifier of the project on which to create the status update.", examples=['1331']),
    ...
    # Log invocation
    _log_tool_invocation("create_project_status", "POST", "/projects/{project_gid}/project_statuses", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_project_status")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_project_template(project_template_gid: str = Field(..., description="The globally unique identifier of the project template to retrieve.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_project_template", "GET", "/project_templates/{project_template_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_project_template")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Project templates
@mcp.tool()
async def delete_project_template(project_template_gid: str = Field(..., description="The globally unique identifier of the project template to delete.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_project_template", "DELETE", "/project_templates/{project_template_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_project_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_project_templates(
    ...
    # Log invocation
    _log_tool_invocation("list_project_templates", "GET", "/project_templates", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_project_templates")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_team_project_templates(team_gid: str = Field(..., description="Globally unique identifier for the team.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_team_project_templates", "GET", "/teams/{team_gid}/project_templates", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_team_project_templates")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_project_from_template(
    project_template_gid: str = Field(..., description="The globally unique identifier of the project template to instantiate. Retrieve this value from the get project template endpoint.", examples=['1331']),
    name: str | None = Field(None, description="The display name to assign to the newly created project.", examples=['New Project Name']),
    team: str | None = Field(None, description="The unique identifier of the team to assign to the new project. Applicable only when the workspace is an organization; defaults to the same team as the source project template if omitted.", examples=['12345']),
    is_strict: bool | None = Field(None, description="Controls how unfulfilled date variables are handled. When true, the request fails with an error if any date variable is missing a value; when false, missing date variables fall back to a default such as the current date.", examples=[True]),
    ...
    # Log invocation
    _log_tool_invocation("create_project_from_template", "POST", "/project_templates/{project_template_gid}/instantiateProject", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_project_from_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_projects(
    workspace: str | None = Field(None, description="The GID of the workspace or organization used to filter the returned projects. Providing this filter is recommended to prevent request timeouts on large domains.", examples=['1331']),
    archived: bool | None = Field(None, description="When provided, filters results to only include projects whose archived status matches this value. Set to true to return only archived projects, or false to return only active projects.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_projects", "GET", "/projects", _request_id)
...
async def create_project(data: _models.ProjectRequest | None = Field(None, description="The request body containing project details such as name, workspace, team, and privacy settings required to create the project.")) -> dict[str, Any]:
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_project")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Projects
@mcp.tool()
async def get_project(project_gid: str = Field(..., description="The globally unique identifier (GID) of the project to retrieve.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_project", "GET", "/projects/{project_gid}", _request_id)
...
async def update_project(
    project_gid: str = Field(..., description="The globally unique identifier (GID) of the project to update.", examples=['1331']),
    ...
    # Log invocation
    _log_tool_invocation("update_project", "PUT", "/projects/{project_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_project")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Projects
@mcp.tool()
async def delete_project(project_gid: str = Field(..., description="The globally unique identifier (GID) of the project to be deleted.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_project", "DELETE", "/projects/{project_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_project")
    _http_headers.update(_auth.get("headers", {}))
...
async def duplicate_project(
    project_gid: str = Field(..., description="The globally unique identifier (GID) of the source project to duplicate.", examples=['1331']),
    name: str | None = Field(None, description="The display name to assign to the newly created duplicate project.", examples=['New Project Name']),
    team: str | None = Field(None, description="The GID of the team to assign the new project to. If omitted, the duplicate inherits the same team as the source project.", examples=['12345']),
    include: str | None = Field(None, description="A comma-separated list of optional elements to copy into the duplicate project. Tasks, project views, and rules are always included automatically. Explicitly specify any combination of optional fields: allocations, forms, members, notes, permissions, task_assignee, task_attachments, task_dates, task_dependencies, task_followers, task_notes, task_projects, task_subtasks, task_tags, task_templates, task_type_default.", examples=['allocations,forms,members,notes,permissions,task_assignee,task_attachments,task_dates,task_dependencies,task_followers,task_notes,task_projects,task_subtasks,task_tags,task_templates,task_type_default']),
    should_skip_weekends: bool | None = Field(None, description="Required when shifting task dates: determines whether auto-shifted due and start dates should skip Saturday and Sunday when recalculating offsets.", examples=[True]),
    due_on: str | None = Field(None, description="An ISO 8601 date (YYYY-MM-DD) to set as the last due date in the duplicated project; all other due dates are offset proportionally relative to this anchor date.", examples=['2019-05-21']),
    start_on: str | None = Field(None, description="An ISO 8601 date (YYYY-MM-DD) to set as the first start date in the duplicated project; all other start dates are offset proportionally relative to this anchor date.", examples=['2019-05-21'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("duplicate_project", "POST", "/projects/{project_gid}/duplicate", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("duplicate_project")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_projects(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task whose associated projects you want to retrieve.", examples=['321654']),
    limit: int | None = Field(None, description="The number of project records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_projects", "GET", "/tasks/{task_gid}/projects", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_projects")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_team_project(
    team_gid: str = Field(..., description="The globally unique identifier of the team with which the new project will be shared.", examples=['159874']),
    ...
    # Log invocation
    _log_tool_invocation("create_team_project", "POST", "/teams/{team_gid}/projects", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_team_project")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_workspace_projects(
    ...
    archived: bool | None = Field(None, description="Filters results to only include projects matching the specified archived status. When set to true, only archived projects are returned; when false, only active projects are returned.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_projects", "GET", "/workspaces/{workspace_gid}/projects", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_projects")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_project_in_workspace(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization in which to create the project.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("create_project_in_workspace", "POST", "/workspaces/{workspace_gid}/projects", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_project_in_workspace")
    _http_headers.update(_auth.get("headers", {}))
...
async def search_projects(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization to search within.", examples=['12345']),
    text: str | None = Field(None, description="Full-text search string matched against project names to narrow results.", examples=['Bugs']),
    sort_by: Literal["due_date", "created_at", "completed_at", "modified_at"] | None = Field('modified_at', description="Field by which to sort results; defaults to `modified_at` if not specified.", examples=['modified_at']),
    sort_ascending: bool | None = Field(False, description="When `true`, results are returned in ascending sort order; defaults to descending (`false`).", examples=[False]),
    completed: bool | None = Field(None, description="Filter projects by completion status: `true` returns only completed projects, `false` returns only incomplete projects.", examples=[False]),
    teams_any: str | None = Field(None, alias="teams.any", description="Comma-separated list of team GIDs; returns projects belonging to any of the specified teams.", examples=['12345,67890']),
    owner_any: str | None = Field(None, alias="owner.any", description="Comma-separated list of user GIDs or the string `me`; returns projects owned by any of the specified users.", examples=['12345,67890']),
    members_any: str | None = Field(None, alias="members.any", description="Comma-separated list of user GIDs or the string `me`; returns projects where any of the specified users are members.", examples=['12345,67890']),
    members_not: str | None = Field(None, alias="members.not", description="Comma-separated list of user GIDs or the string `me`; excludes projects where any of the specified users are members.", examples=['12345,67890']),
    portfolios_any: str | None = Field(None, alias="portfolios.any", description="Comma-separated list of portfolio GIDs; returns projects that belong to any of the specified portfolios.", examples=['12345,67890']),
    completed_on: str | None = Field(None, description="ISO 8601 date string to match projects completed on an exact date, or `null` to match projects with no completion date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    completed_on_before: str | None = Field(None, alias="completed_on.before", description="ISO 8601 date string; returns projects completed strictly before this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    completed_on_after: str | None = Field(None, alias="completed_on.after", description="ISO 8601 date string; returns projects completed strictly after this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    completed_at_before: str | None = Field(None, alias="completed_at.before", description="ISO 8601 datetime string; returns projects whose completion timestamp is strictly before this datetime.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    completed_at_after: str | None = Field(None, alias="completed_at.after", description="ISO 8601 datetime string; returns projects whose completion timestamp is strictly after this datetime.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    created_on: str | None = Field(None, description="ISO 8601 date string to match projects created on an exact date, or `null` to match projects with no creation date recorded.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    created_on_before: str | None = Field(None, alias="created_on.before", description="ISO 8601 date string; returns projects created strictly before this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    created_on_after: str | None = Field(None, alias="created_on.after", description="ISO 8601 date string; returns projects created strictly after this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    created_at_before: str | None = Field(None, alias="created_at.before", description="ISO 8601 datetime string; returns projects whose creation timestamp is strictly before this datetime.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    created_at_after: str | None = Field(None, alias="created_at.after", description="ISO 8601 datetime string; returns projects whose creation timestamp is strictly after this datetime.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    due_on: str | None = Field(None, description="ISO 8601 date string to match projects with a due date on an exact date, or `null` to match projects with no due date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    due_on_before: str | None = Field(None, alias="due_on.before", description="ISO 8601 date string; returns projects with a due date strictly before this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    due_on_after: str | None = Field(None, alias="due_on.after", description="ISO 8601 date string; returns projects with a due date strictly after this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    due_at_before: str | None = Field(None, alias="due_at.before", description="ISO 8601 datetime string; returns projects whose due datetime is strictly before this datetime.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    due_at_after: str | None = Field(None, alias="due_at.after", description="ISO 8601 datetime string; returns projects whose due datetime is strictly after this datetime.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    start_on: str | None = Field(None, description="ISO 8601 date string to match projects with a start date on an exact date, or `null` to match projects with no start date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    start_on_before: str | None = Field(None, alias="start_on.before", description="ISO 8601 date string; returns projects with a start date strictly before this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    start_on_after: str | None = Field(None, alias="start_on.after", description="ISO 8601 date string; returns projects with a start date strictly after this date.", examples=['2019-09-15'], json_schema_extra={'format': 'date'})
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("search_projects", "GET", "/workspaces/{workspace_gid}/projects/search", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("search_projects")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_custom_field_to_project(
    project_gid: str = Field(..., description="The unique identifier of the project to which the custom field will be added.", examples=['1331']),
    ...
    is_important: bool | None = Field(None, description="When true, marks this custom field as important for the project, causing it to be prominently displayed in list views of the project's items.", examples=[True]),
    insert_before: str | None = Field(None, description="The GID of an existing custom field setting on this project before which the new setting will be inserted to control ordering. Cannot be used together with insert_after.", examples=['1331']),
    insert_after: str | None = Field(None, description="The GID of an existing custom field setting on this project after which the new setting will be inserted to control ordering. Cannot be used together with insert_before.", examples=['1331'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_custom_field_to_project", "POST", "/projects/{project_gid}/addCustomFieldSetting", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_custom_field_to_project")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_custom_field_from_project(
    project_gid: str = Field(..., description="The globally unique identifier of the project from which the custom field setting will be removed.", examples=['1331']),
    custom_field: str = Field(..., description="The globally unique identifier of the custom field to detach from the project.", examples=['14916'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_custom_field_from_project", "POST", "/projects/{project_gid}/removeCustomFieldSetting", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_custom_field_from_project")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Projects
@mcp.tool()
async def get_project_task_counts(project_gid: str = Field(..., description="The globally unique identifier of the project whose task counts you want to retrieve.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_project_task_counts", "GET", "/projects/{project_gid}/task_counts", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_project_task_counts")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_project_members(
    project_gid: str = Field(..., description="The globally unique identifier of the project to which members will be added.", examples=['1331']),
    members: str = Field(..., description="A comma-separated list of user identifiers to add as project members. Each identifier can be the string 'me', a user's email address, or a user's globally unique identifier (gid).", examples=['521621,621373'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_project_members", "POST", "/projects/{project_gid}/addMembers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_project_members")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_project_members(
    project_gid: str = Field(..., description="The globally unique identifier of the project from which members will be removed.", examples=['1331']),
    members: str = Field(..., description="A comma-separated list of users to remove from the project, where each user can be identified by their GID, email address, or the literal string 'me' to reference the authenticated user.", examples=['521621,621373'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_project_members", "POST", "/projects/{project_gid}/removeMembers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_project_members")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_project_followers(
    project_gid: str = Field(..., description="The unique identifier of the project to which followers will be added.", examples=['1331']),
    followers: str = Field(..., description="A comma-separated list of user identifiers to add as followers; each identifier can be the string 'me', a user's email address, or a user's GID.", examples=['521621,621373'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_project_followers", "POST", "/projects/{project_gid}/addFollowers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_project_followers")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_project_followers(
    project_gid: str = Field(..., description="The globally unique identifier of the project from which followers will be removed.", examples=['1331']),
    followers: str = Field(..., description="A comma-separated list of users to remove as followers. Each user can be identified by their GID, email address, or the string 'me' to reference the authenticated user.", examples=['521621,621373'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_project_followers", "POST", "/projects/{project_gid}/removeFollowers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_project_followers")
    _http_headers.update(_auth.get("headers", {}))
...
async def save_project_as_template(
    project_gid: str = Field(..., description="The unique identifier of the project to convert into a template.", examples=['1331']),
    name: str = Field(..., description="The display name to assign to the newly created project template.", examples=['New Project Template']),
    public: bool = Field(..., description="Controls whether the project template is publicly visible to all members of its team. Set to false to restrict visibility.", examples=[True]),
    team: str | None = Field(None, description="The GID of the team to associate with the new project template. Required when the source project belongs to an organization; do not use alongside workspace.", examples=['12345']),
    workspace: str | None = Field(None, description="The GID of the workspace to associate with the new project template. Only applicable when the source project exists in a workspace rather than an organization; do not use alongside team.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("save_project_as_template", "POST", "/projects/{project_gid}/saveAsTemplate", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("save_project_as_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_rates(
    parent: str | None = Field(None, description="The globally unique identifier of the parent project whose rates should be retrieved.", examples=['159874']),
    resource: str | None = Field(None, description="The globally unique identifier of a user or placeholder to filter rates down to a single specific resource.", examples=['1061493'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_rates", "GET", "/rates", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_rates")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_rate(
    parent: str = Field(..., description="The globally unique ID of the parent project to which this rate will be assigned.", examples=['12345']),
    resource: str = Field(..., description="The globally unique ID of the resource (user or placeholder) for whom the rate is being set.", examples=['12345']),
    rate: float = Field(..., description="The monetary value of the rate to assign to the resource, representing the billing amount per unit of time.", examples=[100])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_rate", "POST", "/rates", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_rate")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Rates
@mcp.tool()
async def get_rate(rate_gid: str = Field(..., description="The globally unique identifier for the rate to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_rate", "GET", "/rates/{rate_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_rate")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_rate(
    rate_gid: str = Field(..., description="The globally unique identifier of the rate record to update.", examples=['12345']),
    rate: float | None = Field(None, description="The new monetary value to assign to the rate. Must be a valid numeric amount.", examples=[100])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_rate", "PUT", "/rates/{rate_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_rate")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Rates
@mcp.tool()
async def delete_rate(rate_gid: str = Field(..., description="The globally unique identifier of the rate to delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_rate", "DELETE", "/rates/{rate_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_rate")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_reactions(
    target: str = Field(..., description="The globally unique identifier (GID) of the object to fetch reactions from. Must reference a valid status update or story.", examples=['159874']),
    emoji_base: str = Field(..., description="Filters results to only include reactions that use this emoji base character. Only reactions matching this exact emoji will be returned.", examples=['👍']),
    limit: int | None = Field(None, description="The maximum number of reactions to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_reactions", "GET", "/reactions", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_reactions")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_roles(
    workspace: str | None = Field(None, description="The workspace or organization ID to filter roles by, limiting results to roles defined within that specific workspace.", examples=['1331']),
    archived: bool | None = Field(None, description="When set to true, returns only archived roles; when set to false, returns only active roles. Omit to return all roles regardless of archived status.", examples=[False])
) -> dict[str, Any]:
    """Retrieves all RBAC roles for a workspace, enabling review of role-based access control configurations. Requires the `roles:read` scope."""

    # Construct request model with validation
    try:
        _request = _models.GetRolesRequest(
            query=_models.GetRolesRequestQuery(workspace=workspace, archived=archived)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("list_roles", "GET", "/roles", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_roles")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Roles
@mcp.tool()
async def create_role(data: _models.RbacRoleRequest | None = Field(None, description="The role definition object containing the name, permissions, and any other attributes for the new RBAC role to be created.")) -> dict[str, Any]:
    """Creates a new RBAC role in the workspace, enabling fine-grained access control assignment to users or groups. Requires the roles:write scope."""

    # Construct request model with validation
    try:
        _request = _models.CreateRoleRequest(
            body=_models.CreateRoleRequestBody(data=data)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("create_role", "POST", "/roles", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_role")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Roles
@mcp.tool()
async def get_role(role_gid: str = Field(..., description="The globally unique identifier of the role to retrieve.", examples=['12345'])) -> dict[str, Any]:
    """Retrieves the complete record for a single role, including all associated permissions and metadata. Requires the roles:read scope."""

    # Construct request model with validation
    try:
        _request = _models.GetRoleRequest(
            path=_models.GetRoleRequestPath(role_gid=role_gid)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("get_role", "GET", "/roles/{role_gid}", _request_id)

    # Extract parameters for API call
    _http_path = _build_path("/roles/{role_gid}", _request.path.model_dump(by_alias=True)) if _request.path else "/roles/{role_gid}"
    _http_headers = {}

    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_role")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_role(
    role_gid: str = Field(..., description="The globally unique identifier of the role to update.", examples=['12345']),
    data: _models.RbacRoleUpdateRequest | None = Field(None, description="The role fields to update, such as name or permissions associated with the role.")
) -> dict[str, Any]:
    """Updates the properties of an existing role in a workspace. Requires the roles:write scope."""

    # Construct request model with validation
    try:
        _request = _models.UpdateRoleRequest(
            path=_models.UpdateRoleRequestPath(role_gid=role_gid),
            body=_models.UpdateRoleRequestBody(data=data)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("update_role", "PUT", "/roles/{role_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_role")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Roles
@mcp.tool()
async def delete_role(role_gid: str = Field(..., description="The globally unique identifier of the role to delete.", examples=['12345'])) -> dict[str, Any]:
    """Permanently deletes a role from a workspace. This action requires the roles:delete scope and cannot be undone."""

    # Construct request model with validation
    try:
        _request = _models.DeleteRoleRequest(
            path=_models.DeleteRoleRequestPath(role_gid=role_gid)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("delete_role", "DELETE", "/roles/{role_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_role")
    _http_headers.update(_auth.get("headers", {}))
...
async def trigger_rule(
    rule_trigger_gid: str = Field(..., description="The unique identifier of the incoming web request trigger to fire, found in the rule's trigger configuration within Asana.", examples=['12345']),
    resource: str = Field(..., description="The unique identifier of the task to run the rule against; the task must belong to the project in which the rule was created.", examples=['12345']),
    action_data: dict[str, Any] = Field(..., description="A key-value map of dynamic data passed to the rule's action at runtime, allowing external context (such as ticket names or IDs from third-party systems) to be used within the rule's action logic.", examples=[{'jira_ticket_name': 'Test', 'jira_ticket_id': '123'}])
) -> dict[str, Any]:
    """Fires a rule that uses an incoming web request trigger, executing its associated actions against a specified resource. Use this to programmatically invoke automation rules in Asana from external systems."""

    # Construct request model with validation
    try:
        _request = _models.TriggerRuleRequest(
            path=_models.TriggerRuleRequestPath(rule_trigger_gid=rule_trigger_gid),
            body=_models.TriggerRuleRequestBody(data=_models.TriggerRuleRequestBodyData(resource=resource, action_data=action_data))
        )
    except pydantic.ValidationError as _validation_err:
        logging.error(f"Parameter validation failed for trigger_rule: {_validation_err}")
        raise ValueError(f"Invalid parameters: {_validation_err.errors()}") from _validation_err
    ...
    # Log invocation
    _log_tool_invocation("trigger_rule", "POST", "/rule_triggers/{rule_trigger_gid}/run", _request_id)

    # Extract parameters for API call
    _http_path = _build_path("/rule_triggers/{rule_trigger_gid}/run", _request.path.model_dump(by_alias=True)) if _request.path else "/rule_triggers/{rule_trigger_gid}/run"
    _http_body = _request.body.model_dump(by_alias=True, exclude_none=True) if _request.body else None
    _http_headers = {}

    # Inject per-operation authentication
    _auth = _get_auth_for_operation("trigger_rule")
    _http_headers.update(_auth.get("headers", {}))

    # Execute request (returns normalized dict and status code)
    _response_data, _ = await _execute_tool_request(
        tool_name="trigger_rule",
        method="POST",
        path=_http_path,
        request_id=_request_id,
        body=_http_body,
...
# Tags: Sections
@mcp.tool()
async def get_section(section_gid: str = Field(..., description="The globally unique identifier (GID) of the section to retrieve.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_section", "GET", "/sections/{section_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_section")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_section(
    section_gid: str = Field(..., description="The globally unique identifier of the section to update.", examples=['321654']),
    name: str | None = Field(None, description="The new display name for the section. Must be a non-empty string.", examples=['Next Actions']),
    insert_before: str | None = Field(None, description="The unique identifier of an existing section before which this section should be repositioned. Mutually exclusive with insert_after.", examples=['86420']),
    insert_after: str | None = Field(None, description="The unique identifier of an existing section after which this section should be repositioned. Mutually exclusive with insert_before.", examples=['987654'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_section", "PUT", "/sections/{section_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_section")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Sections
@mcp.tool()
async def delete_section(section_gid: str = Field(..., description="The globally unique identifier (GID) of the section to delete.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_section", "DELETE", "/sections/{section_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_section")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_project_sections(project_gid: str = Field(..., description="Globally unique identifier for the project.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_project_sections", "GET", "/projects/{project_gid}/sections", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_project_sections")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_section(
    project_gid: str = Field(..., description="The unique identifier of the project in which the new section will be created.", examples=['1331']),
    name: str | None = Field(None, description="The display name for the new section. Must be a non-empty string.", examples=['Next Actions']),
    insert_before: str | None = Field(None, description="The GID of an existing section in this project before which the new section will be inserted. Mutually exclusive with insert_after; only one may be provided.", examples=['86420']),
    insert_after: str | None = Field(None, description="The GID of an existing section in this project after which the new section will be inserted. Mutually exclusive with insert_before; only one may be provided.", examples=['987654'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_section", "POST", "/projects/{project_gid}/sections", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_section")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_to_section(
    section_gid: str = Field(..., description="The unique identifier of the section to which the task will be added.", examples=['321654']),
    task: str | None = Field(None, description="The unique identifier of the task to add to the section. Note: tasks with a resource_subtype of 'section' (separators) are not supported.", examples=['123456']),
    insert_before: str | None = Field(None, description="The unique identifier of an existing task in this section before which the added task should be inserted. Mutually exclusive with insert_after.", examples=['86420']),
    insert_after: str | None = Field(None, description="The unique identifier of an existing task in this section after which the added task should be inserted. Mutually exclusive with insert_before.", examples=['987654'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_task_to_section", "POST", "/sections/{section_gid}/addTask", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_to_section")
    _http_headers.update(_auth.get("headers", {}))
...
async def reorder_section(
    project_gid: str = Field(..., description="The unique identifier of the project that contains the sections being reordered.", examples=['1331']),
    section: str | None = Field(None, description="The unique identifier of the section you want to move to a new position within the project.", examples=['321654']),
    before_section: str | None = Field(None, description="The unique identifier of the reference section that the moved section should be placed immediately before. Mutually exclusive with `after_section`.", examples=['86420']),
    after_section: str | None = Field(None, description="The unique identifier of the reference section that the moved section should be placed immediately after. Mutually exclusive with `before_section`.", examples=['987654'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("reorder_section", "POST", "/projects/{project_gid}/sections/insert", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("reorder_section")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Status updates
@mcp.tool()
async def get_status_update(status_update_gid: str = Field(..., description="The unique identifier of the status update to retrieve.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_status_update", "GET", "/status_updates/{status_update_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_status_update")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Status updates
@mcp.tool()
async def delete_status_update(status_update_gid: str = Field(..., description="The unique identifier of the status update to delete.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_status_update", "DELETE", "/status_updates/{status_update_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_status_update")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_status_updates(
    parent: str = Field(..., description="The globally unique identifier (GID) of the object whose status updates should be retrieved. Must reference a project, portfolio, or goal.", examples=['159874']),
    limit: int | None = Field(None, description="The maximum number of status update records to return per page, between 1 and 100.", ge=1, le=100, examples=[50]),
    created_since: str | None = Field(None, description="Filters results to only include status updates created at or after this timestamp, specified in ISO 8601 date-time format.", examples=['2012-02-22T02:06:58.158Z'], json_schema_extra={'format': 'date-time'})
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_status_updates", "GET", "/status_updates", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_status_updates")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_status_update(
    limit: int | None = Field(None, description="The number of results to return per page, must be between 1 and 100.", ge=1, le=100, examples=[50]),
    ...
    # Log invocation
    _log_tool_invocation("create_status_update", "POST", "/status_updates", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_status_update")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Stories
@mcp.tool()
async def get_story(story_gid: str = Field(..., description="The globally unique identifier (GID) of the story to retrieve.", examples=['35678'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_story", "GET", "/stories/{story_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_story")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_story(
    story_gid: str = Field(..., description="The globally unique identifier of the story to update.", examples=['35678']),
    text: str | None = Field(None, description="The plain text content of the comment story to set. Cannot be used together with html_text; only one may be specified per request.", examples=['This is a comment.']),
    is_pinned: bool | None = Field(None, description="Whether the story should be pinned to its parent resource. Pinning is supported only for comment and attachment story types.", examples=[False]),
    sticker_name: Literal["green_checkmark", "people_dancing", "dancing_unicorn", "heart", "party_popper", "people_waving_flags", "splashing_narwhal", "trophy", "yeti_riding_unicorn", "celebrating_people", "determined_climbers", "phoenix_spreading_love"] | None = Field(None, description="The name of the sticker to display on the story. Set to null to remove an existing sticker. Must be one of the supported sticker identifiers.", examples=['dancing_unicorn'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_story", "PUT", "/stories/{story_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_story")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Stories
@mcp.tool()
async def delete_story(story_gid: str = Field(..., description="The globally unique identifier of the story to delete.", examples=['35678'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_story", "DELETE", "/stories/{story_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_story")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_stories(task_gid: str = Field(..., description="The task to operate on.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_stories", "GET", "/tasks/{task_gid}/stories", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_stories")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_comment(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task to which the story will be added.", examples=['321654']),
    text: str | None = Field(None, description="The plain text content of the comment to post on the task. Cannot be used together with html_text.", examples=['This is a comment.']),
    is_pinned: bool | None = Field(None, description="Whether the story should be pinned to the top of the task's story feed, making it prominently visible.", examples=[False]),
    sticker_name: Literal["green_checkmark", "people_dancing", "dancing_unicorn", "heart", "party_popper", "people_waving_flags", "splashing_narwhal", "trophy", "yeti_riding_unicorn", "celebrating_people", "determined_climbers", "phoenix_spreading_love"] | None = Field(None, description="The name of the sticker to attach to this story. Omit or set to null if no sticker is desired.", examples=['dancing_unicorn'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_task_comment", "POST", "/tasks/{task_gid}/stories", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_comment")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Tags
@mcp.tool()
async def list_tags(workspace: str | None = Field(None, description="The unique identifier of the workspace used to filter the returned tags to only those belonging to that workspace.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_tags", "GET", "/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_tags")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_tag(data: _models.TagCreateRequest | None = Field(None, description="The request body containing the tag details, including the required workspace or organization identifier and any additional tag properties such as name and color.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_tag", "POST", "/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_tag")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Tags
@mcp.tool()
async def get_tag(tag_gid: str = Field(..., description="The globally unique identifier (GID) of the tag to retrieve.", examples=['11235'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_tag", "GET", "/tags/{tag_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_tag(
    tag_gid: str = Field(..., description="The globally unique identifier of the tag to update.", examples=['11235']),
    ...
    # Log invocation
    _log_tool_invocation("update_tag", "PUT", "/tags/{tag_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_tag")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Tags
@mcp.tool()
async def delete_tag(tag_gid: str = Field(..., description="The globally unique identifier of the tag to delete.", examples=['11235'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_tag", "DELETE", "/tags/{tag_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_tags(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task whose tags you want to retrieve.", examples=['321654']),
    limit: int | None = Field(None, description="The number of tag results to return per page, must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_tags", "GET", "/tasks/{task_gid}/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_tags")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_workspace_tags(workspace_gid: str = Field(..., description="Globally unique identifier for the workspace or organization.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_tags", "GET", "/workspaces/{workspace_gid}/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_tags")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_tag_in_workspace(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization in which to create the tag.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("create_tag_in_workspace", "POST", "/workspaces/{workspace_gid}/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_tag_in_workspace")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Task templates
@mcp.tool()
async def list_task_templates(project: str | None = Field(None, description="The unique identifier of the project whose task templates should be returned. This filter is required to scope results to a specific project.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_templates", "GET", "/task_templates", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_templates")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Task templates
@mcp.tool()
async def get_task_template(task_template_gid: str = Field(..., description="The globally unique identifier (GID) of the task template to retrieve.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_task_template", "GET", "/task_templates/{task_template_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_task_template")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Task templates
@mcp.tool()
async def delete_task_template(task_template_gid: str = Field(..., description="The globally unique identifier of the task template to delete.", examples=['1331'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_task_template", "DELETE", "/task_templates/{task_template_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_task_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def instantiate_task_from_template(
    task_template_gid: str = Field(..., description="The globally unique identifier of the task template to instantiate a new task from.", examples=['1331']),
    name: str | None = Field(None, description="The display name for the newly created task. If omitted, the task inherits the name defined in the source task template.", examples=['New Task'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("instantiate_task_from_template", "POST", "/task_templates/{task_template_gid}/instantiateTask", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("instantiate_task_from_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_tasks(
    assignee: str | None = Field(None, description="Filter tasks by the GID of the assigned user. To find unassigned tasks, use assignee.any = null. Requires workspace to also be specified.", examples=['14641']),
    project: str | None = Field(None, description="Filter tasks belonging to the specified project GID.", examples=['321654']),
    section: str | None = Field(None, description="Filter tasks belonging to the specified section GID within a project.", examples=['321654']),
    workspace: str | None = Field(None, description="Filter tasks within the specified workspace GID. Requires assignee to also be specified.", examples=['321654']),
    completed_since: str | None = Field(None, description="Return only tasks that are incomplete or were completed on or after this timestamp, provided in ISO 8601 date-time format.", examples=['2012-02-22T02:06:58.158Z'], json_schema_extra={'format': 'date-time'}),
    modified_since: str | None = Field(None, description="Return only tasks modified on or after this timestamp in ISO 8601 date-time format. Modifications include property changes and association updates such as assigning, renaming, completing, or adding stories.", examples=['2012-02-22T02:06:58.158Z'], json_schema_extra={'format': 'date-time'})
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_tasks", "GET", "/tasks", _request_id)
...
# Tags: Tasks
@mcp.tool()
async def get_task(task_gid: str = Field(..., description="The unique global identifier (GID) of the task to retrieve.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_task", "GET", "/tasks/{task_gid}", _request_id)
...
async def update_task(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task to update.", examples=['321654']),
    ...
    # Log invocation
    _log_tool_invocation("update_task", "PUT", "/tasks/{task_gid}", _request_id)
...
# Tags: Tasks
@mcp.tool()
async def delete_task(task_gid: str = Field(..., description="The unique global identifier (GID) of the task to delete.", examples=['321654'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_task", "DELETE", "/tasks/{task_gid}", _request_id)
...
async def duplicate_task(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task to duplicate.", examples=['321654']),
    name: str | None = Field(None, description="The name to assign to the newly duplicated task.", examples=['New Task Name']),
    include: str | None = Field(None, description="A comma-separated list of fields to copy from the original task to the duplicate. Supported fields include: assignee, attachments, dates, dependencies, followers, notes, parent, projects, subtasks, and tags.", examples=[['notes,assignee,subtasks,attachments,tags,followers,projects,dates,dependencies,parent']])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("duplicate_task", "POST", "/tasks/{task_gid}/duplicate", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("duplicate_task")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_project_tasks(
    project_gid: str = Field(..., description="The globally unique identifier (GID) of the project whose tasks you want to retrieve.", examples=['1331']),
    completed_since: str | None = Field(None, description="Filters results to include only incomplete tasks or tasks completed after this point in time. Accepts an ISO 8601 date-time string or the keyword 'now' to filter relative to the current moment.", examples=['2012-02-22T02:06:58.158Z']),
    limit: int | None = Field(None, description="The number of task records to return per page. Must be between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_project_tasks", "GET", "/projects/{project_gid}/tasks", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_project_tasks")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_section_tasks(
    section_gid: str = Field(..., description="The globally unique identifier of the section whose tasks you want to retrieve.", examples=['321654']),
    limit: int | None = Field(None, description="Number of task records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50]),
    completed_since: str | None = Field(None, description="Filters results to include only incomplete tasks or tasks completed after the specified time. Accepts an ISO 8601 date-time string or the keyword 'now'.", examples=['2012-02-22T02:06:58.158Z'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_section_tasks", "GET", "/sections/{section_gid}/tasks", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_section_tasks")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_tasks_by_tag(
    tag_gid: str = Field(..., description="The globally unique identifier of the tag whose associated tasks you want to retrieve.", examples=['11235']),
    limit: int | None = Field(None, description="The number of task records to return per page, must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_tasks_by_tag", "GET", "/tags/{tag_gid}/tasks", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_tasks_by_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_user_task_list_tasks(
    user_task_list_gid: str = Field(..., description="The globally unique identifier for the user task list whose tasks you want to retrieve.", examples=['12345']),
    completed_since: str | None = Field(None, description="Filters results to only include tasks that are incomplete or were completed on or after this point in time. Accepts an ISO 8601 date-time string or the keyword 'now' to return only currently incomplete tasks.", examples=['2012-02-22T02:06:58.158Z']),
    limit: int | None = Field(None, description="The number of task objects to return per page, between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_user_task_list_tasks", "GET", "/user_task_lists/{user_task_list_gid}/tasks", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_user_task_list_tasks")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_subtasks(task_gid: str = Field(..., description="The task to operate on.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_subtasks", "GET", "/tasks/{task_gid}/subtasks", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_subtasks")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_subtask(
    task_gid: str = Field(..., description="The unique identifier (GID) of the parent task to which the new subtask will be added.", examples=['321654']),
    ...
    # Log invocation
    _log_tool_invocation("create_subtask", "POST", "/tasks/{task_gid}/subtasks", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_subtask")
    _http_headers.update(_auth.get("headers", {}))
...
async def set_task_parent(
    task_gid: str = Field(..., description="The unique identifier of the task whose parent relationship will be updated.", examples=['321654']),
    parent: str = Field(..., description="The unique identifier of the task to set as the new parent, or null to remove the existing parent and make the task top-level.", examples=['987654']),
    insert_after: str | None = Field(None, description="The unique identifier of an existing subtask of the new parent after which this task should be inserted, or null to insert at the beginning of the subtask list. Cannot be used together with insert_before.", examples=['null']),
    insert_before: str | None = Field(None, description="The unique identifier of an existing subtask of the new parent before which this task should be inserted, or null to insert at the end of the subtask list. Cannot be used together with insert_after.", examples=['124816'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("set_task_parent", "POST", "/tasks/{task_gid}/setParent", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("set_task_parent")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_dependencies(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task whose dependencies you want to retrieve.", examples=['321654']),
    limit: int | None = Field(None, description="The number of dependency records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_dependencies", "GET", "/tasks/{task_gid}/dependencies", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_dependencies")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_dependencies(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task to which dependencies will be added.", examples=['321654']),
    ...
    # Log invocation
    _log_tool_invocation("add_task_dependencies", "POST", "/tasks/{task_gid}/addDependencies", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_dependencies")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_dependencies(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task from which dependencies will be removed.", examples=['321654']),
    ...
    # Log invocation
    _log_tool_invocation("remove_task_dependencies", "POST", "/tasks/{task_gid}/removeDependencies", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_task_dependencies")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_dependents(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task whose dependents you want to retrieve.", examples=['321654']),
    limit: int | None = Field(None, description="The number of dependent task records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_dependents", "GET", "/tasks/{task_gid}/dependents", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_dependents")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_dependents(
    task_gid: str = Field(..., description="The unique identifier of the task that will become the dependency (i.e., the task that others will depend on).", examples=['321654']),
    ...
    # Log invocation
    _log_tool_invocation("add_task_dependents", "POST", "/tasks/{task_gid}/addDependents", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_dependents")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_dependents(
    task_gid: str = Field(..., description="The unique identifier of the task from which dependents will be unlinked.", examples=['321654']),
    ...
    # Log invocation
    _log_tool_invocation("remove_task_dependents", "POST", "/tasks/{task_gid}/removeDependents", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_task_dependents")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_to_project(
    task_gid: str = Field(..., description="The unique identifier of the task to add to the project.", examples=['321654']),
    project: str = Field(..., description="The unique identifier of the project to add the task to.", examples=['13579']),
    insert_after: str | None = Field(None, description="The GID of an existing task in the project after which this task should be inserted. Pass null to place the task at the beginning of the list or, when combined with `section`, at the beginning of that section. Cannot be used together with `insert_before`.", examples=['124816']),
    insert_before: str | None = Field(None, description="The GID of an existing task in the project before which this task should be inserted. Pass null to place the task at the end of the list or, when combined with `section`, at the end of that section. Cannot be used together with `insert_after`.", examples=['432134']),
    section: str | None = Field(None, description="The GID of a section within the project into which the task should be placed. By default the task is added to the end of the section; combine with `insert_after: null` to place at the beginning, `insert_before: null` to place at the end, or a non-null `insert_before`/`insert_after` task GID to position relative to a specific task within the section.", examples=['987654'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_task_to_project", "POST", "/tasks/{task_gid}/addProject", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_to_project")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_from_project(
    task_gid: str = Field(..., description="The unique identifier of the task to be removed from the project.", examples=['321654']),
    project: str = Field(..., description="The unique identifier of the project from which the task should be removed.", examples=['13579'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_task_from_project", "POST", "/tasks/{task_gid}/removeProject", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_task_from_project")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_tag(
    task_gid: str = Field(..., description="The unique global identifier (GID) of the task to which the tag will be added.", examples=['321654']),
    tag: str = Field(..., description="The unique global identifier (GID) of the tag to attach to the task.", examples=['13579'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_task_tag", "POST", "/tasks/{task_gid}/addTag", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_tag(
    task_gid: str = Field(..., description="The unique global identifier (GID) of the task from which the tag will be removed.", examples=['321654']),
    tag: str = Field(..., description="The unique global identifier (GID) of the tag to remove from the task.", examples=['13579'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_task_tag", "POST", "/tasks/{task_gid}/removeTag", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_task_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_followers(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task to which followers will be added.", examples=['321654']),
    followers: list[str] = Field(..., description="A list of users to add as followers, where each entry can be the string 'me', a user's email address, or a user's GID. Order is not significant.", examples=[['13579', '321654']])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_task_followers", "POST", "/tasks/{task_gid}/addFollowers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_followers")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_followers(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task from which followers will be removed.", examples=['321654']),
    followers: list[str] = Field(..., description="A list of users to remove as followers from the task. Each item can be the string 'me', a user's email address, or a user's GID. Order is not significant.", examples=[['13579', '321654']])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_task_followers", "POST", "/tasks/{task_gid}/removeFollowers", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_task_followers")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_task_by_custom_id(
    workspace_gid: str = Field(..., description="The globally unique identifier for the workspace or organization in which to search for the task.", examples=['12345']),
    custom_id: str = Field(..., description="The custom ID shortcode assigned to the task, typically formatted as a prefix followed by a number (e.g., a project code and sequence number).", examples=['EX-1'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_task_by_custom_id", "GET", "/workspaces/{workspace_gid}/tasks/custom_id/{custom_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_task_by_custom_id")
    _http_headers.update(_auth.get("headers", {}))
...
async def search_tasks(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization to search within.", examples=['12345']),
    text: str | None = Field(None, description="Full-text search string matched against both task name and description.", examples=['Bug']),
    resource_subtype: Literal["default_task", "milestone", "approval", "custom"] | None = Field('milestone', description="Filters results to tasks of a specific subtype. Use 'default_task' for standard tasks, 'milestone' for milestones, 'approval' for approval tasks, or 'custom' for custom task types."),
    assignee_any: str | None = Field(None, alias="assignee.any", description="Returns tasks assigned to any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    assignee_not: str | None = Field(None, alias="assignee.not", description="Excludes tasks assigned to any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    portfolios_any: str | None = Field(None, alias="portfolios.any", description="Returns tasks belonging to any of the specified portfolios. Accepts a comma-separated list of portfolio GIDs.", examples=['12345,23456,34567']),
    projects_any: str | None = Field(None, alias="projects.any", description="Returns tasks belonging to any of the specified projects. Accepts a comma-separated list of project GIDs. Note: combining with sections.any returns tasks matching either filter, not just the section.", examples=['12345,23456,34567']),
    projects_not: str | None = Field(None, alias="projects.not", description="Excludes tasks belonging to any of the specified projects. Accepts a comma-separated list of project GIDs.", examples=['12345,23456,34567']),
    projects_all: str | None = Field(None, alias="projects.all", description="Returns tasks belonging to all of the specified projects. Accepts a comma-separated list of project GIDs.", examples=['12345,23456,34567']),
    sections_any: str | None = Field(None, alias="sections.any", description="Returns tasks in any of the specified sections or columns. Accepts a comma-separated list of section GIDs. To retrieve only tasks in a section, omit projects.any.", examples=['12345,23456,34567']),
    sections_not: str | None = Field(None, alias="sections.not", description="Excludes tasks in any of the specified sections or columns. Accepts a comma-separated list of section GIDs.", examples=['12345,23456,34567']),
    sections_all: str | None = Field(None, alias="sections.all", description="Returns tasks in all of the specified sections or columns. Accepts a comma-separated list of section GIDs.", examples=['12345,23456,34567']),
    tags_any: str | None = Field(None, alias="tags.any", description="Returns tasks with any of the specified tags. Accepts a comma-separated list of tag GIDs.", examples=['12345,23456,34567']),
    tags_not: str | None = Field(None, alias="tags.not", description="Excludes tasks with any of the specified tags. Accepts a comma-separated list of tag GIDs.", examples=['12345,23456,34567']),
    tags_all: str | None = Field(None, alias="tags.all", description="Returns tasks that have all of the specified tags. Accepts a comma-separated list of tag GIDs.", examples=['12345,23456,34567']),
    teams_any: str | None = Field(None, alias="teams.any", description="Returns tasks belonging to any of the specified teams. Accepts a comma-separated list of team GIDs.", examples=['12345,23456,34567']),
    followers_any: str | None = Field(None, alias="followers.any", description="Returns tasks followed by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    followers_not: str | None = Field(None, alias="followers.not", description="Excludes tasks followed by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    created_by_any: str | None = Field(None, alias="created_by.any", description="Returns tasks created by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    created_by_not: str | None = Field(None, alias="created_by.not", description="Excludes tasks created by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    assigned_by_any: str | None = Field(None, alias="assigned_by.any", description="Returns tasks assigned by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    assigned_by_not: str | None = Field(None, alias="assigned_by.not", description="Excludes tasks assigned by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    liked_by_not: str | None = Field(None, alias="liked_by.not", description="Excludes tasks liked by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    commented_on_by_not: str | None = Field(None, alias="commented_on_by.not", description="Excludes tasks commented on by any of the specified users. Accepts a comma-separated list of user GIDs or the special value 'me'.", examples=['12345,23456,34567']),
    due_on_before: str | None = Field(None, alias="due_on.before", description="Returns tasks with a due date strictly before the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    due_on_after: str | None = Field(None, alias="due_on.after", description="Returns tasks with a due date strictly after the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    due_on: str | None = Field(None, description="Returns tasks with a due date exactly matching the specified date, or pass null to match tasks with no due date. Accepts an ISO 8601 date string or null.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    due_at_before: str | None = Field(None, alias="due_at.before", description="Returns tasks with a due datetime strictly before the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    due_at_after: str | None = Field(None, alias="due_at.after", description="Returns tasks with a due datetime strictly after the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    start_on_before: str | None = Field(None, alias="start_on.before", description="Returns tasks with a start date strictly before the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    start_on_after: str | None = Field(None, alias="start_on.after", description="Returns tasks with a start date strictly after the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    start_on: str | None = Field(None, description="Returns tasks with a start date exactly matching the specified date, or pass null to match tasks with no start date. Accepts an ISO 8601 date string or null.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    created_on_before: str | None = Field(None, alias="created_on.before", description="Returns tasks created strictly before the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    created_on_after: str | None = Field(None, alias="created_on.after", description="Returns tasks created strictly after the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    created_on: str | None = Field(None, description="Returns tasks created on exactly the specified date, or pass null to match tasks with no creation date recorded. Accepts an ISO 8601 date string or null.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    created_at_before: str | None = Field(None, alias="created_at.before", description="Returns tasks created strictly before the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    created_at_after: str | None = Field(None, alias="created_at.after", description="Returns tasks created strictly after the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    completed_on_before: str | None = Field(None, alias="completed_on.before", description="Returns tasks completed strictly before the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    completed_on_after: str | None = Field(None, alias="completed_on.after", description="Returns tasks completed strictly after the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    completed_on: str | None = Field(None, description="Returns tasks completed on exactly the specified date, or pass null to match tasks with no completion date. Accepts an ISO 8601 date string or null.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    completed_at_before: str | None = Field(None, alias="completed_at.before", description="Returns tasks completed strictly before the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    completed_at_after: str | None = Field(None, alias="completed_at.after", description="Returns tasks completed strictly after the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    modified_on_before: str | None = Field(None, alias="modified_on.before", description="Returns tasks last modified strictly before the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    modified_on_after: str | None = Field(None, alias="modified_on.after", description="Returns tasks last modified strictly after the specified date. Accepts an ISO 8601 date string.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    modified_on: str | None = Field(None, description="Returns tasks last modified on exactly the specified date, or pass null to match tasks with no modification date. Accepts an ISO 8601 date string or null.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    modified_at_before: str | None = Field(None, alias="modified_at.before", description="Returns tasks last modified strictly before the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    modified_at_after: str | None = Field(None, alias="modified_at.after", description="Returns tasks last modified strictly after the specified datetime. Accepts an ISO 8601 datetime string with timezone.", examples=['2019-04-15T01:01:46.055Z'], json_schema_extra={'format': 'date-time'}),
    is_blocking: bool | None = Field(None, description="When true, filters to incomplete tasks that have at least one incomplete dependent task blocking them from being considered done.", examples=[False]),
    is_blocked: bool | None = Field(None, description="When true, filters to tasks that have at least one incomplete dependency that must be resolved before the task can be completed.", examples=[False]),
    has_attachment: bool | None = Field(None, description="When true, filters to tasks that have one or more file attachments.", examples=[False]),
    completed: bool | None = Field(None, description="When true, returns only completed tasks; when false, returns only incomplete tasks. Omit to return both.", examples=[False]),
    is_subtask: bool | None = Field(None, description="When true, filters results to subtasks only; when false, excludes subtasks from results.", examples=[False]),
    sort_by: Literal["due_date", "created_at", "completed_at", "likes", "modified_at"] | None = Field('modified_at', description="Field by which to sort the returned tasks. Defaults to 'modified_at'. Use in combination with sort_ascending to control order direction.", examples=['likes']),
    sort_ascending: bool | None = Field(False, description="When true, results are sorted in ascending order by the sort_by field; when false (default), results are sorted in descending order.", examples=[True])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("search_tasks", "GET", "/workspaces/{workspace_gid}/tasks/search", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("search_tasks")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_team_membership(team_membership_gid: str = Field(..., description="The unique identifier (GID) of the team membership record to retrieve.", examples=['724362'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_team_membership", "GET", "/team_memberships/{team_membership_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_team_membership")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_team_memberships(
    limit: int | None = Field(None, description="The number of team membership records to return per page, between 1 and 100.", ge=1, le=100, examples=[50]),
    team: str | None = Field(None, description="The globally unique identifier (GID) of the team whose memberships should be returned.", examples=['159874']),
    user: str | None = Field(None, description="Identifies the user whose team memberships to retrieve; accepts the string \"me\", a user email address, or a user GID. Must be used together with the workspace parameter.", examples=['512241']),
    workspace: str | None = Field(None, description="The globally unique identifier (GID) of the workspace to scope the results to. Must be used together with the user parameter.", examples=['31326'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_team_memberships", "GET", "/team_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_team_memberships")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_team_memberships_for_team(
    team_gid: str = Field(..., description="The globally unique identifier of the team whose memberships you want to retrieve.", examples=['159874']),
    limit: int | None = Field(None, description="The number of membership records to return per page, accepting values between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_team_memberships_for_team", "GET", "/teams/{team_gid}/team_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_team_memberships_for_team")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_user_team_memberships(
    user_gid: str = Field(..., description="The unique identifier for the user whose team memberships will be retrieved. Accepts the string 'me' for the authenticated user, a user's email address, or a user's global ID (gid).", examples=['me']),
    workspace: str = Field(..., description="The globally unique identifier (gid) of the workspace used to scope the team membership results to a specific organization or workspace.", examples=['31326']),
    limit: int | None = Field(None, description="The number of team membership records to return per page, allowing pagination through large result sets. Must be an integer between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_user_team_memberships", "GET", "/users/{user_gid}/team_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_user_team_memberships")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_team(data: _models.TeamRequest | None = Field(None, description="The configuration details for the new team, such as name and settings.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_team", "POST", "/teams", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_team")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Teams
@mcp.tool()
async def get_team(team_gid: str = Field(..., description="The globally unique identifier (GID) for the team to retrieve.", examples=['159874'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_team", "GET", "/teams/{team_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_team")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_team(
    team_gid: str = Field(..., description="The globally unique identifier for the team to be updated.", examples=['159874']),
    ...
    # Log invocation
    _log_tool_invocation("update_team", "PUT", "/teams/{team_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_team")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_workspace_teams(
    workspace_gid: str = Field(..., description="The globally unique identifier for the workspace or organization whose teams you want to retrieve.", examples=['12345']),
    limit: int | None = Field(None, description="The number of team records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_teams", "GET", "/workspaces/{workspace_gid}/teams", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_teams")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_user_teams(
    user_gid: str = Field(..., description="The unique identifier for the user whose teams you want to retrieve. Accepts the literal string 'me' for the authenticated user, a user's email address, or a numeric user GID.", examples=['me']),
    organization: str = Field(..., description="The GID of the workspace or organization used to filter the returned teams, ensuring only teams within that context are included.", examples=['1331']),
    limit: int | None = Field(None, description="The number of team records to return per page. Must be an integer between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_user_teams", "GET", "/users/{user_gid}/teams", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_user_teams")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_team_member(
    team_gid: str = Field(..., description="The unique identifier of the team to which the user will be added.", examples=['159874']),
    user: str | None = Field(None, description="The identifier of the user to add to the team — accepts the literal string 'me' for the current user, a user's email address, or a user's globally unique identifier (GID).", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_team_member", "POST", "/teams/{team_gid}/addUser", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_team_member")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_team_member(
    team_gid: str = Field(..., description="The globally unique identifier of the team from which the user will be removed.", examples=['159874']),
    user: str | None = Field(None, description="The identifier of the user to remove, accepted as the string 'me' (for the requesting user), an email address, or a user GID.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_team_member", "POST", "/teams/{team_gid}/removeUser", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_team_member")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Time periods
@mcp.tool()
async def get_time_period(time_period_gid: str = Field(..., description="The globally unique identifier of the time period to retrieve.", examples=['917392'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_time_period", "GET", "/time_periods/{time_period_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_time_period")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_time_periods(
    workspace: str = Field(..., description="The globally unique identifier of the workspace whose time periods should be retrieved.", examples=['31326']),
    limit: int | None = Field(None, description="The number of time period records to return per page, between 1 and 100.", ge=1, le=100, examples=[50]),
    start_on: str | None = Field(None, description="Filters results to time periods starting on or after this date, specified in ISO 8601 date format.", examples=['2019-09-15'], json_schema_extra={'format': 'date'}),
    end_on: str | None = Field(None, description="Filters results to time periods ending on or before this date, specified in ISO 8601 date format.", examples=['2019-09-15'], json_schema_extra={'format': 'date'})
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_time_periods", "GET", "/time_periods", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_time_periods")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_time_tracking_entries(task_gid: str = Field(..., description="The task to operate on.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_time_tracking_entries", "GET", "/tasks/{task_gid}/time_tracking_entries", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_time_tracking_entries")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_time_entry(
    task_gid: str = Field(..., description="The unique identifier (GID) of the task on which the time tracking entry will be created.", examples=['321654']),
    duration_minutes: int | None = Field(None, description="The amount of time to log for this entry, expressed in whole minutes. Must be greater than 0.", examples=[12]),
    entered_on: str | None = Field(None, description="The calendar date this time entry is logged against, in ISO 8601 date format (YYYY-MM-DD). Defaults to today if omitted.", examples=['2023-03-19'], json_schema_extra={'format': 'date'}),
    attributable_to: str | None = Field(None, description="The GID of the project this time entry should be attributed to, allowing time to be associated with a specific project context.", examples=['987654']),
    billable_status: Literal["billable", "nonBillable", "notApplicable"] | None = Field(None, description="The billable classification of this time entry: 'billable' for client-chargeable time, 'nonBillable' for internal time, or 'notApplicable' when billing status is not relevant.", examples=['billable']),
    description: str | None = Field(None, description="A free-text note describing the work performed during this time entry, providing context for the logged time.", examples=['My description of work done on this entry'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_time_entry", "POST", "/tasks/{task_gid}/time_tracking_entries", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_time_entry")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Time tracking entries
@mcp.tool()
async def get_time_tracking_entry(time_tracking_entry_gid: str = Field(..., description="The globally unique identifier (GID) of the time tracking entry to retrieve.", examples=['917392'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_time_tracking_entry", "GET", "/time_tracking_entries/{time_tracking_entry_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_time_tracking_entry")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_time_tracking_entry(
    time_tracking_entry_gid: str = Field(..., description="The globally unique identifier of the time tracking entry to update.", examples=['917392']),
    duration_minutes: int | None = Field(None, description="The amount of time to log for this entry, expressed in whole minutes.", examples=[12]),
    entered_on: str | None = Field(None, description="The calendar date on which this time entry is logged, in ISO 8601 date format. Defaults to today if not specified.", examples=['2023-03-19'], json_schema_extra={'format': 'date'}),
    attributable_to: str | None = Field(None, description="The unique identifier (GID) of the project to which this time entry's effort is attributed.", examples=['987654']),
    billable_status: Literal["billable", "nonBillable", "notApplicable"] | None = Field(None, description="The billable status of this time entry. Use 'billable' for client-chargeable work, 'nonBillable' for internal work, or 'notApplicable' when billing status is irrelevant.", examples=['billable']),
    description: str | None = Field(None, description="A free-text description summarizing the work performed during this time entry.", examples=['My description of work done on this entry'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_time_tracking_entry", "PUT", "/time_tracking_entries/{time_tracking_entry_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_time_tracking_entry")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Time tracking entries
@mcp.tool()
async def delete_time_tracking_entry(time_tracking_entry_gid: str = Field(..., description="The globally unique identifier (GID) of the time tracking entry to delete.", examples=['917392'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_time_tracking_entry", "DELETE", "/time_tracking_entries/{time_tracking_entry_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_time_tracking_entry")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_time_tracking_entries(
    task: str | None = Field(None, description="The globally unique identifier of the task to scope results to only time tracking entries associated with that task.", examples=['12345']),
    attributable_to: str | None = Field(None, description="The globally unique identifier of the project to scope results to only time tracking entries attributed to that project.", examples=['12345']),
    portfolio: str | None = Field(None, description="The globally unique identifier of the portfolio to scope results to only time tracking entries belonging to tasks within that portfolio.", examples=['12345']),
    user: str | None = Field(None, description="The globally unique identifier of the user to scope results to only time tracking entries logged by that user.", examples=['12345']),
    workspace: str | None = Field(None, description="The globally unique identifier of the workspace to scope results to. When filtering by workspace, at least one of `entered_on_start_date` or `entered_on_end_date` must also be provided.", examples=['98765']),
    entered_on_start_date: str | None = Field(None, description="The inclusive start date for filtering entries by their entry date, in ISO 8601 date format (YYYY-MM-DD). Use together with `entered_on_end_date` to define a date range.", examples=['2025-01-01'], json_schema_extra={'format': 'date'}),
    entered_on_end_date: str | None = Field(None, description="The inclusive end date for filtering entries by their entry date, in ISO 8601 date format (YYYY-MM-DD). Use together with `entered_on_start_date` to define a date range.", examples=['2025-12-31'], json_schema_extra={'format': 'date'}),
    timesheet_approval_status: str | None = Field(None, description="The globally unique identifier of a timesheet approval status to scope results to only time tracking entries matching that approval state.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_time_tracking_entries", "GET", "/time_tracking_entries", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_time_tracking_entries")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_timesheet_approval_status(timesheet_approval_status_gid: str = Field(..., description="The globally unique identifier (GID) of the timesheet approval status record to retrieve.", examples=['917392'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_timesheet_approval_status", "GET", "/timesheet_approval_statuses/{timesheet_approval_status_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_timesheet_approval_status")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_timesheet_approval_status(
    timesheet_approval_status_gid: str = Field(..., description="The globally unique identifier of the timesheet approval status record to update.", examples=['917392']),
    approval_status: Literal["submitted", "draft", "approved", "rejected"] = Field(..., description="The target approval state to transition to. Valid values are 'submitted' (submit for review), 'draft' (recall a submission), 'approved' (approve the timesheet), or 'rejected' (reject the timesheet). Allowed transitions depend on the current state of the record.", examples=['submitted']),
    message: str | None = Field(None, description="An optional message to accompany the status transition, such as a reason for approval or rejection.", examples=['Approved by manager'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_timesheet_approval_status", "PUT", "/timesheet_approval_statuses/{timesheet_approval_status_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_timesheet_approval_status")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_timesheet_approval_statuses(
    workspace: str = Field(..., description="The globally unique identifier of the workspace whose timesheet approval statuses should be retrieved.", examples=['12345']),
    user: str | None = Field(None, description="The globally unique identifier of a specific user to narrow results to only their timesheet approval statuses.", examples=['67890']),
    from_date: str | None = Field(None, description="The inclusive start date for filtering timesheet approval statuses, in ISO 8601 date format (YYYY-MM-DD).", examples=['2025-11-01'], json_schema_extra={'format': 'date'}),
    to_date: str | None = Field(None, description="The inclusive end date for filtering timesheet approval statuses, in ISO 8601 date format (YYYY-MM-DD).", examples=['2025-11-30'], json_schema_extra={'format': 'date'}),
    approval_statuses: str | None = Field(None, description="One or more approval status values to filter by; accepted values are draft, submitted, approved, or rejected. Multiple values may be provided as a comma-separated list.", examples=['draft'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_timesheet_approval_statuses", "GET", "/timesheet_approval_statuses", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_timesheet_approval_statuses")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_timesheet_approval_status(
    user: str = Field(..., description="The globally unique identifier of the user whose timesheet approval status is being created.", examples=['12345']),
    workspace: str = Field(..., description="The globally unique identifier of the workspace in which the timesheet exists.", examples=['12345']),
    start_date: str = Field(..., description="The start date of the timesheet week in ISO 8601 date format; must be a Monday.", examples=['2025-01-06'], json_schema_extra={'format': 'date'}),
    end_date: str = Field(..., description="The end date of the timesheet week in ISO 8601 date format; must be the Sunday immediately following the start date.", examples=['2025-01-12'], json_schema_extra={'format': 'date'})
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_timesheet_approval_status", "POST", "/timesheet_approval_statuses", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_timesheet_approval_status")
    _http_headers.update(_auth.get("headers", {}))
...
async def search_workspace_typeahead(
    workspace_gid: str = Field(..., description="The globally unique identifier for the workspace or organization to search within.", examples=['12345']),
    ...
    query: str | None = Field(None, description="The search string used to match relevant objects by name or other identifying fields. Omitting or passing an empty string returns results ordered by relevance heuristics (e.g., recency or contact frequency) for the authenticated user.", examples=['Greg']),
    count: int | None = Field(None, description="The maximum number of results to return, between 1 and 100. Defaults to 20 if omitted; if fewer matches exist than requested, all available results are returned.", examples=[20])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("search_workspace_typeahead", "GET", "/workspaces/{workspace_gid}/typeahead", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("search_workspace_typeahead")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_user_task_list(user_task_list_gid: str = Field(..., description="The globally unique identifier for the user task list to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_user_task_list", "GET", "/user_task_lists/{user_task_list_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_user_task_list")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_user_task_list_by_user(
    user_gid: str = Field(..., description="The unique identifier for the user whose task list you want to retrieve. Accepts the literal string 'me' for the authenticated user, a user's email address, or a user's global ID (gid).", examples=['me']),
    workspace: str = Field(..., description="The global ID (gid) of the workspace in which to look up the user's task list. Each user has one task list per workspace.", examples=['1234'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_user_task_list_by_user", "GET", "/users/{user_gid}/user_task_list", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_user_task_list_by_user")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_users(
    workspace: str | None = Field(None, description="The unique ID of a workspace or organization to restrict results to only users belonging to that workspace or organization.", examples=['1331']),
    team: str | None = Field(None, description="The unique ID of a team to restrict results to only users belonging to that team.", examples=['15627']),
    limit: int | None = Field(None, description="The number of user records to return per page. Must be an integer between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
...
@mcp.tool()
async def get_user(
    user_gid: str = Field(..., description="The unique identifier for the user to retrieve. Accepts a user GID, an email address, or the string 'me' to reference the currently authenticated user.", examples=['me']),
    workspace: str | None = Field(None, description="The GID of a workspace used to filter the user results, useful when a user belongs to multiple workspaces.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_user", "GET", "/users/{user_gid}", _request_id)
...
async def update_user(
    user_gid: str = Field(..., description="The unique identifier for the target user, which can be the literal string 'me' to reference the authenticated user, a user's email address, or a numeric user GID.", examples=['me']),
    workspace: str | None = Field(None, description="Filters the operation to a specific workspace by its GID, useful when a user belongs to multiple workspaces.", examples=['12345']),
    ...
    # Log invocation
    _log_tool_invocation("update_user", "PUT", "/users/{user_gid}", _request_id)
...
async def list_user_favorites(
    user_gid: str = Field(..., description="The unique identifier of the user whose favorites to retrieve. Accepts the literal string 'me' to reference the authenticated user, a user's email address, or a user's GID.", examples=['me']),
    ...
    workspace: str = Field(..., description="The GID of the workspace in which to look up the user's favorites. All returned favorites will belong to this workspace.", examples=['1234']),
    limit: int | None = Field(None, description="The number of favorite items to return per page. Must be between 1 and 100 inclusive.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_user_favorites", "GET", "/users/{user_gid}/favorites", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_user_favorites")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Users
@mcp.tool()
async def list_team_members(team_gid: str = Field(..., description="The globally unique identifier of the team whose members you want to retrieve.", examples=['159874'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_team_members", "GET", "/teams/{team_gid}/users", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_team_members")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Users
@mcp.tool()
async def list_workspace_users(workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization whose users you want to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_users", "GET", "/workspaces/{workspace_gid}/users", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_users")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_workspace_user(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization in which to look up the user.", examples=['12345']),
    user_gid: str = Field(..., description="The identifier for the target user — accepts the literal string \"me\" (for the authenticated user), a user's email address, or a user's globally unique identifier (GID).", examples=['me'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_workspace_user", "GET", "/workspaces/{workspace_gid}/users/{user_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_workspace_user")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_workspace_user(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization in which the user will be updated.", examples=['12345']),
    user_gid: str = Field(..., description="The identifier of the user to update, which can be the string 'me' to reference the authenticated user, a user's email address, or a user's globally unique identifier (GID).", examples=['me']),
    ...
    # Log invocation
    _log_tool_invocation("update_workspace_user", "PUT", "/workspaces/{workspace_gid}/users/{user_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_workspace_user")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_webhooks(
    workspace: str = Field(..., description="The unique identifier of the workspace to query for registered webhooks.", examples=['1331']),
    resource: str | None = Field(None, description="When provided, filters the returned webhooks to only those associated with the specified resource identifier.", examples=['51648'])
) -> dict[str, Any]:
    """Retrieves all webhooks your app has registered for the authenticated user in a specified workspace. Optionally filter results to webhooks associated with a specific resource."""

    # Construct request model with validation
    try:
        _request = _models.GetWebhooksRequest(
            query=_models.GetWebhooksRequestQuery(workspace=workspace, resource=resource)
        )
    except pydantic.ValidationError as _validation_err:
...
async def create_webhook(
    resource: str = Field(..., description="The GID of the Asana resource to monitor for events (e.g., a task, project, or workspace). Note that higher-level resources such as workspaces require filters to be specified alongside the subscription.", examples=['12345']),
    target: str = Field(..., description="The fully-qualified HTTPS URL that will receive webhook event POST requests. Query parameters may be included to encode application-specific state that will be preserved across all deliveries.", examples=['https://example.com/receive-webhook/7654?app_specific_param=app_specific_value'], json_schema_extra={'format': 'uri'}),
    filters: list[_models.CreateWebhookBodyDataFiltersItem] | None = Field(None, description="An optional array of WebhookFilter objects defining an allowlist of conditions; an event is delivered only if it matches at least one filter. If omitted, all events for the resource are delivered. Order of filters is not significant.")
) -> dict[str, Any]:
    """Creates a webhook subscription that delivers event notifications via HTTP POST to a specified target URL whenever changes occur on the given Asana resource. Requires your target server to complete a synchronous confirmation handshake during the creation request by echoing back the X-Hook-Secret header."""

    # Construct request model with validation
    try:
        _request = _models.CreateWebhookRequest(
            body=_models.CreateWebhookRequestBody(data=_models.CreateWebhookRequestBodyData(resource=resource, target=target, filters=filters))
        )
    except pydantic.ValidationError as _validation_err:
...
# Tags: Webhooks
@mcp.tool()
async def get_webhook(webhook_gid: str = Field(..., description="The globally unique identifier of the webhook to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_webhook", "GET", "/webhooks/{webhook_gid}", _request_id)
...
async def update_webhook(
    webhook_gid: str = Field(..., description="The globally unique identifier of the webhook to update.", examples=['12345']),
    filters: list[_models.UpdateWebhookBodyDataFiltersItem] | None = Field(None, description="An array of WebhookFilter objects defining which events should trigger delivery; the entire existing filters array is replaced by this new array. A webhook event is delivered if it matches any filter in the array.")
) -> dict[str, Any]:
    """Updates the filters for an existing webhook by completely replacing the previous filters array with the new one provided. Requires the webhooks:write scope."""

    # Construct request model with validation
    try:
        _request = _models.UpdateWebhookRequest(
            path=_models.UpdateWebhookRequestPath(webhook_gid=webhook_gid),
            body=_models.UpdateWebhookRequestBody(data=_models.UpdateWebhookRequestBodyData(filters=filters) if any(v is not None for v in [filters]) else None)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("update_webhook", "PUT", "/webhooks/{webhook_gid}", _request_id)
...
# Tags: Webhooks
@mcp.tool()
async def delete_webhook(webhook_gid: str = Field(..., description="The globally unique identifier of the webhook to permanently delete.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_webhook", "DELETE", "/webhooks/{webhook_gid}", _request_id)
...
@mcp.tool()
async def get_workspace_membership(workspace_membership_gid: str = Field(..., description="The unique identifier (GID) of the workspace membership to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_workspace_membership", "GET", "/workspace_memberships/{workspace_membership_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_workspace_membership")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_user_workspace_memberships(
    user_gid: str = Field(..., description="The unique identifier for the user whose workspace memberships to retrieve. Accepts the literal string 'me' for the authenticated user, a registered email address, or a numeric user GID.", examples=['me']),
    limit: int | None = Field(None, description="The number of membership records to return per page. Must be between 1 and 100 inclusive; use pagination to retrieve additional results beyond the first page.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_user_workspace_memberships", "GET", "/users/{user_gid}/workspace_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_user_workspace_memberships")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_workspace_memberships(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization whose memberships you want to retrieve.", examples=['12345']),
    user: str | None = Field(None, description="Filter memberships to a specific user, identified by the string 'me' (current user), an email address, or a user GID.", examples=['me']),
    limit: int | None = Field(None, description="The number of membership records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_memberships", "GET", "/workspaces/{workspace_gid}/workspace_memberships", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_memberships")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Workspaces
@mcp.tool()
async def list_workspaces(limit: int | None = Field(None, description="Number of workspace records to return per page. Must be between 1 and 100.", ge=1, le=100, examples=[50])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspaces", "GET", "/workspaces", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspaces")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Workspaces
@mcp.tool()
async def get_workspace(workspace_gid: str = Field(..., description="The globally unique identifier for the workspace or organization to retrieve.", examples=['12345'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_workspace", "GET", "/workspaces/{workspace_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_workspace")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_workspace(
    workspace_gid: str = Field(..., description="The globally unique identifier of the workspace or organization to update.", examples=['12345']),
    name: str | None = Field(None, description="The new display name to assign to the workspace.", examples=['My Company Workspace'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_workspace", "PUT", "/workspaces/{workspace_gid}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_workspace")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_workspace_user(
    workspace_gid: str = Field(..., description="The unique identifier of the workspace or organization to which the user will be added.", examples=['12345']),
    user: str | None = Field(None, description="The identifier of the user to add, accepted as the literal string 'me' (current user), an email address, or a user GID.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_workspace_user", "POST", "/workspaces/{workspace_gid}/addUser", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_workspace_user")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_workspace_user(
    workspace_gid: str = Field(..., description="The unique identifier of the workspace or organization from which the user will be removed.", examples=['12345']),
    user: str | None = Field(None, description="The identifier of the user to remove, which can be the literal string 'me', an email address, or a user's globally unique ID.", examples=['12345'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_workspace_user", "POST", "/workspaces/{workspace_gid}/removeUser", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_workspace_user")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_workspace_events(
    workspace_gid: str = Field(..., description="The globally unique identifier for the target workspace or organization whose events should be retrieved.", examples=['12345']),
    sync: str | None = Field(None, description="A sync token from a previous response used to fetch only events that occurred after that token was issued; omit this parameter on the first request to receive a fresh token. If the token has expired, the API returns a 412 error along with a new valid sync token to use going forward.", examples=['de4774f6915eae04714ca93bb2f5ee81'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_events", "GET", "/workspaces/{workspace_gid}/events", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_events")
    _http_headers.update(_auth.get("headers", {}))
