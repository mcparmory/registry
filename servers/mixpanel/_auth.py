...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "get_insights_report": [["ServiceAccount"]],
    "get_funnel_data": [["ServiceAccount"]],
    "list_saved_funnels": [["ServiceAccount"]],
    "get_retention_report": [["ServiceAccount"]],
    "get_retention_frequency_report": [["ServiceAccount"]],
    "get_segmented_event_data": [["ServiceAccount"]],
    "get_event_segmentation_by_numeric_buckets": [["ServiceAccount"]],
    "get_event_sum_by_time": [["ServiceAccount"]],
    "get_event_average": [["ServiceAccount"]],
    "get_activity_stream_for_users": [["ServiceAccount"]],
    "list_cohorts": [["ServiceAccount"]],
    "query_profiles": [["ServiceAccount"]],
    "get_event_aggregates": [["ServiceAccount"]],
    "list_top_events": [["ServiceAccount"]],
    "list_top_event_names": [["ServiceAccount"]],
    "get_event_property_aggregates": [["ServiceAccount"]],
    "list_top_event_properties": [["ServiceAccount"]],
    "list_event_property_top_values": [["ServiceAccount"]],
    "execute_jql_script": [["ServiceAccount"]]
}
