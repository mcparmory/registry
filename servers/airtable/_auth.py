...
class OAuth2Auth:
    """
    OAuth 2.0 authentication for Airtable Web API.
    ...
    URLs:
        ...
        Refresh URL: https://airtable.com/oauth2/v1/token
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://airtable.com/oauth2/v1/token")
        self.auth_url = self._resolve_url_template("https://airtable.com/oauth2/v1/authorize")
        self.refresh_url = self._resolve_url_template("https://airtable.com/oauth2/v1/token")
...
class BearerTokenAuth:
    """
    Bearer token authentication for Airtable Web API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "get_current_user": [["oauth2"], ["bearerAuth"]],
    "list_table_records": [["oauth2"], ["bearerAuth"]],
    "create_records": [["oauth2"], ["bearerAuth"]],
    "replace_records": [["oauth2"], ["bearerAuth"]],
    "update_records": [["oauth2"], ["bearerAuth"]],
    "delete_records": [["oauth2"], ["bearerAuth"]],
    "get_record": [["oauth2"], ["bearerAuth"]],
