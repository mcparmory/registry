...
def build_sort_array(sort_fields: list[str] | None = None, sort_directions: list[str] | None = None) -> list[dict] | None:
    ...
    for i, field in enumerate(sort_fields):
        ...
        if direction not in valid_directions:
            raise ValueError(f"Invalid sort direction '{direction}' at index {i}. Must be 'asc' or 'desc'.") from None
        sort_array.append({'field': field, 'direction': direction})
    return sort_array
...
async def list_table_records(
    ...
    time_zone: str | None = Field(None, alias="timeZone", description="The time zone for formatting dates when using string cell format (required if cellFormat is 'string'). Use standard time zone identifiers."),
    user_locale: str | None = Field(None, alias="userLocale", description="The user locale for formatting dates when using string cell format (required if cellFormat is 'string'). Use standard locale codes."),
    page_size: int | None = Field(None, alias="pageSize", description="Number of records to return per page. Must be between 1 and 100 (defaults to 100).", ge=1, le=100),
    max_records: int | None = Field(None, alias="maxRecords", description="The maximum total number of records to return across all paginated requests. Must be at least 1.", ge=1),
    offset: str | None = Field(None, description="Pagination token from a previous response. Include this to fetch the next page of records."),
    view: str | None = Field(None, description="Filter results to a specific view by its name or ID. Only records visible in that view will be returned."),
    filter_by_formula: str | None = Field(None, alias="filterByFormula", description="A formula to filter records. Records are included if the formula evaluates to a truthy value (excluding 0, false, empty string, NaN, empty array, or #Error!)."),
    ...
    sort = build_sort_array(sort_fields, sort_directions)

    # Construct request model with validation
    try:
        _request = _models.GetV0BaseidTableidornameRequest(
            path=_models.GetV0BaseidTableidornameRequestPath(base_id=base_id, table_id_or_name=table_id_or_name),
            query=_models.GetV0BaseidTableidornameRequestQuery(time_zone=time_zone, user_locale=user_locale, page_size=page_size, max_records=max_records, offset=offset, view=view, filter_by_formula=filter_by_formula, cell_format=cell_format, record_metadata=record_metadata, sort=sort)
        )
...
async def create_records(
    ...
    # Construct request model with validation
    try:
        _request = _models.PostV0BaseidTableidornameRequest(
            path=_models.PostV0BaseidTableidornameRequestPath(base_id=base_id, table_id_or_name=table_id_or_name),
            body=_models.PostV0BaseidTableidornameRequestBody(records=records, typecast=typecast)
        )
    except pydantic.ValidationError as _validation_err:
...
async def replace_records(
    ...
    # Construct request model with validation
    try:
        _request = _models.PutV0BaseidTableidornameRequest(
            path=_models.PutV0BaseidTableidornameRequestPath(base_id=base_id, table_id_or_name=table_id_or_name),
            body=_models.PutV0BaseidTableidornameRequestBody(typecast=typecast, records=records,
                perform_upsert=_models.PutV0BaseidTableidornameRequestBodyPerformUpsert(fields_to_merge_on=fields_to_merge_on))
        )
    except pydantic.ValidationError as _validation_err:
...
async def update_records(
    ...
    # Construct request model with validation
    try:
        _request = _models.PatchV0BaseidTableidornameRequest(
            path=_models.PatchV0BaseidTableidornameRequestPath(base_id=base_id, table_id_or_name=table_id_or_name),
            body=_models.PatchV0BaseidTableidornameRequestBody(typecast=typecast, records=records,
                perform_upsert=_models.PatchV0BaseidTableidornameRequestBodyPerformUpsert(fields_to_merge_on=fields_to_merge_on))
        )
    except pydantic.ValidationError as _validation_err:
...
async def delete_records(
    ...
    # Construct request model with validation
    try:
        _request = _models.DeleteV0BaseidTableidornameRequest(
            path=_models.DeleteV0BaseidTableidornameRequestPath(base_id=base_id, table_id_or_name=table_id_or_name),
            query=_models.DeleteV0BaseidTableidornameRequestQuery(records=records)
        )
    except pydantic.ValidationError as _validation_err:
...
async def get_record(
    ...
    # Construct request model with validation
    try:
        _request = _models.GetV0BaseidTableidornameRecordidRequest(
            path=_models.GetV0BaseidTableidornameRecordidRequestPath(base_id=base_id, table_id_or_name=table_id_or_name, record_id=record_id),
            query=_models.GetV0BaseidTableidornameRecordidRequestQuery(cell_format=cell_format)
        )
    except pydantic.ValidationError as _validation_err:
...
async def replace_record(
    ...
    # Construct request model with validation
    try:
        _request = _models.PutV0BaseidTableidornameRecordidRequest(
            path=_models.PutV0BaseidTableidornameRecordidRequestPath(base_id=base_id, table_id_or_name=table_id_or_name, record_id=record_id),
            body=_models.PutV0BaseidTableidornameRecordidRequestBody(typecast=typecast, fields=fields)
        )
    except pydantic.ValidationError as _validation_err:
...
async def update_record(
    ...
    # Construct request model with validation
    try:
        _request = _models.PatchV0BaseidTableidornameRecordidRequest(
            path=_models.PatchV0BaseidTableidornameRecordidRequestPath(base_id=base_id, table_id_or_name=table_id_or_name, record_id=record_id),
            body=_models.PatchV0BaseidTableidornameRecordidRequestBody(typecast=typecast, fields=fields)
        )
    except pydantic.ValidationError as _validation_err:
...
async def delete_record(
    ...
    # Construct request model with validation
    try:
        _request = _models.DeleteV0BaseidTableidornameRecordidRequest(
            path=_models.DeleteV0BaseidTableidornameRecordidRequestPath(base_id=base_id, table_id_or_name=table_id_or_name, record_id=record_id)
        )
    except pydantic.ValidationError as _validation_err:
...
async def sync_table_data(
    ...
    # Construct request model with validation
    try:
        _request = _models.PostV0BaseidTableidornameSyncApiendpointsyncidRequest(
            path=_models.PostV0BaseidTableidornameSyncApiendpointsyncidRequestPath(base_id=base_id, table_id_or_name=table_id_or_name, api_endpoint_sync_id=api_endpoint_sync_id),
            body=_models.PostV0BaseidTableidornameSyncApiendpointsyncidRequestBody(body=body)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    _http_headers = {}
    _http_headers["Content-Type"] = "text/csv"
...
async def upload_attachment(
    ...
    # Construct request model with validation
    try:
        _request = _models.PostV0BaseidRecordidAttachmentfieldidornameUploadattachmentRequest(
            path=_models.PostV0BaseidRecordidAttachmentfieldidornameUploadattachmentRequestPath(base_id=base_id, record_id=record_id, attachment_field_id_or_name=attachment_field_id_or_name),
            body=_models.PostV0BaseidRecordidAttachmentfieldidornameUploadattachmentRequestBody(content_type=content_type, file_=file_, filename=filename)
        )
    except pydantic.ValidationError as _validation_err:
...
def validate_environment() -> None:
    ...
    if errors:
        ...
        print("  python airtable_server.py", file=sys.stderr)
        print("=" * 70, file=sys.stderr)
        sys.exit(1)
