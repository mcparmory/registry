"""
Authentication module for Google Analytics MCP server.
...
class OAuth2Auth:
    """
    OAuth 2.0 authentication for Google Analytics Data API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "run_pivot_reports_batch": [["OAuth2"]],
    "run_reports_batch": [["OAuth2"]],
    "validate_report_compatibility": [["OAuth2"]],
    "get_audience_export": [["OAuth2"]],
    "generate_pivot_report": [["OAuth2"]],
    "get_realtime_report": [["OAuth2"]],
    "run_report": [["OAuth2"]],
    "list_audience_exports": [["OAuth2"]],
    "create_audience_export": [["OAuth2"]],
    "query_audience_export": [["OAuth2"]]
}
