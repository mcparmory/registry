"""
Authentication module for Shopify Admin API MCP server.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    ...
    "get_checkouts_count": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "get_province": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "get_customer_saved_search": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    "update_customer_saved_search": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    "delete_customer_saved_search": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    "list_customers_for_saved_search": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "add_address_for_customer": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    "update_customer_addresses": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "lookup_discount_code": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "get_fulfillment_count": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    "get_fulfillment": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    "update_fulfillment": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    "cancel_fulfillment_order_2": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "create_discount_code": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "count_product_images": [["OAuth2Auth"], ["CustomAppAccessToken"]],
    ...
    "get_usage_charge": [["OAuth2Auth"], ["CustomAppAccessToken"]],
