...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "add_domain_to_workspace": [["apiKey"]],
    "get_link": [["apiKey"]],
    "create_or_update_link": [["apiKey"]],
    "get_link_analytics": [["apiKey"]],
    "list_webhooks_for_link": [["apiKey"]],
    "get_clicks_analytics": [["apiKey"]],
    "get_click_counters_by_dimension": [["apiKey"]],
    "list_domains": [["apiKey"]],
    "add_domain_to_workspace_by_id": [["apiKey"]],
    "delete_domain": [["apiKey"]],
    "update_domain_favicon": [["apiKey"]],
    "create_or_update_link_batch": [["apiKey"]],
    "delete_links": [["apiKey"]],
    "export_links": [["apiKey"]],
    "delete_link": [["apiKey"]],
    "list_links": [["apiKey"]],
    "list_workspaces": [["apiKey"]],
    "delete_webhook_from_link": [["apiKey"]]
}
