...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    ...
    "delete_label": [["OAuth2"]],
    "delete_messages_batch": [["OAuth2"]],
    "update_message_labels_batch": [["OAuth2"]],
    "get_message": [["OAuth2"]],
    ...
    "send_message": [["OAuth2"]],
    "move_message_to_trash": [["OAuth2"]],
    "remove_message_from_trash": [["OAuth2"]],
    "get_message_attachment": [["OAuth2"]],
    ...
    "list_cse_keypairs": [["OAuth2"]],
    "create_cse_keypair": [["OAuth2"]],
    "disable_cse_keypair": [["OAuth2"]],
    "enable_cse_keypair": [["OAuth2"]],
    "get_cse_keypair": [["OAuth2"]],
    "delete_cse_keypair_permanently": [["OAuth2"]],
    ...
    "send_verification_email_to_send_as_alias": [["OAuth2"]],
    "get_smime_info": [["OAuth2"]],
    "delete_send_as_smime_config": [["OAuth2"]],
    "list_smime_configs": [["OAuth2"]],
    "create_smime_config": [["OAuth2"]],
    "set_default_smime_config": [["OAuth2"]],
    "get_thread": [["OAuth2"]],
    "delete_thread": [["OAuth2"]],
    "list_threads": [["OAuth2"]],
    "update_thread_labels": [["OAuth2"]],
    "move_thread_to_trash": [["OAuth2"]],
    "remove_thread_from_trash": [["OAuth2"]]
}
