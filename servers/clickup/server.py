...
Generated: 2026-03-26 23:33:24 UTC
...
async def upload_task_attachment(
    task_id: str = Field(..., description="The unique identifier of the task to which the file will be attached.", examples=['9hv']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of the default system-generated task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when referencing a task by its custom task ID. Must be provided alongside custom_task_ids=true.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("upload_task_attachment", "POST", "/v2/task/{task_id}/attachment", _request_id)
    ...
    _auth = _get_auth_for_operation("upload_task_attachment")
...
async def exchange_oauth_token(
    client_id: str = Field(..., description="The unique client identifier issued to your OAuth application upon registration."),
    client_secret: str = Field(..., description="The confidential client secret issued to your OAuth application, used alongside the client ID to authenticate your app."),
    code: str = Field(..., description="The short-lived authorization code received in the redirect URL after the user grants access during the OAuth flow.")
) -> dict[str, Any]:
    """Exchanges an OAuth authorization code for an access token using your app's client credentials. Required as part of the OAuth flow for third-party application authentication; not applicable for personal API token usage."""

    # Construct request model with validation
    try:
        _request = _models.GetAccessTokenRequest(
            body=_models.GetAccessTokenRequestBody(client_id=client_id, client_secret=client_secret, code=code)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("exchange_oauth_token", "POST", "/v2/oauth/token", _request_id)

    # Extract parameters for API call
    _http_path = "/v2/oauth/token"
    _http_body = _request.body.model_dump(by_alias=True, exclude_none=True) if _request.body else None
    _http_headers = {}
...
async def get_current_user() -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_current_user", "GET", "/v2/user", _request_id)
...
async def list_workspaces() -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspaces", "GET", "/v2/team", _request_id)
...
async def create_checklist(
    task_id: str = Field(..., description="The unique identifier of the task to which the checklist will be added.", examples=['9hz']),
    name: str = Field(..., description="The display name for the new checklist."),
    custom_task_ids: bool | None = Field(None, description="Set to true if referencing the task by its custom task ID instead of the default system-generated task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs; must be provided alongside custom_task_ids=true.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("create_checklist", "POST", "/v2/task/{task_id}/checklist", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_checklist")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_checklist(
    checklist_id: str = Field(..., description="The unique identifier (UUID) of the checklist to update.", examples=['b955c4dc']),
    ...
    # Log invocation
    _log_tool_invocation("update_checklist", "PUT", "/v2/checklist/{checklist_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_checklist")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Task Checklists
@mcp.tool()
async def delete_checklist(checklist_id: str = Field(..., description="The unique identifier (UUID) of the checklist to delete.", examples=['b955c4dc'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_checklist", "DELETE", "/v2/checklist/{checklist_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_checklist")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_checklist_item(
    checklist_id: str = Field(..., description="The unique identifier of the checklist to which the new item will be added.", examples=['b955c4dc']),
    ...
    # Log invocation
    _log_tool_invocation("create_checklist_item", "POST", "/v2/checklist/{checklist_id}/checklist_item", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_checklist_item")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_checklist_item(
    checklist_id: str = Field(..., description="The unique identifier of the checklist that contains the item to be updated.", examples=['b955c4dc']),
    checklist_item_id: str = Field(..., description="The unique identifier of the specific checklist item to update.", examples=['21e08dc8']),
    ...
    # Log invocation
    _log_tool_invocation("update_checklist_item", "PUT", "/v2/checklist/{checklist_id}/checklist_item/{checklist_item_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_checklist_item")
    _http_headers.update(_auth.get("headers", {}))
...
async def delete_checklist_item(
    checklist_id: str = Field(..., description="The unique identifier (UUID) of the checklist from which the item will be deleted.", examples=['b955c4dc']),
    checklist_item_id: str = Field(..., description="The unique identifier (UUID) of the specific checklist item to be deleted.", examples=['21e08dc8'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_checklist_item", "DELETE", "/v2/checklist/{checklist_id}/checklist_item/{checklist_item_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_checklist_item")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_comments(
    task_id: str = Field(..., description="The unique identifier of the task whose comments you want to retrieve.", examples=['9hz']),
    custom_task_ids: bool | None = Field(None, description="Set to `true` if referencing the task by its custom task ID instead of the default ClickUp task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID (team ID) required when `custom_task_ids` is set to `true` to correctly resolve the custom task ID.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_comments", "GET", "/v2/task/{task_id}/comment", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_comments")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_comment(
    task_id: str = Field(..., description="The unique identifier of the task to which the comment will be added.", examples=['9hz']),
    ...
    custom_task_ids: bool | None = Field(None, description="Set to true if referencing the task by its custom task ID instead of the default system-generated ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs. Must be provided alongside custom_task_ids=true.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("add_task_comment", "POST", "/v2/task/{task_id}/comment", _request_id)
...
async def list_chat_view_comments(
    view_id: str = Field(..., description="The unique identifier of the Chat view whose comments you want to retrieve.", examples=['3c']),
    ...
    # Log invocation
    _log_tool_invocation("list_chat_view_comments", "GET", "/v2/view/{view_id}/comment", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_chat_view_comments")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_chat_view_comment(
    view_id: str = Field(..., description="The unique identifier of the Chat view to which the comment will be added.", examples=['3c']),
    ...
    # Log invocation
    _log_tool_invocation("create_chat_view_comment", "POST", "/v2/view/{view_id}/comment", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_chat_view_comment")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_comments(
    list_id: float = Field(..., description="The unique identifier of the List whose comments you want to retrieve.", examples=[124]),
    ...
    # Log invocation
    _log_tool_invocation("list_comments", "GET", "/v2/list/{list_id}/comment", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_comments")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_list_comment(
    list_id: float = Field(..., description="The unique identifier of the List to which the comment will be added.", examples=[124]),
    ...
    # Log invocation
    _log_tool_invocation("add_list_comment", "POST", "/v2/list/{list_id}/comment", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_list_comment")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_comment(
    comment_id: float = Field(..., description="The unique identifier of the comment to update.", examples=[456]),
    ...
    # Log invocation
    _log_tool_invocation("update_comment", "PUT", "/v2/comment/{comment_id}", _request_id)
...
# Tags: Comments
@mcp.tool()
async def delete_comment(comment_id: float = Field(..., description="The unique numeric identifier of the comment to delete.", examples=[456])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_comment", "DELETE", "/v2/comment/{comment_id}", _request_id)
...
# Tags: Comments
@mcp.tool()
async def list_comment_replies(comment_id: float = Field(..., description="The unique identifier of the parent comment whose threaded replies should be retrieved.", examples=[456])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_comment_replies", "GET", "/v2/comment/{comment_id}/reply", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_comment_replies")
    _http_headers.update(_auth.get("headers", {}))
...
async def reply_to_comment(
    comment_id: float = Field(..., description="The unique identifier of the parent comment to reply to.", examples=[456]),
    ...
    # Log invocation
    _log_tool_invocation("reply_to_comment", "POST", "/v2/comment/{comment_id}/reply", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("reply_to_comment")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_custom_fields(
    list_id: float = Field(..., description="The unique numeric identifier of the List whose Custom Fields you want to retrieve.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type format for the request, indicating the content format expected by the API.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_custom_fields", "GET", "/v2/list/{list_id}/field", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_custom_fields")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_folder_custom_fields(
    folder_id: float = Field(..., description="The unique numeric identifier of the folder whose custom fields you want to retrieve.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, used to indicate the format of the data being sent to the server.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_folder_custom_fields", "GET", "/v2/folder/{folder_id}/field", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_folder_custom_fields")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_space_custom_fields(
    space_id: float = Field(..., description="The unique identifier of the Space whose Custom Fields you want to retrieve.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, used to indicate the format of the data being sent.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_space_custom_fields", "GET", "/v2/space/{space_id}/field", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_space_custom_fields")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_workspace_custom_fields(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose Workspace-level Custom Fields you want to retrieve.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, indicating the format of the request body sent to the API.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_custom_fields", "GET", "/v2/team/{team_id}/field", _request_id)
...
async def set_task_custom_field_value(
    task_id: str = Field(..., description="The unique identifier of the task you want to update with a Custom Field value.", examples=['9hv']),
    field_id: str = Field(..., description="The universally unique identifier (UUID) of the Custom Field you want to set. Retrieve this from the Get Accessible Custom Fields or Get Task endpoints.", examples=['b955c4dc']),
    custom_task_ids: bool | None = Field(None, description="Set to true if you are referencing the task by its Custom Task ID instead of the standard task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when referencing a task by its Custom Task ID. Must be provided alongside custom_task_ids=true.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("set_task_custom_field_value", "POST", "/v2/task/{task_id}/field/{field_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("set_task_custom_field_value")
    _http_headers.update(_auth.get("headers", {}))
...
async def clear_task_custom_field_value(
    task_id: str = Field(..., description="The unique identifier of the task from which the Custom Field value will be cleared.", examples=['9hv']),
    field_id: str = Field(..., description="The UUID of the Custom Field whose value should be removed from the task.", examples=['b955c4dc']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of the default ClickUp task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID (team_id) required when using custom task IDs; must be paired with custom_task_ids=true.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("clear_task_custom_field_value", "DELETE", "/v2/task/{task_id}/field/{field_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("clear_task_custom_field_value")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_dependency(
    task_id: str = Field(..., description="The ID of the task for which the dependency relationship is being defined — either the task that is waiting on another task or the task that is blocking another task.", examples=['9hv']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference tasks by their custom task IDs instead of their default system-generated IDs. Requires `team_id` to also be provided.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when `custom_task_ids` is true, used to resolve custom task IDs within the correct Workspace scope.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("add_task_dependency", "POST", "/v2/task/{task_id}/dependency", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_dependency")
    _http_headers.update(_auth.get("headers", {}))
...
async def delete_task_dependency(
    task_id: str = Field(..., description="The unique identifier of the primary task whose dependency relationship is being removed.", examples=['9hv']),
    depends_on: str = Field(..., description="The ID of the task that the primary task depends on — i.e., the prerequisite task to be unlinked.", examples=['9hz']),
    dependency_of: str = Field(..., description="The ID of the task that depends on the primary task — i.e., the downstream task to be unlinked.", examples=['9hz']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference tasks by their custom task IDs instead of their system-generated IDs. Requires the team_id parameter to also be provided.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID (team) required when using custom task IDs. Must be provided alongside custom_task_ids=true to correctly resolve custom task references.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_task_dependency", "DELETE", "/v2/task/{task_id}/dependency", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_task_dependency")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def link_task(
    task_id: str = Field(..., description="The ID of the task initiating the link (the source task).", examples=['9hv']),
    links_to: str = Field(..., description="The ID of the task to link to (the target task).", examples=['9hz']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference tasks by their custom task IDs instead of their default system IDs. Requires team_id to also be provided when enabled.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID (team) required when custom_task_ids is set to true, used to resolve custom task IDs within the correct workspace scope.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("link_task", "POST", "/v2/task/{task_id}/link/{links_to}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("link_task")
    _http_headers.update(_auth.get("headers", {}))
...
async def delete_task_link(
    task_id: str = Field(..., description="The unique identifier of the source task from which the link will be removed.", examples=['9hv']),
    links_to: str = Field(..., description="The unique identifier of the target task that is currently linked to the source task.", examples=['9hz']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference tasks by their custom task IDs instead of their default system-generated IDs. Requires the team_id parameter to also be provided.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs. Must be provided alongside custom_task_ids=true to correctly resolve tasks within the specified Workspace.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_task_link", "DELETE", "/v2/task/{task_id}/link/{links_to}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_task_link")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_folders(
    space_id: float = Field(..., description="The unique identifier of the Space whose Folders you want to retrieve.", examples=[789]),
    archived: bool | None = Field(None, description="When set to true, returns only archived Folders; when false or omitted, returns only active Folders.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_folders", "GET", "/v2/space/{space_id}/folder", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_folders")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_folder(
    space_id: float = Field(..., description="The unique identifier of the Space in which the new folder will be created.", examples=[789]),
    ...
    # Log invocation
    _log_tool_invocation("create_folder", "POST", "/v2/space/{space_id}/folder", _request_id)
...
# Tags: Folders
@mcp.tool()
async def get_folder(folder_id: float = Field(..., description="The unique numeric identifier of the folder to retrieve.", examples=[457])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_folder", "GET", "/v2/folder/{folder_id}", _request_id)
...
async def rename_folder(
    folder_id: float = Field(..., description="The unique numeric identifier of the folder to rename.", examples=[457]),
    ...
    # Log invocation
    _log_tool_invocation("rename_folder", "PUT", "/v2/folder/{folder_id}", _request_id)
...
# Tags: Folders
@mcp.tool()
async def delete_folder(folder_id: float = Field(..., description="The unique numeric identifier of the folder to be deleted.", examples=[457])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_folder", "DELETE", "/v2/folder/{folder_id}", _request_id)
...
async def list_goals(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose Goals you want to retrieve.", examples=[123]),
    include_completed: bool | None = Field(None, description="When set to true, completed Goals are included in the response alongside active ones; omitting this parameter or setting it to false returns only active Goals.", examples=[True])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_goals", "GET", "/v2/team/{team_id}/goal", _request_id)
...
async def create_goal(
    team_id: float = Field(..., description="The unique identifier of the Workspace where the Goal will be created.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("create_goal", "POST", "/v2/team/{team_id}/goal", _request_id)
...
# Tags: Goals
@mcp.tool()
async def get_goal(goal_id: str = Field(..., description="The unique UUID identifier of the goal to retrieve.", examples=['e53a033c'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_goal", "GET", "/v2/goal/{goal_id}", _request_id)
...
async def update_goal(
    goal_id: str = Field(..., description="The unique identifier (UUID) of the Goal to update.", examples=['e53a033c']),
    ...
    # Log invocation
    _log_tool_invocation("update_goal", "PUT", "/v2/goal/{goal_id}", _request_id)
...
async def delete_goal(
    goal_id: str = Field(..., description="The unique identifier (UUID) of the Goal to be deleted.", examples=['e53a033c']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, used to indicate the format of the data being sent.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_goal", "DELETE", "/v2/goal/{goal_id}", _request_id)
...
async def create_key_result(
    goal_id: str = Field(..., description="The unique identifier of the goal to which this key result will be added.", examples=['e53a033c']),
    ...
    # Log invocation
    _log_tool_invocation("create_key_result", "POST", "/v2/goal/{goal_id}/key_result", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_key_result")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_key_result(
    key_result_id: str = Field(..., description="The unique identifier of the key result to update.", examples=['947d46ed']),
    ...
    # Log invocation
    _log_tool_invocation("update_key_result", "PUT", "/v2/key_result/{key_result_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_key_result")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Goals
@mcp.tool()
async def delete_key_result(key_result_id: str = Field(..., description="The unique identifier (UUID) of the key result to delete.", examples=['947d46ed'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_key_result", "DELETE", "/v2/key_result/{key_result_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_key_result")
    _http_headers.update(_auth.get("headers", {}))
...
async def invite_workspace_guest(
    team_id: float = Field(..., description="The unique identifier of the Workspace to which the guest will be invited.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("invite_workspace_guest", "POST", "/v2/team/{team_id}/guest", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("invite_workspace_guest")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def get_guest(
    team_id: float = Field(..., description="The unique identifier of the Workspace (team) containing the guest.", examples=[123]),
    guest_id: float = Field(..., description="The unique identifier of the guest user to retrieve.", examples=[403])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_guest", "GET", "/v2/team/{team_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_guest")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_workspace_guest(
    team_id: float = Field(..., description="The unique identifier of the Workspace where the guest resides.", examples=[123]),
    guest_id: float = Field(..., description="The unique identifier of the guest whose settings are being updated.", examples=[403]),
    ...
    # Log invocation
    _log_tool_invocation("update_workspace_guest", "PUT", "/v2/team/{team_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_workspace_guest")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_workspace_guest(
    team_id: float = Field(..., description="The unique identifier of the Workspace from which the guest will be removed.", examples=[123]),
    guest_id: float = Field(..., description="The unique identifier of the guest whose Workspace access will be revoked.", examples=[403])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_workspace_guest", "DELETE", "/v2/team/{team_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_workspace_guest")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_guest_to_task(
    task_id: str = Field(..., description="The unique identifier of the task to share with the guest.", examples=['c04']),
    guest_id: float = Field(..., description="The unique numeric identifier of the guest user to add to the task.", examples=[403]),
    ...
    include_shared: bool | None = Field(None, description="Whether to include details of items shared with the guest in the response. Set to false to exclude shared item details; defaults to true.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_guest_to_task", "POST", "/v2/task/{task_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_guest_to_task")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_guest(
    task_id: str = Field(..., description="The unique identifier of the task from which the guest's access will be revoked.", examples=['c04']),
    guest_id: float = Field(..., description="The numeric identifier of the guest user whose access to the task will be removed.", examples=[403]),
    include_shared: bool | None = Field(None, description="Controls whether the response includes details of other items shared with the guest. Set to false to exclude shared item details; defaults to true.", examples=[False]),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of the standard ClickUp task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs. Must be provided alongside custom_task_ids=true to correctly resolve the task.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_task_guest", "DELETE", "/v2/task/{task_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_task_guest")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_guest_to_list(
    list_id: float = Field(..., description="The unique identifier of the List to share with the guest.", examples=[1427]),
    guest_id: float = Field(..., description="The unique identifier of the guest user to add to the List.", examples=[403]),
    ...
    include_shared: bool | None = Field(None, description="Whether to include details of items already shared with the guest. Set to false to exclude shared item details; defaults to true.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_guest_to_list", "POST", "/v2/list/{list_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_guest_to_list")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_list_guest(
    list_id: float = Field(..., description="The unique identifier of the List from which the guest's access will be revoked.", examples=[1427]),
    guest_id: float = Field(..., description="The unique identifier of the guest whose access to the List will be removed.", examples=[403]),
    include_shared: bool | None = Field(None, description="Controls whether the response includes details of items shared with the guest. Set to false to exclude shared item details; defaults to true.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_list_guest", "DELETE", "/v2/list/{list_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_list_guest")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_guest_to_folder(
    folder_id: float = Field(..., description="The unique identifier of the folder to share with the guest.", examples=[1057]),
    guest_id: float = Field(..., description="The unique identifier of the guest user to whom folder access will be granted.", examples=[403]),
    ...
    include_shared: bool | None = Field(None, description="Whether to include details of items already shared with the guest in the response. Set to false to exclude shared item details.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_guest_to_folder", "POST", "/v2/folder/{folder_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_guest_to_folder")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_folder_guest(
    folder_id: float = Field(..., description="The unique numeric identifier of the Folder from which the guest's access will be revoked.", examples=[1057]),
    guest_id: float = Field(..., description="The unique numeric identifier of the guest whose access to the Folder will be removed.", examples=[403]),
    include_shared: bool | None = Field(None, description="When set to false, the response excludes details of items shared with the guest; defaults to true to include shared item details.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_folder_guest", "DELETE", "/v2/folder/{folder_id}/guest/{guest_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_folder_guest")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_folder_lists(
    folder_id: float = Field(..., description="The unique identifier of the Folder whose Lists you want to retrieve.", examples=[456]),
    archived: bool | None = Field(None, description="When set to true, includes archived Lists in the response alongside active ones. Defaults to false, returning only active Lists.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_folder_lists", "GET", "/v2/folder/{folder_id}/list", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_folder_lists")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_list(
    folder_id: float = Field(..., description="The unique identifier of the Folder in which the new List will be created.", examples=[456]),
    ...
    # Log invocation
    _log_tool_invocation("create_list", "POST", "/v2/folder/{folder_id}/list", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_list")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_folder_from_template(
    ...
    template_id: str = Field(..., description="The unique identifier of the Folder template to apply, always prefixed with `t-`. Retrieve available template IDs using the Get Folder Templates endpoint.", examples=['t-7162342']),
    name: str = Field(..., description="The display name to assign to the newly created Folder."),
    return_immediately: bool | None = Field(True, description="When true, returns the new Folder ID immediately after access checks without waiting for all nested assets to finish being created. When false, the request waits until the Folder and all its contents are fully created before responding."),
    ...
    start_date: str | None = Field(None, description="The project start date used as the anchor point for remapping task dates from the template. Must be provided in ISO 8601 date-time format.", json_schema_extra={'format': 'date-time'}),
    due_date: str | None = Field(None, description="The project due date used as the anchor point for remapping task dates from the template. Must be provided in ISO 8601 date-time format.", json_schema_extra={'format': 'date-time'}),
    ...
    # Log invocation
    _log_tool_invocation("create_folder_from_template", "POST", "/v2/space/{space_id}/folder_template/{template_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_folder_from_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_folderless_lists(
    space_id: float = Field(..., description="The unique identifier of the Space whose folderless Lists you want to retrieve.", examples=[789]),
    archived: bool | None = Field(None, description="When set to true, includes archived Lists in the response alongside active ones.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_folderless_lists", "GET", "/v2/space/{space_id}/list", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_folderless_lists")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_folderless_list(
    space_id: float = Field(..., description="The unique identifier of the Space in which the new List will be created.", examples=[789]),
    name: str = Field(..., description="The display name for the new List."),
    ...
    # Log invocation
    _log_tool_invocation("create_folderless_list", "POST", "/v2/space/{space_id}/list", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_folderless_list")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Lists
@mcp.tool()
async def get_list(list_id: float = Field(..., description="The unique numeric identifier of the List to retrieve. To locate this ID, right-click the List in your Sidebar, select Copy link, and extract the last segment of the pasted URL.", examples=[124])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_list", "GET", "/v2/list/{list_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_list")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_list(
    list_id: str = Field(..., description="The unique identifier of the List to update.", examples=['124']),
    ...
    due_parsed = parse_due(due) or {}

    # Construct request model with validation
    try:
        _request = _models.UpdateListRequest(
            path=_models.UpdateListRequestPath(list_id=list_id),
            body=_models.UpdateListRequestBody(name=name, markdown_content=markdown_content, priority=priority, assignee=assignee, status=status, unset_status=unset_status, due_date=due_parsed.get('due_date'), due_date_time=due_parsed.get('due_date_time'))
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("update_list", "PUT", "/v2/list/{list_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_list")
    _http_headers.update(_auth.get("headers", {}))
...
async def delete_list(
    list_id: float = Field(..., description="The unique numeric identifier of the List to be deleted.", examples=[124]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, used to indicate the format of the data being sent.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_list", "DELETE", "/v2/list/{list_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_list")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_task_to_list(
    list_id: float = Field(..., description="The unique numeric identifier of the list to which the task will be added.", examples=[123]),
    task_id: str = Field(..., description="The unique string identifier of the task to add to the specified list.", examples=['9hz'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_task_to_list", "POST", "/v2/list/{list_id}/task/{task_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_task_to_list")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_from_list(
    list_id: float = Field(..., description="The unique numeric identifier of the List from which the task should be removed. Must not be the task's home List.", examples=[123]),
    task_id: str = Field(..., description="The unique string identifier of the task to remove from the specified List.", examples=['9hz'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_task_from_list", "DELETE", "/v2/list/{list_id}/task/{task_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_task_from_list")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Members
@mcp.tool()
async def list_task_members(task_id: str = Field(..., description="The unique identifier of the task whose explicit members you want to retrieve.", examples=['9hz'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_members", "GET", "/v2/task/{task_id}/member", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_task_members")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Members
@mcp.tool()
async def list_list_members(list_id: float = Field(..., description="The unique numeric identifier of the List whose explicit members you want to retrieve.", examples=[123])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_list_members", "GET", "/v2/list/{list_id}/member", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_list_members")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_custom_roles(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose Custom Roles you want to retrieve.", examples=[123]),
    include_members: bool | None = Field(None, description="When set to true, the response will include the list of members assigned to each Custom Role.", examples=[True])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_custom_roles", "GET", "/v2/team/{team_id}/customroles", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_custom_roles")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def list_shared_hierarchy(team_id: float = Field(..., description="The unique identifier of the workspace whose shared content you want to retrieve.", examples=[123])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_shared_hierarchy", "GET", "/v2/team/{team_id}/shared", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_shared_hierarchy")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_spaces(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose Spaces you want to retrieve.", examples=[123]),
    archived: bool | None = Field(None, description="When set to true, returns only archived Spaces; when false or omitted, returns only active Spaces.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_spaces", "GET", "/v2/team/{team_id}/space", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_spaces")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_space(
    team_id: float = Field(..., description="The unique identifier of the Workspace (team) in which the new Space will be created.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("create_space", "POST", "/v2/team/{team_id}/space", _request_id)
...
# Tags: Spaces
@mcp.tool()
async def get_space(space_id: float = Field(..., description="The unique numeric identifier of the Space to retrieve.", examples=[790])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_space", "GET", "/v2/space/{space_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_space")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_space(
    space_id: float = Field(..., description="The unique identifier of the Space to update.", examples=[790]),
    ...
    # Log invocation
    _log_tool_invocation("update_space", "PUT", "/v2/space/{space_id}", _request_id)
...
# Tags: Spaces
@mcp.tool()
async def delete_space(space_id: float = Field(..., description="The unique numeric identifier of the Space to be deleted.", examples=[790])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_space", "DELETE", "/v2/space/{space_id}", _request_id)
...
async def list_space_tags(
    space_id: float = Field(..., description="The unique identifier of the Space whose tags you want to retrieve.", examples=[512]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type format for the request, indicating the content should be sent as JSON.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_space_tags", "GET", "/v2/space/{space_id}/tag", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_space_tags")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_space_tag(
    space_id: float = Field(..., description="The unique identifier of the Space where the new tag will be created.", examples=[512]),
    ...
    # Log invocation
    _log_tool_invocation("create_space_tag", "POST", "/v2/space/{space_id}/tag", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_space_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_space_tag(
    space_id: float = Field(..., description="The unique identifier of the space that contains the tag to be updated.", examples=[512]),
    tag_name: str = Field(..., description="The current name of the tag to be edited, used to identify the tag within the space.", examples=['name']),
    ...
    # Log invocation
    _log_tool_invocation("update_space_tag", "PUT", "/v2/space/{space_id}/tag/{tag_name}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_space_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def delete_space_tag(
    space_id: float = Field(..., description="The unique numeric identifier of the Space from which the tag will be deleted.", examples=[512]),
    tag_name: str = Field(..., description="The URL path identifier of the tag to delete, typically matching the tag's display name.", examples=['name']),
    ...
    # Log invocation
    _log_tool_invocation("delete_space_tag", "DELETE", "/v2/space/{space_id}/tag/{tag_name}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_space_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_tag_to_task(
    task_id: str = Field(..., description="The unique identifier of the task to which the tag will be added.", examples=['abc']),
    tag_name: str = Field(..., description="The name of the tag to add to the task. Must match an existing tag name exactly.", examples=['name']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, which must indicate JSON format.", examples=['application/json']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of the default system-generated task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs. Must be provided alongside custom_task_ids=true to correctly resolve the task.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("add_tag_to_task", "POST", "/v2/task/{task_id}/tag/{tag_name}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_tag_to_task")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_task_tag(
    task_id: str = Field(..., description="The unique identifier of the task from which the tag will be removed.", examples=['abc']),
    tag_name: str = Field(..., description="The name of the tag to remove from the task. Must match the tag name exactly as it exists in the Space.", examples=['name']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, indicating the format of the payload being sent.", examples=['application/json']),
    custom_task_ids: bool | None = Field(None, description="Set to true if referencing the task by its custom task ID instead of the default ClickUp task ID. Must be used in conjunction with the team_id parameter.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID (team) required when custom_task_ids is set to true. Used to resolve the correct task when referencing by custom task ID.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_task_tag", "DELETE", "/v2/task/{task_id}/tag/{tag_name}", _request_id)
...
async def list_tasks(
    list_id: float = Field(..., description="The unique numeric ID of the List whose tasks you want to retrieve. To find it, hover over the List in the Sidebar, click the ellipsis menu, select Copy link, and extract the number following '/li' in the URL.", examples=[123]),
    archived: bool | None = Field(None, description="When true, includes archived tasks in the response. Archived tasks are excluded by default.", examples=[False]),
    include_markdown_description: bool | None = Field(None, description="When true, task descriptions are returned in Markdown format instead of plain text.", examples=[True]),
    ...
    # Log invocation
    _log_tool_invocation("list_tasks", "GET", "/v2/list/{list_id}/task", _request_id)
...
async def create_task(
    list_id: float = Field(..., description="The unique numeric ID of the list in which the task will be created.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("create_task", "POST", "/v2/list/{list_id}/task", _request_id)
...
@mcp.tool()
async def get_task(
    task_id: str = Field(..., description="The unique identifier of the task to retrieve. When using custom task IDs, set custom_task_ids to true and provide the team_id.", examples=['9hz']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of the default ClickUp task ID. Must be used together with the team_id parameter.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when custom_task_ids is set to true. Identifies which Workspace the custom task ID belongs to.", examples=[123]),
    ...
    include_markdown_description: bool | None = Field(None, description="Set to true to return the task description formatted in Markdown instead of plain text.", examples=[True]),
    ...
    # Log invocation
    _log_tool_invocation("get_task", "GET", "/v2/task/{task_id}", _request_id)
...
async def update_task(
    task_id: str = Field(..., description="The unique identifier of the task to update.", examples=['9hx']),
    ...
    # Log invocation
    _log_tool_invocation("update_task", "PUT", "/v2/task/{task_id}", _request_id)
...
async def delete_task(
    task_id: str = Field(..., description="The unique identifier of the task to delete. Use the task's custom ID instead if the custom_task_ids parameter is set to true.", examples=['9xh']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, which must be set to indicate JSON-formatted content.", examples=['application/json']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task using its custom task ID rather than the default system-generated task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID (team ID) required when using custom task IDs. Must be provided alongside custom_task_ids=true to correctly resolve the task.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_task", "DELETE", "/v2/task/{task_id}", _request_id)
...
async def list_tasks_by_team(
    team_id: float = Field(..., alias="team_Id", description="The unique numeric ID of the Workspace (team) from which to retrieve tasks.", examples=[123]),
    ...
    include_markdown_description: bool | None = Field(None, description="When set to true, task description fields in the response are returned in Markdown format instead of plain text.", examples=[True]),
    ...
    custom_fields_field_ids: Any | None = Field(None, description="List of Custom Field IDs to filter by (one per filter entry)."),
    custom_fields_operators: Any | None = Field(None, description="List of operators for each Custom Field filter (e.g. '=', '<', '>', '!='). Must match length of custom_fields_field_ids."),
    custom_fields_values: Any | None = Field(None, description="List of values for each Custom Field filter. Must match length of custom_fields_field_ids.")
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_tasks_by_team", "GET", "/v2/team/{team_Id}/task", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_tasks_by_team")
    _http_headers.update(_auth.get("headers", {}))
...
async def merge_tasks(
    task_id: str = Field(..., description="The unique ID of the target task that all source tasks will be merged into. Must be a valid internal task ID; Custom Task IDs are not supported.", examples=['9hv']),
    source_task_ids: list[str] = Field(..., description="An array of IDs representing the source tasks to merge into the target task. Order is not significant; all listed tasks will be merged. Custom Task IDs are not supported.", examples=[['abc123', 'def456']])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("merge_tasks", "POST", "/v2/task/{task_id}/merge", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("merge_tasks")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_task_time_in_status(
    task_id: str = Field(..., description="The unique identifier of the task for which to retrieve time-in-status data.", examples=['9hz']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, used to indicate the format of the request body sent to the API.", examples=['application/json']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of the default ClickUp task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID (team_id) required when using custom task IDs. Must be provided alongside custom_task_ids=true.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_task_time_in_status", "GET", "/v2/task/{task_id}/time_in_status", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_task_time_in_status")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_bulk_tasks_time_in_status(
    ...
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload sent to the API.", examples=['application/json']),
    custom_task_ids: bool | None = Field(None, description="Set to true if referencing tasks by their custom task IDs instead of default system IDs.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when custom_task_ids is set to true; must be provided alongside that parameter.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_bulk_tasks_time_in_status", "GET", "/v2/task/bulk_time_in_status/task_ids", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_bulk_tasks_time_in_status")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_task_templates(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose task templates you want to retrieve.", examples=[123]),
    page: int = Field(..., description="The zero-based page number for paginating through task template results, where 0 returns the first page.", examples=[0]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type format for the request body, which must be set to indicate JSON content.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_task_templates", "GET", "/v2/team/{team_id}/taskTemplate", _request_id)
...
async def list_templates(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose List templates you want to retrieve.", examples=[123]),
    page: int = Field(..., description="Zero-indexed page number for paginating through template results; start at 0 for the first page.", examples=[0]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="MIME type for the request body, indicating the format of the data being sent.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_templates", "GET", "/v2/team/{team_id}/list_template", _request_id)
...
async def list_folder_templates(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose Folder templates you want to retrieve.", examples=[123]),
    page: int = Field(..., description="Zero-indexed page number for paginating through Folder template results; start at 0 for the first page.", examples=[0]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body sent to the API.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_folder_templates", "GET", "/v2/team/{team_id}/folder_template", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_folder_templates")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_task_from_template(
    list_id: float = Field(..., description="The unique numeric identifier of the list where the new task will be created.", examples=[512]),
    template_id: str = Field(..., description="The unique string identifier of the task template to use when creating the task.", examples=['9hz']),
    ...
    # Log invocation
    _log_tool_invocation("create_task_from_template", "POST", "/v2/list/{list_id}/taskTemplate/{template_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_task_from_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_list_from_template_in_folder(
    ...
    template_id: str = Field(..., description="The ID of the List template to apply. Template IDs include a 't-' prefix. Retrieve available template IDs using the Get List Templates endpoint.", examples=['t-15363293']),
    name: str = Field(..., description="The display name to assign to the newly created List."),
    return_immediately: bool | None = Field(True, description="When true (default), the new List's ID is returned immediately before all nested template objects are fully created. When false, the request waits until the List and all sub-objects are fully applied before responding."),
    ...
    start_date: str | None = Field(None, description="The project start date used as the anchor when remapping task dates from the template. Must be an ISO 8601 date-time string.", json_schema_extra={'format': 'date-time'}),
    due_date: str | None = Field(None, description="The project due date used as the anchor when remapping task dates from the template. Must be an ISO 8601 date-time string.", json_schema_extra={'format': 'date-time'}),
    ...
    # Log invocation
    _log_tool_invocation("create_list_from_template_in_folder", "POST", "/v2/folder/{folder_id}/list_template/{template_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_list_from_template_in_folder")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_list_from_template(
    ...
    template_id: str = Field(..., description="The unique identifier of the List template to apply, always prefixed with `t-`. Retrieve available template IDs using the Get List Templates endpoint.", examples=['t-15363293']),
    name: str = Field(..., description="The display name to assign to the newly created List."),
    return_immediately: bool | None = Field(True, description="When true, returns the new object ID immediately after access checks without waiting for all nested assets to finish being created. When false, the request waits until the List and all its contents are fully created before responding."),
    content: str | None = Field(None, description="Optional description or body text for the new List."),
    time_estimate: float | None = Field(None, description="Whether to import time estimate values (hours, minutes, and seconds) from the template's tasks."),
    automation: bool | None = Field(None, description="Whether to import automation rules defined in the template."),
    ...
    old_subtask_assignees: bool | None = Field(None, description="Whether to import assignees on subtasks from the template's tasks."),
    start_date: str | None = Field(None, description="The project start date used as the anchor point when remapping task dates, provided in ISO 8601 date-time format.", json_schema_extra={'format': 'date-time'}),
    due_date: str | None = Field(None, description="The project due date used as the anchor point when remapping task dates, provided in ISO 8601 date-time format.", json_schema_extra={'format': 'date-time'}),
    ...
    # Log invocation
    _log_tool_invocation("create_list_from_template", "POST", "/v2/space/{space_id}/list_template/{template_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_list_from_template")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_workspace_seats(team_id: str = Field(..., description="The unique identifier of the Workspace whose seat information you want to retrieve.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_workspace_seats", "GET", "/v2/team/{team_id}/seats", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_workspace_seats")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_workspace_plan(team_id: str = Field(..., description="The unique identifier of the Workspace whose plan information you want to retrieve.")) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_workspace_plan", "GET", "/v2/team/{team_id}/plan", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_workspace_plan")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_user_group(
    team_id: float = Field(..., description="The unique identifier of the Workspace (referred to as team_id in the API) where the User Group will be created.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("create_user_group", "POST", "/v2/team/{team_id}/group", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_user_group")
    _http_headers.update(_auth.get("headers", {}))
...
@mcp.tool()
async def list_custom_task_types(team_id: float = Field(..., description="The unique identifier of the Workspace whose custom task types you want to retrieve.", examples=[123])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_custom_task_types", "GET", "/v2/team/{team_id}/custom_item", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_custom_task_types")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_user_group(
    group_id: str = Field(..., description="The unique identifier of the User Group to update.", examples=['C9C58BE9']),
    ...
    # Log invocation
    _log_tool_invocation("update_user_group", "PUT", "/v2/group/{group_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_user_group")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: User Groups
@mcp.tool()
async def delete_user_group(group_id: str = Field(..., description="The unique identifier of the user group to delete from the Workspace.", examples=['C9C58BE9'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_user_group", "DELETE", "/v2/group/{group_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_user_group")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_user_groups(
    team_id: float = Field(..., description="The unique ID of the Workspace whose User Groups you want to retrieve.", examples=[123]),
    group_ids: list[str] | None = Field(None, description="An optional list of User Group IDs to filter results to specific groups; omit to return all User Groups in the Workspace. Each item should be a valid User Group ID string. Order is not significant.", examples=['C9C58BE9-7C73-4002-A6A9-123456789123', 'F3B51AE4-6F25-1783-D2C1-987654321321'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_user_groups", "GET", "/v2/group", _request_id)
...
async def get_task_tracked_time(
    task_id: str = Field(..., description="The unique identifier of the task whose tracked time entries you want to retrieve.", examples=['9hv']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, indicating the format of the data being sent.", examples=['application/json']),
    custom_task_ids: bool | None = Field(None, description="Set to true if referencing the task by its custom task ID instead of the default ClickUp task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs; must be provided alongside custom_task_ids=true.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_task_tracked_time", "GET", "/v2/task/{task_id}/time", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_task_tracked_time")
    _http_headers.update(_auth.get("headers", {}))
...
async def track_task_time(
    task_id: str = Field(..., description="The unique identifier of the task to log time against.", examples=['9hv']),
    ...
    custom_task_ids: bool | None = Field(None, description="Set to true if referencing the task by its custom task ID rather than the default system-generated ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs. Must be provided alongside custom_task_ids=true.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("track_task_time", "POST", "/v2/task/{task_id}/time", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("track_task_time")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_time_entry_legacy(
    task_id: str = Field(..., description="The unique identifier of the task containing the time interval to update.", examples=['9hv']),
    interval_id: str = Field(..., description="The unique identifier of the specific time interval to edit.", examples=['123']),
    ...
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of its default system ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when using custom task IDs. Must be provided alongside custom_task_ids=true.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("update_time_entry_legacy", "PUT", "/v2/task/{task_id}/time/{interval_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_time_entry_legacy")
    _http_headers.update(_auth.get("headers", {}))
...
async def delete_tracked_time_interval(
    task_id: str = Field(..., description="The unique identifier of the task from which the tracked time interval will be deleted.", examples=['9hv']),
    interval_id: str = Field(..., description="The unique identifier of the tracked time interval to delete.", examples=['123']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The MIME type of the request body, indicating the format of the data being sent.", examples=['application/json']),
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the task by its custom task ID instead of the default ClickUp task ID.", examples=[True]),
    team_id: float | None = Field(None, description="The Workspace ID required when referencing a task by its custom task ID; must be provided alongside custom_task_ids=true.", examples=[123])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_tracked_time_interval", "DELETE", "/v2/task/{task_id}/time/{interval_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_tracked_time_interval")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_time_entries(
    team_id: float = Field(..., alias="team_Id", description="The unique identifier of the workspace from which to retrieve time entries.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, which must be set to indicate JSON content.", examples=['application/json']),
    ...
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the target task using its custom task ID instead of its standard ClickUp task ID. Must be used together with the team_id parameter.", examples=[True]),
    team_id2: float | None = Field(None, alias="team_id", description="The workspace ID required when custom_task_ids is set to true, used to resolve the custom task ID to the correct task within the workspace.", examples=[123]),
    is_billable: bool | None = Field(None, description="Filters results by billing status: set to true to return only billable time entries, or false to return only non-billable time entries. Omit to return all entries regardless of billing status.", examples=[True])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_time_entries", "GET", "/v2/team/{team_Id}/time_entries", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_time_entries")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_time_entry(
    team_id: float = Field(..., alias="team_Id", description="The unique identifier of the workspace where the time entry will be created.", examples=[123]),
    ...
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the associated task by its custom task ID instead of its standard ClickUp task ID.", examples=[True]),
    team_id2: float | None = Field(None, alias="team_id", description="The workspace ID required when using custom task IDs. Must be provided alongside custom_task_ids=true to correctly resolve the custom task reference.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("create_time_entry", "POST", "/v2/team/{team_Id}/time_entries", _request_id)
...
async def get_time_entry(
    team_id: float = Field(..., description="The unique numeric ID of the workspace containing the time entry.", examples=[123]),
    timer_id: str = Field(..., description="The unique ID of the time entry to retrieve. Time entry IDs can be obtained from the Get Time Entries Within a Date Range endpoint.", examples=['1963465985517105840']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, indicating the format of the payload being sent.", examples=['application/json']),
    ...
    # Log invocation
    _log_tool_invocation("get_time_entry", "GET", "/v2/team/{team_id}/time_entries/{timer_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_time_entry")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_time_entry(
    team_id: float = Field(..., description="The unique identifier of the workspace containing the time entry.", examples=[123]),
    timer_id: float = Field(..., description="The unique identifier of the time entry to update.", examples=[2004673344540003600]),
    ...
    custom_task_ids: bool | None = Field(None, description="Set to true to reference the associated task by its custom task ID instead of its default ClickUp task ID.", examples=[True]),
    ...
    # Log invocation
    _log_tool_invocation("update_time_entry", "PUT", "/v2/team/{team_id}/time_entries/{timer_id}", _request_id)
...
async def delete_time_entry(
    team_id: float = Field(..., description="The unique identifier of the Workspace from which the time entries will be deleted.", examples=[123]),
    ...
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, indicating the format in which the data is being sent.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_time_entry", "DELETE", "/v2/team/{team_id}/time_entries/{timer_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_time_entry")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_time_entry_history(
    team_id: float = Field(..., description="The unique numeric ID of the workspace containing the time entry.", examples=[123]),
    timer_id: str = Field(..., description="The unique ID of the time entry whose history you want to retrieve. Can be obtained from the Get Time Entries Within a Date Range endpoint.", examples=['1963465985517105840']),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, indicating the format of the data being sent.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_time_entry_history", "GET", "/v2/team/{team_id}/time_entries/{timer_id}/history", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_time_entry_history")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_running_time_entry(
    team_id: float = Field(..., description="The unique identifier of the workspace in which to look up the running time entry.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, indicating the format in which data is being sent to the API.", examples=['application/json']),
    ...
    # Log invocation
    _log_tool_invocation("get_running_time_entry", "GET", "/v2/team/{team_id}/time_entries/current", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_running_time_entry")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_time_entry_tags(
    team_id: float = Field(..., description="The unique identifier of the Workspace whose time entry tags you want to retrieve.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request payload, indicating the format in which data is being sent to the server.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_time_entry_tags", "GET", "/v2/team/{team_id}/time_entries/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_time_entry_tags")
    _http_headers.update(_auth.get("headers", {}))
...
async def add_tags_to_time_entries(
    team_id: float = Field(..., description="The unique identifier of the workspace containing the time entries.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("add_tags_to_time_entries", "POST", "/v2/team/{team_id}/time_entries/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("add_tags_to_time_entries")
    _http_headers.update(_auth.get("headers", {}))
...
async def rename_time_entry_tag(
    team_id: float = Field(..., description="The unique identifier of the workspace containing the time entry tags to update.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("rename_time_entry_tag", "PUT", "/v2/team/{team_id}/time_entries/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("rename_time_entry_tag")
    _http_headers.update(_auth.get("headers", {}))
...
async def remove_tags_from_time_entries(
    ...
    # Log invocation
    _log_tool_invocation("remove_tags_from_time_entries", "DELETE", "/v2/team/{team_id}/time_entries/tags", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("remove_tags_from_time_entries")
    _http_headers.update(_auth.get("headers", {}))
...
async def start_time_entry(
    team_id: float = Field(..., alias="team_Id", description="The unique identifier of the workspace in which to start the time entry.", examples=[123]),
    custom_task_ids: bool | None = Field(None, description="Set to true if the task is being referenced by its custom task ID rather than its default system-generated ID.", examples=[True]),
    ...
    # Log invocation
    _log_tool_invocation("start_time_entry", "POST", "/v2/team/{team_Id}/time_entries/start", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("start_time_entry")
    _http_headers.update(_auth.get("headers", {}))
...
async def stop_time_entry(
    team_id: float = Field(..., description="The unique identifier of the workspace in which to stop the active time entry.", examples=[123]),
    content_type: Literal["application/json"] = Field(..., alias="Content-Type", description="The media type of the request body, which must be set to indicate JSON formatting.", examples=['application/json'])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("stop_time_entry", "POST", "/v2/team/{team_id}/time_entries/stop", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("stop_time_entry")
    _http_headers.update(_auth.get("headers", {}))
...
async def invite_workspace_member(
    team_id: float = Field(..., description="The unique identifier of the Workspace to which the user will be invited.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("invite_workspace_member", "POST", "/v2/team/{team_id}/user", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("invite_workspace_member")
    _http_headers.update(_auth.get("headers", {}))
...
async def get_workspace_user(
    team_id: float = Field(..., description="The unique numeric ID of the Workspace (also referred to as a team) containing the user.", examples=[123]),
    user_id: float = Field(..., description="The unique numeric ID of the user to retrieve within the specified Workspace.", examples=[403]),
    include_shared: bool | None = Field(None, description="When set to false, excludes details of items shared with the user as a guest; defaults to true to include all shared item details.", examples=[False])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_workspace_user", "GET", "/v2/team/{team_id}/user/{user_id}", _request_id)
...
async def update_workspace_user(
    team_id: float = Field(..., description="The unique identifier of the Workspace (team) in which the user will be updated.", examples=[123]),
    user_id: float = Field(..., description="The unique identifier of the user to be updated within the specified Workspace.", examples=[403]),
    ...
    # Log invocation
    _log_tool_invocation("update_workspace_user", "PUT", "/v2/team/{team_id}/user/{user_id}", _request_id)
...
async def remove_workspace_user(
    team_id: float = Field(..., description="The unique identifier of the Workspace (team) from which the user will be removed.", examples=[123]),
    user_id: float = Field(..., description="The unique identifier of the user to be deactivated and removed from the Workspace.", examples=[403])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("remove_workspace_user", "DELETE", "/v2/team/{team_id}/user/{user_id}", _request_id)
...
# Tags: Views
@mcp.tool()
async def list_workspace_views(team_id: float = Field(..., description="The unique identifier of the Workspace whose Everything-level views you want to retrieve.", examples=[123])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_workspace_views", "GET", "/v2/team/{team_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_workspace_views")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_workspace_view(
    team_id: float = Field(..., description="The unique identifier of the Workspace in which to create the view.", examples=[123]),
    ...
    # Log invocation
    _log_tool_invocation("create_workspace_view", "POST", "/v2/team/{team_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_workspace_view")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Views
@mcp.tool()
async def list_space_views(space_id: float = Field(..., description="The unique identifier of the Space whose views you want to retrieve.", examples=[790])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_space_views", "GET", "/v2/space/{space_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_space_views")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_space_view(
    space_id: float = Field(..., description="The unique identifier of the Space where the new view will be created.", examples=[790]),
    name: str = Field(..., description="The display name for the new view."),
    ...
    # Log invocation
    _log_tool_invocation("create_space_view", "POST", "/v2/space/{space_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_space_view")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Views
@mcp.tool()
async def list_folder_views(folder_id: float = Field(..., description="The unique identifier of the Folder whose views you want to retrieve.", examples=[457])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_folder_views", "GET", "/v2/folder/{folder_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_folder_views")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_folder_view(
    folder_id: float = Field(..., description="The unique numeric identifier of the folder where the new view will be created.", examples=[457]),
    name: str = Field(..., description="The display name for the new view."),
    ...
    # Log invocation
    _log_tool_invocation("create_folder_view", "POST", "/v2/folder/{folder_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_folder_view")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Views
@mcp.tool()
async def list_views(list_id: float = Field(..., description="The unique identifier of the List whose views you want to retrieve.", examples=[124])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_views", "GET", "/v2/list/{list_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_views")
    _http_headers.update(_auth.get("headers", {}))
...
async def create_list_view(
    list_id: float = Field(..., description="The unique identifier of the List in which to create the new view.", examples=[124]),
    name: str = Field(..., description="The display name for the new view."),
    type_: str = Field(..., alias="type", description="The view type to create. Determines the visual layout and available features for the view."),
    grouping_field: str = Field(..., alias="groupingField", description="The field by which tasks in the view are grouped. Use 'none' to disable grouping."),
    grouping_dir: int = Field(..., alias="groupingDir", description="The sort direction for groups. Use 1 for ascending order (e.g., urgent priority at top) or -1 for descending order (e.g., no priority at top)."),
    ...
    # Log invocation
    _log_tool_invocation("create_list_view", "POST", "/v2/list/{list_id}/view", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("create_list_view")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Views
@mcp.tool()
async def get_view(view_id: str = Field(..., description="The unique identifier of the view to retrieve. Corresponds to a specific task or page view within the workspace.", examples=['3c-105'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("get_view", "GET", "/v2/view/{view_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("get_view")
    _http_headers.update(_auth.get("headers", {}))
...
async def update_view(
    view_id: str = Field(..., description="The unique identifier of the view to update.", examples=['3c']),
    ...
    # Log invocation
    _log_tool_invocation("update_view", "PUT", "/v2/view/{view_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("update_view")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Views
@mcp.tool()
async def delete_view(view_id: str = Field(..., description="The unique identifier of the view to be deleted.", examples=['3c'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_view", "DELETE", "/v2/view/{view_id}", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("delete_view")
    _http_headers.update(_auth.get("headers", {}))
...
async def list_view_tasks(
    view_id: str = Field(..., description="The unique identifier of the view whose tasks you want to retrieve.", examples=['3c']),
    page: int = Field(..., description="The zero-based page number to retrieve for paginated results, where 0 returns the first page.", examples=[0])
) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_view_tasks", "GET", "/v2/view/{view_id}/task", _request_id)
    ...
    # Inject per-operation authentication
    _auth = _get_auth_for_operation("list_view_tasks")
    _http_headers.update(_auth.get("headers", {}))
...
# Tags: Webhooks
@mcp.tool()
async def list_webhooks(team_id: float = Field(..., description="The unique identifier of the Workspace whose webhooks you want to retrieve.", examples=[123])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("list_webhooks", "GET", "/v2/team/{team_id}/webhook", _request_id)
...
async def create_webhook(
    team_id: float = Field(..., description="The unique identifier of the workspace in which to create the webhook.", examples=[123]),
    endpoint: str = Field(..., description="The publicly accessible URL that will receive HTTP POST requests when subscribed events occur."),
    events: list[str] = Field(..., description="List of event types to subscribe to; each item is an event name string. Use the wildcard value `*` to subscribe to all available events. Refer to the webhooks documentation for the full list of supported event names."),
    space_id: int | None = Field(None, description="Optional space ID to scope the webhook so it only fires for events within that specific space."),
    folder_id: int | None = Field(None, description="Optional folder ID to scope the webhook so it only fires for events within that specific folder."),
    list_id: int | None = Field(None, description="Optional list ID to scope the webhook so it only fires for events within that specific list."),
    task_id: str | None = Field(None, description="Optional task ID to scope the webhook so it only fires for events related to that specific task.")
) -> dict[str, Any]:
    """Creates a webhook for a workspace to listen for and receive notifications about specified events. Optionally scope the webhook to a specific space, folder, list, or task."""

    # Construct request model with validation
    try:
        _request = _models.CreateWebhookRequest(
            path=_models.CreateWebhookRequestPath(team_id=team_id),
            body=_models.CreateWebhookRequestBody(endpoint=endpoint, events=events, space_id=space_id, folder_id=folder_id, list_id=list_id, task_id=task_id)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("create_webhook", "POST", "/v2/team/{team_id}/webhook", _request_id)
...
async def update_webhook(
    webhook_id: str = Field(..., description="The unique UUID identifier of the webhook to update.", examples=['4b67ac88']),
    endpoint: str = Field(..., description="The destination URL where webhook event payloads will be sent when triggered."),
    events: str = Field(..., description="The event type or types that this webhook should monitor and trigger on."),
    status: str = Field(..., description="The current operational status of the webhook, such as active or inactive.")
) -> dict[str, Any]:
    """Update an existing webhook's configuration, including the endpoint URL, monitored events, and active status. Use this to modify which events trigger notifications or to enable/disable the webhook."""

    # Construct request model with validation
    try:
        _request = _models.UpdateWebhookRequest(
            path=_models.UpdateWebhookRequestPath(webhook_id=webhook_id),
            body=_models.UpdateWebhookRequestBody(endpoint=endpoint, events=events, status=status)
        )
    except pydantic.ValidationError as _validation_err:
    ...
    # Log invocation
    _log_tool_invocation("update_webhook", "PUT", "/v2/webhook/{webhook_id}", _request_id)
...
# Tags: Webhooks
@mcp.tool()
async def delete_webhook(webhook_id: str = Field(..., description="The unique identifier (UUID) of the webhook to delete.", examples=['4b67ac88'])) -> dict[str, Any]:
    ...
    # Log invocation
    _log_tool_invocation("delete_webhook", "DELETE", "/v2/webhook/{webhook_id}", _request_id)
...
def validate_environment() -> None:
    ...
    if errors:
        ...
        print("  python click_up_api_v2_reference_server.py", file=sys.stderr)
        print("=" * 70, file=sys.stderr)
        sys.exit(1)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Clickup Api V2 Reference MCP Server")
    ...
    logger = logging.getLogger(__name__)
    logger.info("Starting Clickup Api V2 Reference MCP Server")
