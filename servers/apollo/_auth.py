...
class OAuth2Auth:
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://app.apollo.io/api/v1/oauth/token")
        self.auth_url = self._resolve_url_template("https://app.apollo.io/#/oauth/authorize")
