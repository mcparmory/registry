...
class OAuth2Auth:
    """
    OAuth 2.0 authentication for GitLab API.
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://gitlab.com/oauth/token")
        self.auth_url = self._resolve_url_template("https://gitlab.com/oauth/authorize")
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "get_group_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "update_group_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "remove_group_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "list_group_badges": [["OAuth2"], ["ApiKeyAuth"]],
    "add_group_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "deny_group_access_request": [["OAuth2"], ["ApiKeyAuth"]],
    "approve_group_access_request": [["OAuth2"], ["ApiKeyAuth"]],
    "list_group_access_requests": [["OAuth2"], ["ApiKeyAuth"]],
    "request_group_access": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_merged_branches": [["OAuth2"], ["ApiKeyAuth"]],
    "get_branch": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_branch": [["OAuth2"], ["ApiKeyAuth"]],
    "check_branch_exists": [["OAuth2"], ["ApiKeyAuth"]],
    "list_repository_branches": [["OAuth2"], ["ApiKeyAuth"]],
    "create_branch": [["OAuth2"], ["ApiKeyAuth"]],
    "unprotect_branch": [["OAuth2"], ["ApiKeyAuth"]],
    "protect_branch": [["OAuth2"], ["ApiKeyAuth"]],
    "get_project_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "update_project_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "list_project_badges": [["OAuth2"], ["ApiKeyAuth"]],
    "create_project_badge": [["OAuth2"], ["ApiKeyAuth"]],
    "deny_access_request": [["OAuth2"], ["ApiKeyAuth"]],
    "approve_access_request": [["OAuth2"], ["ApiKeyAuth"]],
    "list_access_requests": [["OAuth2"], ["ApiKeyAuth"]],
    "request_project_access": [["OAuth2"], ["ApiKeyAuth"]],
    "update_alert_metric_image": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_alert_metric_image": [["OAuth2"], ["ApiKeyAuth"]],
    "list_alert_metric_images": [["OAuth2"], ["ApiKeyAuth"]],
    "upload_alert_metric_image": [["OAuth2"], ["ApiKeyAuth"]],
    "pause_batched_background_migration": [["OAuth2"], ["ApiKeyAuth"]],
    "get_admin_ci_variable": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_instance_variable": [["OAuth2"], ["ApiKeyAuth"]],
    "list_instance_variables": [["OAuth2"], ["ApiKeyAuth"]],
    "create_instance_variable": [["OAuth2"], ["ApiKeyAuth"]],
    "get_cluster": [["OAuth2"], ["ApiKeyAuth"]],
    "update_cluster": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_cluster": [["OAuth2"], ["ApiKeyAuth"]],
    "add_kubernetes_cluster": [["OAuth2"], ["ApiKeyAuth"]],
    "list_clusters": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_application": [["OAuth2"], ["ApiKeyAuth"]],
    "get_user_avatar": [["OAuth2"], ["ApiKeyAuth"]],
    "get_broadcast_message": [["OAuth2"], ["ApiKeyAuth"]],
    "delete_broadcast_message": [["OAuth2"], ["ApiKeyAuth"]],
    "get_migration_entity": [["OAuth2"], ["ApiKeyAuth"]],
    "list_migration_entities": [["OAuth2"], ["ApiKeyAuth"]],
    "get_bulk_import": [["OAuth2"], ["ApiKeyAuth"]],
    "list_migration_entities_all": [["OAuth2"], ["ApiKeyAuth"]],
    "list_migrations": [["OAuth2"], ["ApiKeyAuth"]],
    "start_bulk_migration": [["OAuth2"], ["ApiKeyAuth"]],
    "list_jobs": [["OAuth2"], ["ApiKeyAuth"]],
    "get_job": [["OAuth2"], ["ApiKeyAuth"]],
    "execute_manual_job": [["OAuth2"], ["ApiKeyAuth"]]
}
