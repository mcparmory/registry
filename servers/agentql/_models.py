...
class CreateSessionV1TetraSessionsPostRequestBody(StrictModel):
    ...
    inactivity_timeout_seconds: int | None = Field(default=None, description="How long the session remains alive without active connections before being shut down, applicable when shutdown_mode is 'on_inactivity_timeout'. Accepts values between 5 seconds and 86400 seconds (24 hours).", ge=5.0, le=86400.0)
