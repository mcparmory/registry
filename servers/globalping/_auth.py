...
class OAuth2Auth:
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://auth.globalping.io/oauth/token")
        self.auth_url = self._resolve_url_template("https://auth.globalping.io/oauth/authorize")
        self.refresh_url = self._resolve_url_template("https://auth.globalping.io/oauth/token")
