"""
Authentication module for Pinecone MCP server.
...
class APIKeyAuth:
    """
    API Key authentication for Pinecone Control Plane API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "list_indexes": [["ApiKeyAuth"]],
    "create_index": [["ApiKeyAuth"]],
    "get_index": [["ApiKeyAuth"]],
    "update_index": [["ApiKeyAuth"]],
    "delete_index": [["ApiKeyAuth"]],
    "list_index_backups": [["ApiKeyAuth"]],
    "create_backup": [["ApiKeyAuth"]],
    "list_collections": [["ApiKeyAuth"]],
    "create_collection": [["ApiKeyAuth"]],
    "create_index_for_model": [["ApiKeyAuth"]],
    "list_project_backups": [["ApiKeyAuth"]],
    "get_backup": [["ApiKeyAuth"]],
    "delete_backup": [["ApiKeyAuth"]],
    "create_index_from_backup": [["ApiKeyAuth"]],
    "list_restore_jobs": [["ApiKeyAuth"]],
    "get_restore_job": [["ApiKeyAuth"]],
