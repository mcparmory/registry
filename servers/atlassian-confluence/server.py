...
Generated: 2026-03-29 17:07:36 UTC
...
async def search_content(
    ...
    cqlcontext_content_statuses: list[Any] | None = Field(None, description="Content statuses to search against. Optional. Array of status strings (e.g., ['current', 'archived']).")
) -> dict[str, Any]:
...
async def search_content_global(
    cql: str | None = Field(None, description="Raw CQL (Confluence Query Language) query string, e.g. 'type=page AND space=DEV AND text~\"hello\"'. When provided, takes precedence over all individual filter params below."),
    ...
    # Use raw cql if provided, otherwise build from structured params
    cql = cql or build_cql_query(content_type, space_key, text_search, created_after, created_before, modified_after, modified_before, status, label, ancestor_id)
...
async def customize_site_appearance(
    ...
    headings: _models.UpdateLookAndFeelSettingsBodyHeadings | None = Field(None),
    links: _models.UpdateLookAndFeelSettingsBodyLinks | None = Field(None),
    menus: _models.UpdateLookAndFeelSettingsBodyMenus | None = Field(None),
    header: _models.UpdateLookAndFeelSettingsBodyHeader | None = Field(None),
    horizontal_header: _models.UpdateLookAndFeelSettingsBodyHorizontalHeader | None = Field(None, alias="horizontalHeader"),
    borders_and_dividers: _models.UpdateLookAndFeelSettingsBodyBordersAndDividers | None = Field(None, alias="bordersAndDividers"),
    content: _models.UpdateLookAndFeelSettingsBodyContent | None = Field(None)
) -> dict[str, Any]:
    ...
    try:
        _request = _models.UpdateLookAndFeelSettingsRequest(
            ...
            body=_models.UpdateLookAndFeelSettingsRequestBody(headings=headings, links=links, menus=menus, header=header, horizontal_header=horizontal_header, borders_and_dividers=borders_and_dividers, content=content)
        )
    except pydantic.ValidationError as _validation_err:
