...
class CreateAuditRecordRequestBodyAuthor(StrictModel):
    type_: Literal["user"] = Field(default=..., validation_alias="type", serialization_alias="type", description="The event type classification. Must be set to 'user' for user action events.")
class CreateAuditRecordRequestBodyAffectedObject(StrictModel):
    name: str = Field(default=..., validation_alias="name", serialization_alias="name", description="The name or identifier of the user or entity that performed the action.")
    object_type: str = Field(default=..., validation_alias="objectType", serialization_alias="objectType", description="The type of object affected by the event (e.g., 'page', 'space', 'user').")
class CreateAuditRecordRequestBody(StrictModel):
    """The record to be created in the audit log."""
    remote_address: str = Field(default=..., validation_alias="remoteAddress", serialization_alias="remoteAddress", description="The IP address from which the event was initiated.")
    creation_date: int | None = Field(default=None, validation_alias="creationDate", serialization_alias="creationDate", description="The timestamp when the event occurred. If not provided, defaults to the current date-time. Specified as milliseconds since Unix epoch.", json_schema_extra={'format': 'int64'})
    category: str | None = Field(default=None, description="The event category displayed in the Confluence audit log UI's 'Event type' column. Classifies the nature of the action performed.")
    sys_admin: bool | None = Field(default=None, validation_alias="sysAdmin", serialization_alias="sysAdmin", description="Whether the event was performed by a system administrator.")
    changed_values: list[ChangedValue] | None = Field(default=None, validation_alias="changedValues", serialization_alias="changedValues", description="An array of objects describing the specific values that were modified during the event. Order reflects the sequence of changes.")
    associated_objects: list[AffectedObject] | None = Field(default=None, validation_alias="associatedObjects", serialization_alias="associatedObjects", description="An array of objects associated with the event context. For example, the space object if the event involved space permissions. Order reflects association priority.")
...
class GetLookAndFeelSettingsRequestQuery(StrictModel):
    space_key: str | None = Field(default=None, validation_alias="spaceKey", serialization_alias="spaceKey", description="The space key to retrieve look and feel settings for. If not provided, only global site-wide settings are returned.")
...
class UpdateLookAndFeelSettingsRequestBodyHeaderSearch(StrictModel):
    ...
    background_color: str = Field(default=..., validation_alias="backgroundColor", serialization_alias="backgroundColor", description="Background color for the search input area in the header.")
...
class UpdateLookAndFeelSettingsRequestBodyHorizontalHeaderSearch(StrictModel):
    ...
    background_color: str = Field(default=..., validation_alias="backgroundColor", serialization_alias="backgroundColor", description="Background color for the search input area in the horizontal header.")
...
class UpdateLookAndFeelSettingsRequestBodyContentContainer(StrictModel):
    ...
    background_image: str | None = Field(default=..., validation_alias="backgroundImage", serialization_alias="backgroundImage", description="Background image URL or CSS gradient for the content container.")
    ...
    border_radius: str = Field(default=..., validation_alias="borderRadius", serialization_alias="borderRadius", description="CSS border-radius property for the content container (e.g., '5px', '50%').")
class UpdateLookAndFeelSettingsRequestBodyContentHeader(StrictModel):
    ...
    background_image: str | None = Field(default=..., validation_alias="backgroundImage", serialization_alias="backgroundImage", description="Background image URL or CSS gradient for the content header.")
...
class UpdateLookAndFeelSettingsRequestBodyContentBody(StrictModel):
    ...
    background_image: str | None = Field(default=..., validation_alias="backgroundImage", serialization_alias="backgroundImage", description="Background image URL or CSS gradient for the content body.")
...
class UpdateLookAndFeelSettingsRequestBodyContentScreenLayer(StrictModel):
    width: str | None = Field(default=None, validation_alias="width", serialization_alias="width", description="Width dimension for the appearance layout (CSS value format).")
    height: str | None = Field(default=None, validation_alias="height", serialization_alias="height", description="Height dimension for the appearance layout (CSS value format).")
class UpdateLookAndFeelSettingsRequestBodyContentScreen(StrictModel):
    ...
    background_blend_mode: str | None = Field(default=None, validation_alias="backgroundBlendMode", serialization_alias="backgroundBlendMode", description="CSS background-blend-mode property for the screen-level background (e.g., 'multiply', 'screen', 'overlay').")
    background_clip: str | None = Field(default=None, validation_alias="backgroundClip", serialization_alias="backgroundClip", description="CSS background-clip property for the screen-level background (e.g., 'border-box', 'padding-box', 'content-box').")
    background_image: str | None = Field(default=None, validation_alias="backgroundImage", serialization_alias="backgroundImage", description="Background image URL or CSS gradient for the screen-level container.")
    background_origin: str | None = Field(default=None, validation_alias="backgroundOrigin", serialization_alias="backgroundOrigin", description="CSS background-origin property for the screen-level background (e.g., 'border-box', 'padding-box', 'content-box').")
    ...
    background_repeat: str | None = Field(default=None, validation_alias="backgroundRepeat", serialization_alias="backgroundRepeat", description="CSS background-repeat property for the screen-level background (e.g., 'repeat', 'no-repeat', 'repeat-x', 'repeat-y').")
    background_size: str | None = Field(default=None, validation_alias="backgroundSize", serialization_alias="backgroundSize", description="CSS background-size property for the screen-level background (e.g., 'cover', 'contain', specific dimensions).")
...
class ResetLookAndFeelSettingsRequestQuery(StrictModel):
    space_key: str | None = Field(default=None, validation_alias="spaceKey", serialization_alias="spaceKey", description="The space key for which to reset look and feel settings. If not provided, resets global look and feel settings instead.")
...
class AddPermissionToSpaceRequestBodyOperation(StrictModel):
    key: Literal["administer", "archive", "copy", "create", "delete", "export", "move", "purge", "purge_version", "read", "restore", "restrict_content", "update", "use"] = Field(default=..., validation_alias="key", serialization_alias="key", description="The specific permission action to grant. Controls what operations the principal can perform on the target content type.")
    target: Literal["page", "blogpost", "comment", "attachment", "space"] = Field(default=..., validation_alias="target", serialization_alias="target", description="The content type or scope to which the permission applies. Determines whether the permission affects the entire space or specific content types within it.")
...
class GetContentStateSettingsRequestPath(StrictModel):
    space_key: str = Field(default=..., validation_alias="spaceKey", serialization_alias="spaceKey", description="The unique key identifier of the space whose content state settings should be retrieved.")
...
class GetPrivacyUnsafeUserEmailRequestQuery(StrictModel):
    account_id: str = Field(default=..., validation_alias="accountId", serialization_alias="accountId", description="The unique account ID that identifies the user across all Atlassian products (format: UUID with numeric prefix).")
...
class RegisterModulesRequestBody(StrictModel):
    modules: list[ConnectModule] = Field(default=..., description="A list of app modules to register, formatted according to the app descriptor specification. Each module defines its type, location, and configuration for dynamic integration.")
...
# Operation: remove_modules
class RemoveModulesRequestQuery(StrictModel):
    module_key: list[str] = Field(default=..., validation_alias="moduleKey", serialization_alias="moduleKey", description="One or more module keys to remove. Provide multiple copies of this parameter to remove multiple modules. Order is not significant.")
...
class ConnectModule(RootModel[dict[str, Any]]):
    pass
