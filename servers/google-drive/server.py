...
Generated: 2026-04-23 21:21:03 UTC
...
# Tags: about
@mcp.tool()
async def get_user_info(fields: str | None = Field(None, description="Selector specifying which fields to include in a partial response.")) -> dict[str, Any] | ToolResult:
...
# Tags: changes
@mcp.tool()
async def get_change_start_page_token() -> dict[str, Any] | ToolResult:
...
# Tags: drives
@mcp.tool()
async def hide_shared_drive(drive_id: str = Field(..., alias="driveId", description="The unique identifier of the shared drive to hide.")) -> dict[str, Any] | ToolResult:
...
# Tags: drives
@mcp.tool()
async def unhide_shared_drive(drive_id: str = Field(..., alias="driveId", description="The unique identifier of the shared drive to restore to the default view.")) -> dict[str, Any] | ToolResult:
...
# Tags: files
@mcp.tool()
async def delete_file(file_id: str = Field(..., alias="fileId", description="The unique identifier of the file to delete.")) -> dict[str, Any] | ToolResult:
...
# Tags: files
@mcp.tool()
async def empty_trash() -> dict[str, Any] | ToolResult:
