...
class APIKeyAuth:
    """
    API Key authentication for Google Maps Platform.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "locate_device": [["ApiKeyAuth"]],
    "calculate_directions": [["ApiKeyAuth"]],
    "get_elevation": [["ApiKeyAuth"]],
    "geocode_address": [["ApiKeyAuth"]],
    "get_timezone": [["ApiKeyAuth"]],
    "snap_coordinates_to_roads": [["ApiKeyAuth"]],
    "snap_points_to_roads": [["ApiKeyAuth"]],
    "calculate_distance_matrix": [["ApiKeyAuth"]],
    "get_place_details": [["ApiKeyAuth"]],
    "search_place_by_text": [["ApiKeyAuth"]],
    "search_nearby_places": [["ApiKeyAuth"]],
    "search_places_by_text": [["ApiKeyAuth"]],
    "get_place_photo": [["ApiKeyAuth"]],
    "get_query_suggestions": [["ApiKeyAuth"]],
    "autocomplete_place": [["ApiKeyAuth"]],
    "get_street_view": [["ApiKeyAuth"]],
    "get_street_view_metadata": [["ApiKeyAuth"]]
}
