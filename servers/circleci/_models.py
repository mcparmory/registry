"""
Circleci Api MCP Server - Pydantic Models
...
# Operation: evaluate_policy_decision
class MakeDecisionRequestPath(StrictModel):
    owner_id: str = Field(default=..., validation_alias="ownerID", serialization_alias="ownerID", description="Unique identifier of the owner whose policies will be evaluated against the input data.")
    context: str = Field(default=..., description="The policy context namespace under which the decision evaluation should be performed, scoping which policies are applicable.")
class MakeDecisionRequestBody(StrictModel):
    input_: str | None = Field(default=None, validation_alias="input", serialization_alias="input", description="The configuration or input data string to be evaluated against the owner's policies in the specified context.")
    metadata: dict[str, Any] | None = Field(default=None, description="Additional key-value metadata object accompanying the input, providing supplementary context to influence or enrich the policy evaluation.")
class MakeDecisionRequest(StrictModel):
    ...
    path: MakeDecisionRequestPath
    body: MakeDecisionRequestBody | None = None

# Operation: get_decision_settings
class GetDecisionSettingsRequestPath(StrictModel):
    owner_id: str = Field(default=..., validation_alias="ownerID", serialization_alias="ownerID", description="The unique identifier of the owner whose decision settings are being retrieved.")
    context: str = Field(default=..., description="The context scope under which the decision settings apply, used to namespace or segment policy evaluation configuration.")
class GetDecisionSettingsRequest(StrictModel):
    ...
    path: GetDecisionSettingsRequestPath

# Operation: update_decision_settings
class SetDecisionSettingsRequestPath(StrictModel):
    owner_id: str = Field(default=..., validation_alias="ownerID", serialization_alias="ownerID", description="The unique identifier of the owner whose decision settings are being updated.")
    context: str = Field(default=..., description="The context scope under which the decision settings apply, used to namespace policy evaluation configurations.")
class SetDecisionSettingsRequestBody(StrictModel):
    enabled: bool | None = Field(default=None, description="Whether policy evaluation is enabled for the specified owner and context. Set to true to activate policy enforcement, or false to disable it.")
class SetDecisionSettingsRequest(StrictModel):
    ...
    path: SetDecisionSettingsRequestPath
    body: SetDecisionSettingsRequestBody | None = None
...
# Operation: create_policy_bundle
class CreatePolicyBundleRequestPath(StrictModel):
    owner_id: str = Field(default=..., validation_alias="ownerID", serialization_alias="ownerID", description="The unique identifier of the owner (organization or user) whose policy bundle is being updated.")
    context: str = Field(default=..., description="The context scope under which the policy bundle applies, used to namespace and isolate policies by environment or purpose.")
class CreatePolicyBundleRequestQuery(StrictModel):
    dry: bool | None = Field(default=None, description="When set to true, validates and previews the policy bundle replacement without persisting any changes.")
class CreatePolicyBundleRequestBody(StrictModel):
    policies: dict[str, str] | None = Field(default=None, description="A collection of policy definitions that will fully replace the existing policy bundle for the specified owner and context.")
class CreatePolicyBundleRequest(StrictModel):
    ...
    path: CreatePolicyBundleRequestPath
    query: CreatePolicyBundleRequestQuery | None = None
    body: CreatePolicyBundleRequestBody | None = None

# Operation: get_policy_document
class GetPolicyDocumentRequestPath(StrictModel):
    owner_id: str = Field(default=..., validation_alias="ownerID", serialization_alias="ownerID", description="The unique identifier of the owner (e.g., organization or user) whose policy documents are being accessed.")
    context: str = Field(default=..., description="The context scope under which the policy bundle is organized, used to namespace or categorize policies within an owner.")
    policy_name: str = Field(default=..., validation_alias="policyName", serialization_alias="policyName", description="The name of the policy to retrieve, as defined by the rego policy_name rule within the policy document.")
class GetPolicyDocumentRequest(StrictModel):
    ...
    path: GetPolicyDocumentRequestPath
...
class CreateContextBodyOwnerV0(StrictModel):
    id_: str = Field(..., validation_alias="id", serialization_alias="id", description="The unique ID of the owner of the context. This is the organization ID. Specify either owner/organization ID or the owner/organization slug. Find the organization ID and slug in the CircleCI web ap...", json_schema_extra={'format': 'uuid'})
...
class CreateContextBodyOwnerV1(StrictModel):
    slug: str = Field(..., description="A string that represents an organization. This is the organization slug. Specify either this or organization/owner ID. Find the organization ID and slug in the CircleCI web app (Organization Settin...")
...
class Trigger(StrictModel):
    ...
    event_source: TriggerEventSource | None = Field(None, description="The source of events to use for this trigger. Will contain either a `repo` or `webhook` object depending on the `provider`. (The `github_app` and `github_oauth` providers imply a `repo` and `webhoo...")
