"""
Box Platform Api MCP Server - Pydantic Models
...
__all__ = [
    "DeleteAiAgentsIdRequest",
    "DeleteCollaborationsIdRequest",
    "DeleteCollaborationWhitelistEntriesIdRequest",
    "DeleteCollaborationWhitelistExemptTargetsIdRequest",
    ...
    "DeleteIntegrationMappingsSlackIdRequest",
    "DeleteIntegrationMappingsTeamsIdRequest",
    "DeleteLegalHoldPoliciesIdRequest",
    "DeleteLegalHoldPolicyAssignmentsIdRequest",
    "DeleteMetadataCascadePoliciesIdRequest",
    "DeleteMetadataTaxonomiesIdIdNodesIdRequest",
    "DeleteMetadataTaxonomiesIdIdRequest",
    ...
    "DeleteShieldInformationBarrierSegmentRestrictionsIdRequest",
    ...
    "GetCollaborationWhitelistEntriesRequest",
    "GetCollaborationWhitelistExemptTargetsIdRequest",
    "GetCollaborationWhitelistExemptTargetsRequest",
    ...
    "GetFileVersionRetentionsIdRequest",
    "GetFileVersionRetentionsRequest",
    ...
    "GetMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaRequest",
    ...
    "GetStoragePoliciesIdRequest",
    "GetStoragePoliciesRequest",
    ...
    "GetTasksIdRequest",
    "GetTermsOfServicesIdRequest",
    "GetTermsOfServicesRequest",
    ...
    "PatchMetadataTaxonomiesIdIdLevelsIdRequest",
    "PatchMetadataTaxonomiesIdIdNodesIdRequest",
    "PatchMetadataTaxonomiesIdIdRequest",
    "PostAiAgentsRequest",
    "PostAiAskRequest",
    "PostAiExtractRequest",
    "PostAiExtractStructuredRequest",
    "PostAiTextGenRequest",
    ...
    "PostIntegrationMappingsSlackRequest",
    ...
    "PostMetadataTaxonomiesIdIdLevelsAppendRequest",
    "PostMetadataTaxonomiesIdIdLevelsRequest",
    "PostMetadataTaxonomiesIdIdLevelsTrimRequest",
    "PostMetadataTaxonomiesIdIdNodesRequest",
    "PostMetadataTaxonomiesRequest",
    "PostMetadataTemplatesSchemaClassificationsRequest",
    "PostMetadataTemplatesSchemaRequest",
    "PostOauth2RevokeRequest",
    "PostOauth2TokenRefreshRequest",
    ...
    "PutIntegrationMappingsTeamsIdRequest",
    "PutLegalHoldPoliciesIdRequest",
    "PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddRequest",
    "PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateRequest",
    ...
    "PostAiTextGenBodyItemsItem",
    "PostFilesIdBodyParent",
    "PostFoldersBodyFolderUploadEmail",
    "PostFoldersIdBodyParent",
    "PostIntegrationMappingsSlackBodyBoxItem",
    "PostIntegrationMappingsSlackBodyOptions",
    "PostIntegrationMappingsSlackBodyPartnerItem",
    ...
    "PutAiAgentsIdBodyAskBasicImage",
    "PutAiAgentsIdBodyAskBasicImageMulti",
    "PutAiAgentsIdBodyAskBasicText",
    "PutAiAgentsIdBodyAskBasicTextMulti",
    "PutAiAgentsIdBodyAskLongText",
    "PutAiAgentsIdBodyAskLongTextMulti",
    "PutAiAgentsIdBodyAskSpreadsheet",
    "PutAiAgentsIdBodyExtractBasicImage",
    "PutAiAgentsIdBodyExtractBasicText",
    "PutAiAgentsIdBodyExtractLongText",
    "PutAiAgentsIdBodyTextGenBasicGen",
    ...
    "PutIntegrationMappingsSlackIdBodyBoxItem",
    "PutIntegrationMappingsSlackIdBodyOptions",
    "PutIntegrationMappingsTeamsIdBodyBoxItem",
    "PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItem",
    "PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItem",
...
class GetAuthorizeRequestQuery(StrictModel):
    response_type: Literal["code"] = Field(default=..., description="Specifies the OAuth 2.0 response type; must be set to 'code' to request an authorization code that can be exchanged for an access token.", json_schema_extra={'format': 'token'})
    client_id: str = Field(default=..., description="The unique Client ID of your registered Box application, found in the OAuth 2.0 Parameters section of your application's configuration page in the Box developer console.")
    redirect_uri: str | None = Field(default=None, description="The HTTPS URI to which Box redirects the user after authorization; must exactly match one of the redirect URIs configured for your application, and is required when multiple redirect URIs are configured.", json_schema_extra={'format': 'url'})
    state: str | None = Field(default=None, description="An arbitrary string your application generates and passes through the authorization flow unchanged, used to correlate the redirect response to the originating request and protect against CSRF and session hijacking attacks.")
    scope: str | None = Field(default=None, description="A space-separated list of permission scopes to request on behalf of the user; defaults to all scopes configured for the application if omitted.")
class GetAuthorizeRequest(StrictModel):
    ...
    query: GetAuthorizeRequestQuery

# Operation: request_access_token
class PostOauth2TokenRequestBody(StrictModel):
    grant_type: Literal["authorization_code", "refresh_token", "client_credentials", "urn:ietf:params:oauth:grant-type:jwt-bearer", "urn:ietf:params:oauth:grant-type:token-exchange"] | None = Field(default=None, description="The OAuth 2.0 grant type that determines which authentication flow to use and which accompanying parameters are required.", json_schema_extra={'format': 'urn'})
    client_id: str | None = Field(default=None, description="The Client ID of the registered Box application requesting the access token. Required when using the authorization_code, client_credentials, or jwt-bearer grant types.")
    code: str | None = Field(default=None, description="The short-lived authorization code received from Box via browser redirect after the user grants permission. Required when using the authorization_code grant type.", json_schema_extra={'format': 'token'})
    refresh_token: str | None = Field(default=None, description="A previously issued refresh token used to obtain a new access token without requiring user re-authentication. Required when using the refresh_token grant type.", json_schema_extra={'format': 'token'})
    assertion: str | None = Field(default=None, description="A signed JWT assertion used to authenticate a server-side application. Required when using the jwt-bearer grant type.", json_schema_extra={'format': 'jwt'})
    subject_token: str | None = Field(default=None, description="The existing access token, JWT assertion, or app token to be exchanged for a downscoped token. Required when using the token-exchange grant type.", json_schema_extra={'format': 'token'})
    subject_token_type: Literal["urn:ietf:params:oauth:token-type:access_token"] | None = Field(default=None, description="Identifies the type of token provided in the subject_token field. Required when using the token-exchange grant type.")
    actor_token: str | None = Field(default=None, description="A JWT assertion used to create an annotator token, representing the actor on whose behalf the token exchange is performed. Used with the token-exchange grant type.", json_schema_extra={'format': 'token'})
    actor_token_type: Literal["urn:ietf:params:oauth:token-type:id_token"] | None = Field(default=None, description="Identifies the type of token provided in the actor_token field. Required when actor_token is supplied in a token-exchange request.", json_schema_extra={'format': 'urn'})
    scope: str | None = Field(default=None, description="A space-delimited list of permission scopes to apply to the new downscoped access token; the subject_token must already possess all requested scopes or the request will fail with 401 Unauthorized.", json_schema_extra={'format': 'space_delimited_list'})
    resource: str | None = Field(default=None, description="The full API URL of the specific Box file for which the token should be scoped, restricting the token's access to that resource only.", json_schema_extra={'format': 'url'})
    box_subject_type: Literal["enterprise", "user"] | None = Field(default=None, description="Specifies whether the client credentials grant should generate a token for an enterprise or an individual user, determining how box_subject_id is interpreted.")
    box_subject_id: str | None = Field(default=None, description="The ID of the enterprise or user for whom the token is being generated when using the client_credentials grant type; use the enterprise ID if box_subject_type is enterprise, or the user ID if box_subject_type is user.")
    box_shared_link: str | None = Field(default=None, description="The full URL of a Box shared link on a file or folder, used to scope the generated token so it can access that shared resource.", json_schema_extra={'format': 'url'})
class PostOauth2TokenRequest(StrictModel):
    ...
    body: PostOauth2TokenRequestBody | None = None

# Operation: refresh_access_token
class PostOauth2TokenRefreshRequest(StrictModel):
...
class PostOauth2RevokeRequestBody(StrictModel):
    token: str | None = Field(default=None, description="The active access token to be revoked and invalidated. Once revoked, the token can no longer be used to authenticate requests.", json_schema_extra={'format': 'token'})
class PostOauth2RevokeRequest(StrictModel):
    ...
    body: PostOauth2RevokeRequestBody | None = None
...
# Operation: preflight_check_file_upload
class OptionsFilesContentRequestBody(StrictModel):
    name: str | None = Field(default=None, description="The intended name of the file to be uploaded, used to check for naming conflicts or invalid characters in the target location.")
    parent: OptionsFilesContentBodyParent | None = Field(default=None, description="The parent folder in which the file will be uploaded, used to verify that the destination exists and the user has sufficient permissions.")
class OptionsFilesContentRequest(StrictModel):
    ...
    body: OptionsFilesContentRequestBody | None = None
...
class GetMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaRequest(StrictModel):
...
# Operation: add_security_classifications
class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddRequestBody(StrictModel):
    body: list[PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItem] | None = Field(default=None, description="Array of one or more classification objects to add to the enterprise's security classification list. Order is not significant; each item should represent a distinct classification definition.")
class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddRequest(StrictModel):
    ...
    body: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddRequestBody | None = None

# Operation: update_security_classifications
class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateRequestBody(StrictModel):
    body: list[PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItem] | None = Field(default=None, description="An array of classification update objects, each specifying the classification to modify and the new label or description values to apply. Order is not significant; each item must identify the target classification and the fields to update.")
class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateRequest(StrictModel):
    ...
    body: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateRequestBody | None = None
...
class PostMetadataCascadePoliciesRequestBody(StrictModel):
    ...
    scope: Literal["global", "enterprise"] | None = Field(default=None, description="The scope of the targeted metadata template. This template will\nneed to already have an instance applied to the targeted folder.")
...
# Operation: delete_metadata_cascade_policy
class DeleteMetadataCascadePoliciesIdRequestPath(StrictModel):
    metadata_cascade_policy_id: str = Field(default=..., description="The unique identifier of the metadata cascade policy to delete.")
class DeleteMetadataCascadePoliciesIdRequest(StrictModel):
    ...
    path: DeleteMetadataCascadePoliciesIdRequestPath
...
class PostUsersRequestBody(StrictModel):
    ...
    name: str | None = Field(default=None, description="The name of the user.", max_length=50)
...
class GetUsersMeRequest(StrictModel):
...
class PostWebhooksRequestBodyTarget(StrictModel):
    id_: str | None = Field(default=None, validation_alias="id", serialization_alias="id", description="The unique identifier of the file or folder that will trigger this webhook when the specified events occur.")
    type_: Literal["file", "folder"] | None = Field(default=None, validation_alias="type", serialization_alias="type", description="The type of item the webhook monitors — either a file or a folder.")
class PostWebhooksRequestBody(StrictModel):
    address: str | None = Field(default=None, description="The publicly accessible HTTPS URL that will receive POST notifications when a trigger event fires.")
    triggers: list[Literal["FILE.UPLOADED", "FILE.PREVIEWED", "FILE.DOWNLOADED", "FILE.TRASHED", "FILE.DELETED", "FILE.RESTORED", "FILE.COPIED", "FILE.MOVED", "FILE.LOCKED", "FILE.UNLOCKED", "FILE.RENAMED", "COMMENT.CREATED", "COMMENT.UPDATED", "COMMENT.DELETED", "TASK_ASSIGNMENT.CREATED", "TASK_ASSIGNMENT.UPDATED", "METADATA_INSTANCE.CREATED", "METADATA_INSTANCE.UPDATED", "METADATA_INSTANCE.DELETED", "FOLDER.CREATED", "FOLDER.RENAMED", "FOLDER.DOWNLOADED", "FOLDER.RESTORED", "FOLDER.DELETED", "FOLDER.COPIED", "FOLDER.MOVED", "FOLDER.TRASHED", "WEBHOOK.DELETED", "COLLABORATION.CREATED", "COLLABORATION.ACCEPTED", "COLLABORATION.REJECTED", "COLLABORATION.REMOVED", "COLLABORATION.UPDATED", "SHARED_LINK.DELETED", "SHARED_LINK.CREATED", "SHARED_LINK.UPDATED", "SIGN_REQUEST.COMPLETED", "SIGN_REQUEST.DECLINED", "SIGN_REQUEST.EXPIRED", "SIGN_REQUEST.SIGNER_EMAIL_BOUNCED", "SIGN_REQUEST.SIGN_SIGNER_SIGNED", "SIGN_REQUEST.SIGN_DOCUMENT_CREATED", "SIGN_REQUEST.SIGN_ERROR_FINALIZING"]] | None = Field(default=None, description="A list of event names that will activate this webhook; each item should be a valid Box webhook trigger name (e.g., FILE.UPLOADED). Order is not significant.")
    target: PostWebhooksRequestBodyTarget | None = None
class PostWebhooksRequest(StrictModel):
    ...
    body: PostWebhooksRequestBody | None = None
...
class PutWebhooksIdRequestPath(StrictModel):
    webhook_id: str = Field(default=..., description="The unique identifier of the webhook to update.")
class PutWebhooksIdRequestBodyTarget(StrictModel):
    id_: str | None = Field(default=None, validation_alias="id", serialization_alias="id", description="The unique identifier of the file or folder item that should trigger this webhook.")
    type_: Literal["file", "folder"] | None = Field(default=None, validation_alias="type", serialization_alias="type", description="The type of Box item (file or folder) that this webhook monitors for events.")
class PutWebhooksIdRequestBody(StrictModel):
    address: str | None = Field(default=None, description="The destination URL that receives POST notifications when a trigger event occurs. Must be a publicly accessible HTTPS endpoint.")
    triggers: list[Literal["FILE.UPLOADED", "FILE.PREVIEWED", "FILE.DOWNLOADED", "FILE.TRASHED", "FILE.DELETED", "FILE.RESTORED", "FILE.COPIED", "FILE.MOVED", "FILE.LOCKED", "FILE.UNLOCKED", "FILE.RENAMED", "COMMENT.CREATED", "COMMENT.UPDATED", "COMMENT.DELETED", "TASK_ASSIGNMENT.CREATED", "TASK_ASSIGNMENT.UPDATED", "METADATA_INSTANCE.CREATED", "METADATA_INSTANCE.UPDATED", "METADATA_INSTANCE.DELETED", "FOLDER.CREATED", "FOLDER.RENAMED", "FOLDER.DOWNLOADED", "FOLDER.RESTORED", "FOLDER.DELETED", "FOLDER.COPIED", "FOLDER.MOVED", "FOLDER.TRASHED", "WEBHOOK.DELETED", "COLLABORATION.CREATED", "COLLABORATION.ACCEPTED", "COLLABORATION.REJECTED", "COLLABORATION.REMOVED", "COLLABORATION.UPDATED", "SHARED_LINK.DELETED", "SHARED_LINK.CREATED", "SHARED_LINK.UPDATED", "SIGN_REQUEST.COMPLETED", "SIGN_REQUEST.DECLINED", "SIGN_REQUEST.EXPIRED", "SIGN_REQUEST.SIGNER_EMAIL_BOUNCED", "SIGN_REQUEST.SIGN_SIGNER_SIGNED", "SIGN_REQUEST.SIGN_DOCUMENT_CREATED", "SIGN_REQUEST.SIGN_ERROR_FINALIZING"]] | None = Field(default=None, description="The list of event names that will fire this webhook. Each item should be a valid Box webhook event name; order is not significant.")
    target: PutWebhooksIdRequestBodyTarget | None = None
class PutWebhooksIdRequest(StrictModel):
    """Updates the configuration of an existing webhook, allowing changes to its target item, event triggers, and notification URL."""
    path: PutWebhooksIdRequestPath
    body: PutWebhooksIdRequestBody | None = None
...
# Operation: get_long_poll_servers
class OptionsEventsRequest(StrictModel):
...
class PostRetentionPoliciesRequestBody(StrictModel):
    policy_name: str | None = Field(default=None, description="The display name for the retention policy, used to identify it in the Box admin console.")
    description: str | None = Field(default=None, description="An optional text description providing additional context or purpose for the retention policy.")
    policy_type: Literal["finite", "indefinite"] | None = Field(default=None, description="Determines whether the policy retains content for a fixed duration (`finite`) or for an unspecified, ongoing period (`indefinite`).")
    disposition_action: Literal["permanently_delete", "remove_retention"] | None = Field(default=None, description="The action taken on content when the retention period expires: permanently delete the content or remove the retention hold so users can manage it themselves.")
    retention_length: str | None | float | None = Field(default=None, description="The number of days the retention policy remains active after being assigned to content. Must be set to `indefinite` when `policy_type` is `indefinite`.")
    retention_type: Literal["modifiable", "non_modifiable"] | None = Field(default=None, description="Controls how strictly the policy can be modified after creation: `modifiable` allows full edits and deletions, while `non_modifiable` restricts changes to support regulatory compliance requirements.")
    can_owner_extend_retention: bool | None = Field(default=None, description="When set to true, allows the file owner to extend the retention period beyond the policy's defined duration.")
    are_owners_notified: bool | None = Field(default=None, description="When set to true, notifies the file owner and co-owners as the retention policy approaches its expiration date.")
    custom_notification_recipients: list[UserMini] | None = Field(default=None, description="A list of additional Box users to notify when the retention policy is nearing expiration. Each item should represent a user object with a valid user ID. Order is not significant.")
class PostRetentionPoliciesRequest(StrictModel):
    ...
    body: PostRetentionPoliciesRequestBody | None = None
...
# Operation: create_legal_hold_policy
class PostLegalHoldPoliciesRequestBody(StrictModel):
    policy_name: str | None = Field(default=None, description="The display name of the legal hold policy, up to 254 characters.", max_length=254)
    description: str | None = Field(default=None, description="An optional human-readable description of the policy's purpose or scope, up to 500 characters.", max_length=500)
    filter_started_at: str | None = Field(default=None, description="The start of the date range filter in ISO 8601 format. When the policy is applied via a custodian assignment, only file versions created or uploaded on or after this date will be held. Required when `is_ongoing` is set to `false`.", max_length=500, json_schema_extra={'format': 'date-time'})
    filter_ended_at: str | None = Field(default=None, description="The end of the date range filter in ISO 8601 format. When the policy is applied via a custodian assignment, only file versions created or uploaded on or before this date will be held. Required when `is_ongoing` is set to `false`.", max_length=500, json_schema_extra={'format': 'date-time'})
    is_ongoing: bool | None = Field(default=None, description="When set to `true`, the policy continuously applies to any new file versions created after the assignment is made, until the policy is retired. Required when no filter dates are provided; mutually exclusive with date range filtering.")
class PostLegalHoldPoliciesRequest(StrictModel):
    ...
    body: PostLegalHoldPoliciesRequestBody | None = None
...
# Operation: list_file_version_retentions
class GetFileVersionRetentionsRequestQuery(StrictModel):
    file_id: str | None = Field(default=None, description="Narrows results to retentions associated with a specific file, identified by its unique file ID.")
    file_version_id: str | None = Field(default=None, description="Narrows results to retentions associated with a specific version of a file, identified by its unique file version ID.")
    policy_id: str | None = Field(default=None, description="Narrows results to retentions governed by a specific retention policy, identified by its unique policy ID.")
    disposition_action: Literal["permanently_delete", "remove_retention"] | None = Field(default=None, description="Narrows results to retentions whose governing policy uses the specified disposition action — either permanently deleting the file or simply removing the retention hold.")
    disposition_before: str | None = Field(default=None, description="Narrows results to files whose retention disposition date falls before the specified date and time, provided in ISO 8601 format.")
    disposition_after: str | None = Field(default=None, description="Narrows results to files whose retention disposition date falls after the specified date and time, provided in ISO 8601 format.")
    limit: int | None = Field(default=None, description="The maximum number of retention records to return in a single response page; must be between 1 and 1000.", le=1000, json_schema_extra={'format': 'int64'})
class GetFileVersionRetentionsRequest(StrictModel):
    ...
    query: GetFileVersionRetentionsRequestQuery | None = None
...
# Operation: get_file_version_retention
class GetFileVersionRetentionsIdRequestPath(StrictModel):
    file_version_retention_id: str = Field(default=..., description="The unique identifier of the file version retention record to retrieve.")
class GetFileVersionRetentionsIdRequest(StrictModel):
    ...
    path: GetFileVersionRetentionsIdRequestPath
...
# Operation: delete_barrier_segment_restriction
class DeleteShieldInformationBarrierSegmentRestrictionsIdRequestPath(StrictModel):
    shield_information_barrier_segment_restriction_id: str = Field(default=..., description="The unique identifier of the shield information barrier segment restriction to delete.")
class DeleteShieldInformationBarrierSegmentRestrictionsIdRequest(StrictModel):
    ...
    path: DeleteShieldInformationBarrierSegmentRestrictionsIdRequestPath
...
# Operation: create_barrier_segment_restriction
class PostShieldInformationBarrierSegmentRestrictionsRequestBodyShieldInformationBarrier(StrictModel):
    id_: str | None = Field(default=None, validation_alias="id", serialization_alias="id", description="The unique identifier of the shield information barrier that both segments belong to.")
class PostShieldInformationBarrierSegmentRestrictionsRequestBodyShieldInformationBarrierSegment(StrictModel):
    id_: str | None = Field(default=None, validation_alias="id", serialization_alias="id", description="The unique identifier of the shield information barrier segment that is initiating the restriction request.")
class PostShieldInformationBarrierSegmentRestrictionsRequestBodyRestrictedSegment(StrictModel):
    id_: str | None = Field(default=None, validation_alias="id", serialization_alias="id", description="The unique identifier of the shield information barrier segment to be restricted from the requesting segment.")
class PostShieldInformationBarrierSegmentRestrictionsRequestBody(StrictModel):
    shield_information_barrier: PostShieldInformationBarrierSegmentRestrictionsRequestBodyShieldInformationBarrier | None = None
    shield_information_barrier_segment: PostShieldInformationBarrierSegmentRestrictionsRequestBodyShieldInformationBarrierSegment | None = None
    restricted_segment: PostShieldInformationBarrierSegmentRestrictionsRequestBodyRestrictedSegment | None = None
class PostShieldInformationBarrierSegmentRestrictionsRequest(StrictModel):
    ...
    body: PostShieldInformationBarrierSegmentRestrictionsRequestBody | None = None
...
# Operation: list_terms_of_services
class GetTermsOfServicesRequestQuery(StrictModel):
    tos_type: Literal["external", "managed"] | None = Field(default=None, description="Filters the results to return only terms of service of the specified type — either for external users or managed internal users.")
class GetTermsOfServicesRequest(StrictModel):
    ...
    query: GetTermsOfServicesRequestQuery | None = None

# Operation: create_terms_of_service
class PostTermsOfServicesRequestBody(StrictModel):
    status: Literal["enabled", "disabled"] | None = Field(default=None, description="Controls whether the terms of service is active and presented to users upon login or collaboration. Must be 'enabled' to require user acceptance, or 'disabled' to deactivate it.")
    tos_type: Literal["external", "managed"] | None = Field(default=None, description="Specifies the audience for these terms of service — 'managed' targets internal enterprise users, while 'external' targets users outside the enterprise collaborating on content.")
    text: str | None = Field(default=None, description="The full terms of service text displayed to users before they can accept. May be left empty only when status is set to 'disabled'.")
class PostTermsOfServicesRequest(StrictModel):
    ...
    body: PostTermsOfServicesRequestBody | None = None

# Operation: get_terms_of_service
class GetTermsOfServicesIdRequestPath(StrictModel):
    terms_of_service_id: str = Field(default=..., description="The unique identifier of the terms of service to retrieve.")
class GetTermsOfServicesIdRequest(StrictModel):
    ...
    path: GetTermsOfServicesIdRequestPath

# Operation: update_terms_of_service
class PutTermsOfServicesIdRequestPath(StrictModel):
    terms_of_service_id: str = Field(default=..., description="The unique identifier of the terms of service to update.")
class PutTermsOfServicesIdRequestBody(StrictModel):
    status: Literal["enabled", "disabled"] | None = Field(default=None, description="Controls whether the terms of service is active and presented to users. Must be either 'enabled' to activate or 'disabled' to deactivate it.")
    text: str | None = Field(default=None, description="The full terms of service text displayed to users upon agreement. May be set to empty only when status is set to 'disabled'.")
class PutTermsOfServicesIdRequest(StrictModel):
    ...
    path: PutTermsOfServicesIdRequestPath
    body: PutTermsOfServicesIdRequestBody | None = None
...
# Operation: list_collaboration_whitelist_entries
class GetCollaborationWhitelistEntriesRequestQuery(StrictModel):
    limit: int | None = Field(default=None, description="Maximum number of whitelist entries to return in a single page of results. Accepts values up to 1000.", le=1000, json_schema_extra={'format': 'int64'})
class GetCollaborationWhitelistEntriesRequest(StrictModel):
    ...
    query: GetCollaborationWhitelistEntriesRequestQuery | None = None

# Operation: add_collaboration_whitelist_domain
class PostCollaborationWhitelistEntriesRequestBody(StrictModel):
    domain: str | None = Field(default=None, description="The external domain to permit for collaboration, such as a partner or client organization's domain.")
    direction: Literal["inbound", "outbound", "both"] | None = Field(default=None, description="The direction in which collaboration is allowed for this domain: 'inbound' permits external users to collaborate into your organization, 'outbound' permits your users to collaborate into the external domain, and 'both' enables collaboration in either direction.")
class PostCollaborationWhitelistEntriesRequest(StrictModel):
    ...
    body: PostCollaborationWhitelistEntriesRequestBody | None = None
...
# Operation: remove_collaboration_whitelist_entry
class DeleteCollaborationWhitelistEntriesIdRequestPath(StrictModel):
    collaboration_whitelist_entry_id: str = Field(default=..., description="The unique identifier of the collaboration whitelist entry to remove.")
class DeleteCollaborationWhitelistEntriesIdRequest(StrictModel):
    ...
    path: DeleteCollaborationWhitelistEntriesIdRequestPath

# Operation: list_collaboration_whitelist_exempt_users
class GetCollaborationWhitelistExemptTargetsRequestQuery(StrictModel):
    limit: int | None = Field(default=None, description="The maximum number of exempt user records to return in a single page of results. Must be between 1 and 1000.", le=1000, json_schema_extra={'format': 'int64'})
class GetCollaborationWhitelistExemptTargetsRequest(StrictModel):
    ...
    query: GetCollaborationWhitelistExemptTargetsRequestQuery | None = None

# Operation: create_collaboration_whitelist_exemption
class PostCollaborationWhitelistExemptTargetsRequestBodyUser(StrictModel):
    id_: str | None = Field(default=None, validation_alias="id", serialization_alias="id", description="The unique identifier of the user to be exempted from collaboration domain restrictions.")
class PostCollaborationWhitelistExemptTargetsRequestBody(StrictModel):
    user: PostCollaborationWhitelistExemptTargetsRequestBodyUser | None = None
class PostCollaborationWhitelistExemptTargetsRequest(StrictModel):
    ...
    body: PostCollaborationWhitelistExemptTargetsRequestBody | None = None

# Operation: get_collaboration_whitelist_exemption
class GetCollaborationWhitelistExemptTargetsIdRequestPath(StrictModel):
    collaboration_whitelist_exempt_target_id: str = Field(default=..., description="The unique identifier of the collaboration domain restriction exemption record to retrieve.")
class GetCollaborationWhitelistExemptTargetsIdRequest(StrictModel):
    ...
    path: GetCollaborationWhitelistExemptTargetsIdRequestPath

# Operation: remove_collaboration_whitelist_exemption
class DeleteCollaborationWhitelistExemptTargetsIdRequestPath(StrictModel):
    collaboration_whitelist_exempt_target_id: str = Field(default=..., description="The unique identifier of the collaboration whitelist exemption record to be deleted.")
class DeleteCollaborationWhitelistExemptTargetsIdRequest(StrictModel):
    ...
    path: DeleteCollaborationWhitelistExemptTargetsIdRequestPath

# Operation: list_storage_policies
class GetStoragePoliciesRequestQuery(StrictModel):
    limit: int | None = Field(default=None, description="The maximum number of storage policies to return in a single response, up to a maximum of 1000.", le=1000, json_schema_extra={'format': 'int64'})
class GetStoragePoliciesRequest(StrictModel):
    ...
    query: GetStoragePoliciesRequestQuery | None = None

# Operation: get_storage_policy
class GetStoragePoliciesIdRequestPath(StrictModel):
    storage_policy_id: str = Field(default=..., description="The unique identifier of the storage policy to retrieve.")
class GetStoragePoliciesIdRequest(StrictModel):
    ...
    path: GetStoragePoliciesIdRequestPath
...
# Operation: update_storage_policy_assignment
class PutStoragePolicyAssignmentsIdRequestPath(StrictModel):
    storage_policy_assignment_id: str = Field(default=..., description="The unique identifier of the storage policy assignment to update.")
class PutStoragePolicyAssignmentsIdRequestBodyStoragePolicy(StrictModel):
    id_: str | None = Field(default=None, validation_alias="id", serialization_alias="id", description="The unique identifier of the storage policy to assign, replacing the currently assigned storage policy.")
class PutStoragePolicyAssignmentsIdRequestBody(StrictModel):
    storage_policy: PutStoragePolicyAssignmentsIdRequestBodyStoragePolicy | None = None
class PutStoragePolicyAssignmentsIdRequest(StrictModel):
    ...
    path: PutStoragePolicyAssignmentsIdRequestPath
    body: PutStoragePolicyAssignmentsIdRequestBody | None = None
...
# Operation: create_slack_integration_mapping
class PostIntegrationMappingsSlackRequestBody(StrictModel):
    partner_item: PostIntegrationMappingsSlackBodyPartnerItem | None = Field(default=None, description="The Slack channel to be mapped, identifying the partner-side resource in the integration.")
    box_item: PostIntegrationMappingsSlackBodyBoxItem | None = Field(default=None, description="The Box item (such as a folder) to be mapped to the specified Slack channel as the content destination.")
    options: PostIntegrationMappingsSlackBodyOptions | None = Field(default=None, description="Optional configuration settings that control the behavior of the Slack-to-Box integration mapping.")
class PostIntegrationMappingsSlackRequest(StrictModel):
    ...
    body: PostIntegrationMappingsSlackRequestBody | None = None

# Operation: update_slack_integration_mapping
class PutIntegrationMappingsSlackIdRequestPath(StrictModel):
    integration_mapping_id: str = Field(default=..., description="The unique identifier of the Slack integration mapping to update.")
class PutIntegrationMappingsSlackIdRequestBody(StrictModel):
    """At least one of `box_item` and `options` must be provided."""
    box_item: PutIntegrationMappingsSlackIdBodyBoxItem | None = Field(default=None, description="The Box folder item to associate with this Slack integration mapping, used to update which Box folder the mapping points to.")
    options: PutIntegrationMappingsSlackIdBodyOptions | None = Field(default=None, description="Configuration options for the Slack integration mapping, allowing customization of how the Box and Slack integration behaves.")
class PutIntegrationMappingsSlackIdRequest(StrictModel):
    ...
    path: PutIntegrationMappingsSlackIdRequestPath
    body: PutIntegrationMappingsSlackIdRequestBody | None = None

# Operation: delete_slack_integration_mapping
class DeleteIntegrationMappingsSlackIdRequestPath(StrictModel):
    integration_mapping_id: str = Field(default=..., description="The unique identifier of the Slack integration mapping to delete.")
class DeleteIntegrationMappingsSlackIdRequest(StrictModel):
    ...
    path: DeleteIntegrationMappingsSlackIdRequestPath
...
# Operation: update_teams_integration_mapping
class PutIntegrationMappingsTeamsIdRequestPath(StrictModel):
    integration_mapping_id: str = Field(default=..., description="The unique identifier of the Teams integration mapping to update.")
class PutIntegrationMappingsTeamsIdRequestBody(StrictModel):
    box_item: PutIntegrationMappingsTeamsIdBodyBoxItem | None = Field(default=None, description="The Box item details to associate with this integration mapping, including the target Box folder ID and any applicable configuration options.")
class PutIntegrationMappingsTeamsIdRequest(StrictModel):
    ...
    path: PutIntegrationMappingsTeamsIdRequestPath
    body: PutIntegrationMappingsTeamsIdRequestBody | None = None

# Operation: delete_teams_integration_mapping
class DeleteIntegrationMappingsTeamsIdRequestPath(StrictModel):
    integration_mapping_id: str = Field(default=..., description="The unique identifier of the Teams integration mapping to delete.")
class DeleteIntegrationMappingsTeamsIdRequest(StrictModel):
    """Permanently deletes a Box for Teams integration mapping by its ID. Requires Admin or Co-Admin role."""
    path: DeleteIntegrationMappingsTeamsIdRequestPath

# Operation: ask_ai_question
class PostAiAskRequestBody(StrictModel):
    mode: Literal["multiple_item_qa", "single_item_qa"] | None = Field(default=None, description="Controls whether the request targets a single document or multiple documents. Use 'single_item_qa' when the items array contains exactly one element; use 'multiple_item_qa' to query across up to 25 items. Note: multi-modal requests are not supported — if both images and text are provided, only text will be processed.")
    prompt: str | None = Field(default=None, description="The natural language question or instruction for the LLM to answer based on the provided items. Limited to 10,000 characters.")
    items: Annotated[list[AiItemAsk], AfterValidator(_check_unique_items)] | None = Field(default=None, description="An array of files or documents the LLM should use as context when generating its answer. Order is not significant; must contain between 1 and 25 items. Text files are processed up to 1MB; images are processed up to 5 items or pages at 1024x1024 resolution.", min_length=1, max_length=25)
    dialogue_history: list[AiDialogueHistory] | None = Field(default=None, description="An ordered list of prior prompt-and-response turns to provide conversational context to the LLM. Earlier turns should appear first to reflect the chronological flow of the conversation.")
    include_citations: bool | None = Field(default=None, description="When set to true, the response will include citations referencing the specific source content used by the LLM to generate the answer.")
    ai_agent: AiAgentReference | AiAgentAsk | None = Field(default=None, description="Optional configuration object for overriding the default AI agent settings used to process the request.")
class PostAiAskRequest(StrictModel):
    ...
    body: PostAiAskRequestBody | None = None

# Operation: generate_text
class PostAiTextGenRequestBody(StrictModel):
    prompt: str | None = Field(default=None, description="The question or instruction for the LLM to respond to. Limited to 10,000 characters.")
    items: Annotated[list[PostAiTextGenBodyItemsItem], AfterValidator(_check_unique_items)] | None = Field(default=None, description="An array containing exactly one file or document item for the LLM to reference when generating a response. Only the first 1MB of a document's text representation will be processed if the file exceeds that size.", min_length=1, max_length=1)
    dialogue_history: list[AiDialogueHistory] | None = Field(default=None, description="An ordered list of prior prompts and their corresponding LLM responses, used to provide conversational context for the current request. Earlier entries should appear first to reflect the chronological flow of the dialogue.")
    ai_agent: AiAgentReference | AiAgentTextGen | None = Field(default=None, description="Configuration object for overriding the default AI agent settings used to process the request, such as model selection or system prompts.")
class PostAiTextGenRequest(StrictModel):
    ...
    body: PostAiTextGenRequestBody | None = None

# Operation: get_ai_agent_default_config
class GetAiAgentDefaultRequestQuery(StrictModel):
    mode: Literal["ask", "text_gen", "extract", "extract_structured"] = Field(default=..., description="The operational mode for which to retrieve the default agent configuration. Determines the type of AI task the configuration applies to: 'ask' for question answering, 'text_gen' for text generation, 'extract' for unstructured data extraction, or 'extract_structured' for structured data extraction.")
    language: str | None = Field(default=None, description="The ISO 639-1 language code specifying the language for the returned agent configuration. If the specified language is not supported, the default agent configuration is returned instead.")
    model: str | None = Field(default=None, description="The specific AI model identifier for which to retrieve the default agent configuration. Use this to obtain model-specific defaults when working with a particular supported model.")
class GetAiAgentDefaultRequest(StrictModel):
    ...
    query: GetAiAgentDefaultRequestQuery
...
# Operation: update_ai_agent
class PutAiAgentsIdRequestPath(StrictModel):
    agent_id: str = Field(default=..., description="The unique identifier of the AI agent to update.")
class PutAiAgentsIdRequestBodyAsk(StrictModel):
    type_: Literal["ai_agent_ask"] | None = Field(default=None, validation_alias="type", serialization_alias="type", description="The type identifier for the ask capability of the AI agent; must be set to 'ai_agent_ask'.")
    access_state: str | None = Field(default=None, validation_alias="access_state", serialization_alias="access_state", description="The availability state of the ask capability; use 'enabled' to activate or 'disabled' to deactivate this capability.")
    description: str | None = Field(default=None, validation_alias="description", serialization_alias="description", description="A human-readable description of the ask capability, explaining its purpose or behavior to users.")
    custom_instructions: str | None = Field(default=None, validation_alias="custom_instructions", serialization_alias="custom_instructions", description="Custom behavioral or contextual instructions that guide how the ask capability responds to queries.")
    suggested_questions: list[str] | None = Field(default=None, validation_alias="suggested_questions", serialization_alias="suggested_questions", description="A list of up to 4 pre-defined questions surfaced to users for the ask capability; pass null to auto-generate suggestions or an empty array to show none. Order determines display sequence.", max_length=4)
    long_text: PutAiAgentsIdBodyAskLongText | None = Field(default=None, validation_alias="long_text", serialization_alias="long_text", description="Configuration object for the processor that handles longer text content within the ask capability.")
    basic_text: PutAiAgentsIdBodyAskBasicText | None = Field(default=None, validation_alias="basic_text", serialization_alias="basic_text", description="Configuration object for the processor that handles standard-length text content within the ask capability.")
    basic_image: PutAiAgentsIdBodyAskBasicImage | None = Field(default=None, validation_alias="basic_image", serialization_alias="basic_image", description="Configuration object for the processor that handles image-based content within the ask capability.")
    spreadsheet: PutAiAgentsIdBodyAskSpreadsheet | None = Field(default=None, validation_alias="spreadsheet", serialization_alias="spreadsheet", description="Configuration object for the AI agent tool responsible for processing spreadsheet and tabular data.")
    long_text_multi: PutAiAgentsIdBodyAskLongTextMulti | None = Field(default=None, validation_alias="long_text_multi", serialization_alias="long_text_multi", description="Configuration object for the processor that handles longer text content across multiple document contexts.")
    basic_text_multi: PutAiAgentsIdBodyAskBasicTextMulti | None = Field(default=None, validation_alias="basic_text_multi", serialization_alias="basic_text_multi", description="Configuration object for the processor that handles standard-length text content across multiple document contexts.")
    basic_image_multi: PutAiAgentsIdBodyAskBasicImageMulti | None = Field(default=None, validation_alias="basic_image_multi", serialization_alias="basic_image_multi", description="Configuration object for the processor that handles image-based content across multiple document contexts.")
class PutAiAgentsIdRequestBodyTextGen(StrictModel):
    type_: Literal["ai_agent_text_gen"] | None = Field(default=None, validation_alias="type", serialization_alias="type", description="The type identifier for the text generation capability of the AI agent; must be set to 'ai_agent_text_gen'.")
    access_state: str | None = Field(default=None, validation_alias="access_state", serialization_alias="access_state", description="The availability state of the text generation capability; use 'enabled' to activate or 'disabled' to deactivate this capability.")
    description: str | None = Field(default=None, validation_alias="description", serialization_alias="description", description="A human-readable description of the text generation capability, explaining its purpose or behavior to users.")
    custom_instructions: str | None = Field(default=None, validation_alias="custom_instructions", serialization_alias="custom_instructions", description="Custom behavioral or contextual instructions that guide how the text generation capability produces output.")
    suggested_questions: list[str] | None = Field(default=None, validation_alias="suggested_questions", serialization_alias="suggested_questions", description="A list of up to 4 pre-defined questions surfaced to users for the text generation capability; pass null to auto-generate suggestions or an empty array to show none. Order determines display sequence.", max_length=4)
    basic_gen: PutAiAgentsIdBodyTextGenBasicGen | None = Field(default=None, validation_alias="basic_gen", serialization_alias="basic_gen", description="Configuration object for the basic text generation tool used by the AI agent to produce written output.")
class PutAiAgentsIdRequestBodyExtract(StrictModel):
    type_: Literal["ai_agent_extract"] | None = Field(default=None, validation_alias="type", serialization_alias="type", description="The type identifier for the metadata extraction capability of the AI agent; must be set to 'ai_agent_extract'.")
    access_state: str | None = Field(default=None, validation_alias="access_state", serialization_alias="access_state", description="The availability state of the metadata extraction capability; use 'enabled' to activate or 'disabled' to deactivate this capability.")
    description: str | None = Field(default=None, validation_alias="description", serialization_alias="description", description="A human-readable description of the metadata extraction capability, explaining its purpose or behavior to users.")
    custom_instructions: str | None = Field(default=None, validation_alias="custom_instructions", serialization_alias="custom_instructions", description="Custom behavioral or contextual instructions that guide how the metadata extraction capability processes content.")
    long_text: PutAiAgentsIdBodyExtractLongText | None = Field(default=None, validation_alias="long_text", serialization_alias="long_text", description="Configuration object for the processor that handles longer text content within the metadata extraction capability.")
    basic_text: PutAiAgentsIdBodyExtractBasicText | None = Field(default=None, validation_alias="basic_text", serialization_alias="basic_text", description="Configuration object for the processor that handles standard-length text content within the metadata extraction capability.")
    basic_image: PutAiAgentsIdBodyExtractBasicImage | None = Field(default=None, validation_alias="basic_image", serialization_alias="basic_image", description="Configuration object for the processor that handles image-based content within the metadata extraction capability.")
class PutAiAgentsIdRequestBody(StrictModel):
    type_: Literal["ai_agent"] | None = Field(default=None, validation_alias="type", serialization_alias="type", description="The top-level type classification of the agent; must be set to 'ai_agent'.")
    name: str | None = Field(default=None, description="The display name of the AI agent.")
    access_state: str | None = Field(default=None, description="The overall availability state of the AI agent; use 'enabled' to make it active, 'disabled' to deactivate it, or 'enabled_for_selected_users' to restrict access to specific users.")
    icon_reference: str | None = Field(default=None, description="The URL reference to the avatar icon displayed for the AI agent, pointing to a supported image file hosted on the Box CDN avatars path.", min_length=1)
    allowed_entities: list[UserBase | GroupBase] | None = Field(default=None, description="A list of users or groups permitted to access and use this AI agent; each item should reference a valid user or group entity.")
    ask: PutAiAgentsIdRequestBodyAsk | None = None
    text_gen: PutAiAgentsIdRequestBodyTextGen | None = None
    extract_: PutAiAgentsIdRequestBodyExtract | None = Field(default=None, validation_alias="extract", serialization_alias="extract")
class PutAiAgentsIdRequest(StrictModel):
    ...
    path: PutAiAgentsIdRequestPath
    body: PutAiAgentsIdRequestBody | None = None

# Operation: delete_ai_agent
class DeleteAiAgentsIdRequestPath(StrictModel):
    agent_id: str = Field(default=..., description="The unique identifier of the AI agent to delete.")
class DeleteAiAgentsIdRequest(StrictModel):
    ...
    path: DeleteAiAgentsIdRequestPath

# Operation: create_metadata_taxonomy
class PostMetadataTaxonomiesRequestBody(StrictModel):
    key: str | None = Field(default=None, description="Unique identifier key for the taxonomy. If omitted, it is automatically derived from the displayName by converting to lowercase and replacing spaces and non-alphanumeric characters with underscores. Maximum 256 characters.", max_length=256)
    display_name: str | None = Field(default=None, validation_alias="displayName", serialization_alias="displayName", description="Human-readable name for the taxonomy as it appears in the UI. Maximum 4096 characters.", max_length=4096)
    namespace: str | None = Field(default=None, description="The namespace that scopes this taxonomy, typically corresponding to an enterprise identifier. Maximum 4096 characters.", max_length=4096)
class PostMetadataTaxonomiesRequest(StrictModel):
    ...
    body: PostMetadataTaxonomiesRequestBody | None = None
...
# Operation: update_metadata_taxonomy
class PatchMetadataTaxonomiesIdIdRequestPath(StrictModel):
    namespace: str = Field(default=..., description="The namespace that scopes the metadata taxonomy, typically tied to an enterprise or organization identifier.")
    taxonomy_key: str = Field(default=..., description="The unique key identifying the metadata taxonomy within the given namespace.")
class PatchMetadataTaxonomiesIdIdRequestBody(StrictModel):
    display_name: str | None = Field(default=None, validation_alias="displayName", serialization_alias="displayName", description="The human-readable display name for the taxonomy, up to 4096 characters.", max_length=4096)
class PatchMetadataTaxonomiesIdIdRequest(StrictModel):
    ...
    path: PatchMetadataTaxonomiesIdIdRequestPath
    body: PatchMetadataTaxonomiesIdIdRequestBody | None = None

# Operation: delete_metadata_taxonomy
class DeleteMetadataTaxonomiesIdIdRequestPath(StrictModel):
    namespace: str = Field(default=..., description="The namespace that scopes the metadata taxonomy, typically representing an enterprise or organizational unit.")
    taxonomy_key: str = Field(default=..., description="The unique key identifying the specific metadata taxonomy within the given namespace.")
class DeleteMetadataTaxonomiesIdIdRequest(StrictModel):
    ...
    path: DeleteMetadataTaxonomiesIdIdRequestPath

# Operation: create_taxonomy_levels
class PostMetadataTaxonomiesIdIdLevelsRequestPath(StrictModel):
    namespace: str = Field(default=..., description="The namespace that scopes the metadata taxonomy, typically representing an enterprise or organizational unit.")
    taxonomy_key: str = Field(default=..., description="The unique key identifying the metadata taxonomy within the given namespace.")
class PostMetadataTaxonomiesIdIdLevelsRequestBody(StrictModel):
    body: list[MetadataTaxonomyLevel] | None = Field(default=None, description="An array of taxonomy level objects to create. Each item defines a new level in the taxonomy hierarchy; order may reflect the intended hierarchical sequence.")
class PostMetadataTaxonomiesIdIdLevelsRequest(StrictModel):
    ...
    path: PostMetadataTaxonomiesIdIdLevelsRequestPath
    body: PostMetadataTaxonomiesIdIdLevelsRequestBody | None = None

# Operation: update_taxonomy_level
class PatchMetadataTaxonomiesIdIdLevelsIdRequestPath(StrictModel):
    ...
    taxonomy_key: str = Field(default=..., description="The unique key identifying the metadata taxonomy within the given namespace.")
    level_index: int = Field(default=..., description="The zero-based or one-based integer index identifying the specific level within the taxonomy to update.")
class PatchMetadataTaxonomiesIdIdLevelsIdRequestBody(StrictModel):
    display_name: str | None = Field(default=None, validation_alias="displayName", serialization_alias="displayName", description="The human-readable display name to assign to this taxonomy level, shown in UIs and reports.")
    description: str | None = Field(default=None, description="A descriptive text providing additional context or detail about this taxonomy level.")
class PatchMetadataTaxonomiesIdIdLevelsIdRequest(StrictModel):
    ...
    path: PatchMetadataTaxonomiesIdIdLevelsIdRequestPath
    body: PatchMetadataTaxonomiesIdIdLevelsIdRequestBody | None = None

# Operation: append_taxonomy_level
class PostMetadataTaxonomiesIdIdLevelsAppendRequestPath(StrictModel):
    namespace: str = Field(default=..., description="The namespace that owns the metadata taxonomy, used to scope and isolate taxonomies across different organizations or environments.")
    taxonomy_key: str = Field(default=..., description="The unique key identifying the metadata taxonomy to which the new level will be appended.")
class PostMetadataTaxonomiesIdIdLevelsAppendRequestBody(StrictModel):
    display_name: str | None = Field(default=None, validation_alias="displayName", serialization_alias="displayName", description="A human-readable name for the new taxonomy level, shown in UIs and reports.")
    description: str | None = Field(default=None, description="An optional longer description providing additional context or detail about the taxonomy level.")
class PostMetadataTaxonomiesIdIdLevelsAppendRequest(StrictModel):
    ...
    path: PostMetadataTaxonomiesIdIdLevelsAppendRequestPath
    body: PostMetadataTaxonomiesIdIdLevelsAppendRequestBody | None = None

# Operation: trim_taxonomy_level
class PostMetadataTaxonomiesIdIdLevelsTrimRequestPath(StrictModel):
    namespace: str = Field(default=..., description="The namespace that owns the metadata taxonomy, typically scoped to an enterprise or organization.")
    taxonomy_key: str = Field(default=..., description="The unique key identifying the metadata taxonomy whose last level will be removed.")
class PostMetadataTaxonomiesIdIdLevelsTrimRequest(StrictModel):
    ...
    path: PostMetadataTaxonomiesIdIdLevelsTrimRequestPath
...
class PostMetadataTaxonomiesIdIdNodesRequestPath(StrictModel):
    namespace: str = Field(default=..., description="The namespace that scopes the metadata taxonomy, typically representing an enterprise or organizational unit.")
    taxonomy_key: str = Field(default=..., description="The unique key identifying the metadata taxonomy within the given namespace.")
class PostMetadataTaxonomiesIdIdNodesRequestBody(StrictModel):
    display_name: str | None = Field(default=None, validation_alias="displayName", serialization_alias="displayName", description="The human-readable label for the taxonomy node as it will appear in the UI or reports.")
    level: int | None = Field(default=None, description="The depth position of this node within the taxonomy hierarchy, where lower values indicate higher levels in the tree.")
    parent_id: str | None = Field(default=None, validation_alias="parentId", serialization_alias="parentId", description="The unique identifier of the parent node under which this node will be nested. Omit this field to create a root-level node.")
class PostMetadataTaxonomiesIdIdNodesRequest(StrictModel):
    ...
    path: PostMetadataTaxonomiesIdIdNodesRequestPath
    body: PostMetadataTaxonomiesIdIdNodesRequestBody | None = None
...
# Operation: update_taxonomy_node
class PatchMetadataTaxonomiesIdIdNodesIdRequestPath(StrictModel):
    namespace: str = Field(default=..., description="The namespace that scopes the metadata taxonomy, typically representing an enterprise or organizational unit.")
    taxonomy_key: str = Field(default=..., description="The unique key identifying the metadata taxonomy within the namespace, representing a classification category such as geography or department.")
    node_id: str = Field(default=..., description="The unique identifier of the taxonomy node to update, formatted as a UUID.")
class PatchMetadataTaxonomiesIdIdNodesIdRequestBody(StrictModel):
    display_name: str | None = Field(default=None, validation_alias="displayName", serialization_alias="displayName", description="The human-readable display name to assign to the taxonomy node, used for presentation in UIs and reports.")
class PatchMetadataTaxonomiesIdIdNodesIdRequest(StrictModel):
    ...
    path: PatchMetadataTaxonomiesIdIdNodesIdRequestPath
    body: PatchMetadataTaxonomiesIdIdNodesIdRequestBody | None = None
...
class AiAgentLongTextToolTextGenEmbeddingsStrategy(PermissiveModel):
    id_: str | None = Field(None, validation_alias="id", serialization_alias="id", description="The strategy used for the AI agent for calculating embeddings.")
    num_tokens_per_chunk: int | None = Field(None, description="The number of tokens per chunk.", ge=1, le=512)

class AiAgentLongTextToolTextGenEmbeddings(PermissiveModel):
    model: str | None = Field(None, description="The model used for the AI agent for calculating embeddings.")
    strategy: AiAgentLongTextToolTextGenEmbeddingsStrategy | None = None

class AiAgentLongTextToolTextGenV1EmbeddingsStrategy(PermissiveModel):
    id_: str | None = Field(None, validation_alias="id", serialization_alias="id", description="The strategy used for the AI agent for calculating embeddings.")
    num_tokens_per_chunk: int | None = Field(None, description="The number of tokens per chunk.", ge=1, le=512)

class AiAgentLongTextToolTextGenV1Embeddings(PermissiveModel):
    model: str | None = Field(None, description="The model used for the AI agent for calculating embeddings.")
    strategy: AiAgentLongTextToolTextGenV1EmbeddingsStrategy | None = None
...
class AiAgentReference(PermissiveModel):
    ...
    id_: str | None = Field(None, validation_alias="id", serialization_alias="id", description="The ID of an Agent. This can be a numeric ID for custom agents (for example, `14031`)\nor a unique identifier for pre-built agents (for example, `enhanced_extract_agent`\nfor the [Enhanced Extract ...")

class AiDialogueHistory(PermissiveModel):
    """A context object that can hold prior prompts and answers."""
    prompt: str | None = Field(None, description="The prompt previously provided by the client and answered by the LLM.")
    answer: str | None = Field(None, description="The answer previously provided by the LLM.")
    created_at: str | None = Field(None, description="The ISO date formatted timestamp of when the previous answer to the prompt was created.", json_schema_extra={'format': 'date-time'})

class AiItemAsk(PermissiveModel):
    ...
    type_: Literal["file", "hubs"] = Field(..., validation_alias="type", serialization_alias="type", description="The type of the item. A `hubs` item must be used as a single item.")
...
class AiLlmEndpointParamsIbm(PermissiveModel):
    ...
    temperature: float | None = Field(None, description="What sampling temperature to use, between 0 and 1. Higher values like 0.8 will make the output more random, \nwhile lower values like 0.2 will make it more focused and deterministic. \nWe generally...")
    top_p: float | None = Field(None, description="An alternative to sampling with temperature, called nucleus sampling, where the model considers the results \nof the tokens with `top_p` probability mass. So 0.1 means only the tokens comprising th...", ge=0.1, le=1)
...
class AiAgentBasicTextTool(PermissiveModel):
    ...
    prompt_template: str | None = Field(None, description="The prompt template contains contextual information of the request and the user prompt.\nWhen passing `prompt_template` parameters, you **must include** inputs for `{user_question}` and `{content}`...", max_length=10000, pattern="(\\{user_question\\}[\\s\\S]*?\\{content\\}|\\{content\\}[\\s\\S]*?\\{user_question\\})")

class AiAgentBasicTextToolTextGen(PermissiveModel):
    """AI agent processor used to handle basic text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParams | None = None
    ...
    prompt_template: str | None = Field(None, description="The prompt template contains contextual information of the request and the user prompt.\n\nWhen using the `prompt_template` parameter, you **must include** input for `{user_question}`.\nInputs for ...", max_length=10000, pattern="\\{user_question\\}")
...
class AiAgentLongTextToolTextGen(PermissiveModel):
    """AI agent processor used to to handle longer text."""
    embeddings: AiAgentLongTextToolTextGenEmbeddings | None = None

class AiAgentBasicGenTool(PermissiveModel):
...
class AiAgentSpreadsheetTool(PermissiveModel):
...
class AiAgentAsk(PermissiveModel):
    """The AI agent used to handle queries."""
    type_: Literal["ai_agent_ask"] = Field(..., validation_alias="type", serialization_alias="type", description="The type of AI agent used to handle queries.")
    long_text: AiAgentLongTextTool | None = None
    basic_text: AiAgentBasicTextTool | None = None
    spreadsheet: AiAgentSpreadsheetTool | None = None
    long_text_multi: AiAgentLongTextTool | None = None
    basic_text_multi: AiAgentBasicTextTool | None = None
    basic_image: AiAgentBasicTextTool | None = None
    basic_image_multi: AiAgentBasicTextTool | None = None

class AiAgentTextGen(PermissiveModel):
    """The AI agent used for generating text."""
    type_: Literal["ai_agent_text_gen"] = Field(..., validation_alias="type", serialization_alias="type", description="The type of AI agent used for generating text.")
    basic_gen: AiAgentBasicGenTool | None = None
...
class MetadataTaxonomyLevel(PermissiveModel):
    """A level in the metadata taxonomy represents a hierarchical category
within the taxonomy structure."""
    display_name: str | None = Field(None, validation_alias="displayName", serialization_alias="displayName", description="The display name of the level as it is shown to the user.")
    description: str | None = Field(None, description="A description of the level.")
    level: int | None = Field(None, description="An index of the level within the taxonomy. Levels are indexed starting from 1.", json_schema_extra={'format': 'int32'})

class OptionsFilesContentBodyParent(PermissiveModel):
...
class PostAiTextGenBodyItemsItem(PermissiveModel):
    """The item to be processed by the LLM."""
    id_: str = Field(..., validation_alias="id", serialization_alias="id", description="The ID of the item.")
    type_: Literal["file"] = Field(..., validation_alias="type", serialization_alias="type", description="The type of the item.")
    content: str | None = Field(None, description="The content to use as context for generating new text or editing existing text.")
...
class PostIntegrationMappingsSlackBodyBoxItem(PermissiveModel):
    type_: Literal["folder"] = Field(..., validation_alias="type", serialization_alias="type", description="Type of the mapped item referenced in `id`.")
    id_: str = Field(..., validation_alias="id", serialization_alias="id", description="ID of the mapped item (of type referenced in `type`).")

class PostIntegrationMappingsSlackBodyOptions(PermissiveModel):
    is_access_management_disabled: bool | None = Field(None, description="Indicates whether or not channel member\naccess to the underlying box item\nshould be automatically managed.\nDepending on type of channel, access is managed\nthrough creating collaborations or sha...")

class PostIntegrationMappingsSlackBodyPartnerItem(PermissiveModel):
    type_: Literal["channel"] = Field(..., validation_alias="type", serialization_alias="type", description="Type of the mapped item referenced in `id`.")
    id_: str = Field(..., validation_alias="id", serialization_alias="id", description="ID of the mapped item (of type referenced in `type`).")
    slack_workspace_id: str | None = Field(None, description="ID of the Slack workspace with which the item is associated. Use this parameter if Box for Slack is installed at a workspace level. Do not use `slack_org_id` at the same time.")
    slack_org_id: str | None = Field(None, description="ID of the Slack org with which the item is associated. Use this parameter if Box for Slack is installed at the org level. Do not use `slack_workspace_id` at the same time.")
...
class PutAiAgentsIdBodyAskBasicImage(PermissiveModel):
    """AI agent processor used to handle basic text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
...
class PutAiAgentsIdBodyAskBasicImageMulti(PermissiveModel):
    """AI agent processor used to handle basic text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
...
class PutAiAgentsIdBodyAskBasicText(PermissiveModel):
    """AI agent processor used to handle basic text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
...
class PutAiAgentsIdBodyAskBasicTextMulti(PermissiveModel):
    """AI agent processor used to handle basic text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
...
class PutAiAgentsIdBodyAskLongTextEmbeddingsStrategy(PermissiveModel):
    id_: str | None = Field(None, validation_alias="id", serialization_alias="id", description="The strategy used for the AI agent for calculating embeddings.")
    num_tokens_per_chunk: int | None = Field(None, description="The number of tokens per chunk.", ge=1, le=512)

class PutAiAgentsIdBodyAskLongTextEmbeddings(PermissiveModel):
    model: str | None = Field(None, description="The model used for the AI agent for calculating embeddings.")
    strategy: PutAiAgentsIdBodyAskLongTextEmbeddingsStrategy | None = None

class PutAiAgentsIdBodyAskLongText(PermissiveModel):
    """AI agent processor used to to handle longer text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
    system_message: str | None = Field(None, description="System messages try to help the LLM \"understand\" its role and what it is supposed to do.")
    prompt_template: str | None = Field(None, description="The prompt template contains contextual information of the request and the user prompt.\nWhen passing `prompt_template` parameters, you **must include** inputs for `{user_question}` and `{content}`...", max_length=10000, pattern="(\\{user_question\\}[\\s\\S]*?\\{content\\}|\\{content\\}[\\s\\S]*?\\{user_question\\})")
    embeddings: PutAiAgentsIdBodyAskLongTextEmbeddings | None = None
    is_custom_instructions_included: bool | None = Field(None, description="True if system message contains custom instructions placeholder, false otherwise.")

class PutAiAgentsIdBodyAskLongTextMultiEmbeddingsStrategy(PermissiveModel):
    id_: str | None = Field(None, validation_alias="id", serialization_alias="id", description="The strategy used for the AI agent for calculating embeddings.")
    num_tokens_per_chunk: int | None = Field(None, description="The number of tokens per chunk.", ge=1, le=512)

class PutAiAgentsIdBodyAskLongTextMultiEmbeddings(PermissiveModel):
    model: str | None = Field(None, description="The model used for the AI agent for calculating embeddings.")
    strategy: PutAiAgentsIdBodyAskLongTextMultiEmbeddingsStrategy | None = None

class PutAiAgentsIdBodyAskLongTextMulti(PermissiveModel):
    """AI agent processor used to to handle longer text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
    system_message: str | None = Field(None, description="System messages try to help the LLM \"understand\" its role and what it is supposed to do.")
    prompt_template: str | None = Field(None, description="The prompt template contains contextual information of the request and the user prompt.\nWhen passing `prompt_template` parameters, you **must include** inputs for `{user_question}` and `{content}`...", max_length=10000, pattern="(\\{user_question\\}[\\s\\S]*?\\{content\\}|\\{content\\}[\\s\\S]*?\\{user_question\\})")
    embeddings: PutAiAgentsIdBodyAskLongTextMultiEmbeddings | None = None
    is_custom_instructions_included: bool | None = Field(None, description="True if system message contains custom instructions placeholder, false otherwise.")

class PutAiAgentsIdBodyAskSpreadsheet(PermissiveModel):
    """The AI agent tool used to handle spreadsheets and tabular data."""
    model: str | None = Field(None, description="The model used for the AI agent for spreadsheets. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")

class PutAiAgentsIdBodyExtractBasicImage(PermissiveModel):
    """AI agent processor used to handle basic text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
...
class PutAiAgentsIdBodyExtractBasicText(PermissiveModel):
    """AI agent processor used to handle basic text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
...
class PutAiAgentsIdBodyExtractLongTextEmbeddingsStrategy(PermissiveModel):
    id_: str | None = Field(None, validation_alias="id", serialization_alias="id", description="The strategy used for the AI agent for calculating embeddings.")
    num_tokens_per_chunk: int | None = Field(None, description="The number of tokens per chunk.", ge=1, le=512)

class PutAiAgentsIdBodyExtractLongTextEmbeddings(PermissiveModel):
    model: str | None = Field(None, description="The model used for the AI agent for calculating embeddings.")
    strategy: PutAiAgentsIdBodyExtractLongTextEmbeddingsStrategy | None = None

class PutAiAgentsIdBodyExtractLongText(PermissiveModel):
    """AI agent processor used to to handle longer text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
    system_message: str | None = Field(None, description="System messages try to help the LLM \"understand\" its role and what it is supposed to do.")
    prompt_template: str | None = Field(None, description="The prompt template contains contextual information of the request and the user prompt.\nWhen passing `prompt_template` parameters, you **must include** inputs for `{user_question}` and `{content}`...", max_length=10000, pattern="(\\{user_question\\}[\\s\\S]*?\\{content\\}|\\{content\\}[\\s\\S]*?\\{user_question\\})")
    embeddings: PutAiAgentsIdBodyExtractLongTextEmbeddings | None = None
    is_custom_instructions_included: bool | None = Field(None, description="True if system message contains custom instructions placeholder, false otherwise.")

class PutAiAgentsIdBodyTextGenBasicGenEmbeddingsStrategy(PermissiveModel):
    id_: str | None = Field(None, validation_alias="id", serialization_alias="id", description="The strategy used for the AI agent for calculating embeddings.")
    num_tokens_per_chunk: int | None = Field(None, description="The number of tokens per chunk.", ge=1, le=512)

class PutAiAgentsIdBodyTextGenBasicGenEmbeddings(PermissiveModel):
    model: str | None = Field(None, description="The model used for the AI agent for calculating embeddings.")
    strategy: PutAiAgentsIdBodyTextGenBasicGenEmbeddingsStrategy | None = None

class PutAiAgentsIdBodyTextGenBasicGen(PermissiveModel):
    """AI agent basic tool used to generate text."""
    model: str | None = Field(None, description="The model used for the AI agent for basic text. For specific model values, see the [available models list](https://developer.box.com/guides/box-ai/ai-models).")
    num_tokens_for_completion: int | None = Field(None, description="The number of tokens for completion.", ge=1)
    llm_endpoint_params: AiLlmEndpointParamsOpenAi | AiLlmEndpointParamsGoogle | AiLlmEndpointParamsAws | AiLlmEndpointParamsIbm | None = Field(None, description="The parameters for the LLM endpoint specific to a model.")
    system_message: str | None = Field(None, description="System messages aim at helping the LLM understand its role and what it is supposed to do.\nThe input for `{current_date}` is optional, depending on the use.")
    prompt_template: str | None = Field(None, description="The prompt template contains contextual information of the request and the user prompt.\n\nWhen using the `prompt_template` parameter, you **must include** input for `{user_question}`.\nInputs for ...", max_length=10000, pattern="\\{user_question\\}")
    embeddings: PutAiAgentsIdBodyTextGenBasicGenEmbeddings | None = None
    content_template: str | None = Field(None, description="How the content should be included in a request to the LLM.\nInput for `{content}` is optional, depending on the use.")
    is_custom_instructions_included: bool | None = Field(None, description="True if system message contains custom instructions placeholder, false otherwise.")
...
class PutIntegrationMappingsSlackIdBodyBoxItem(PermissiveModel):
    type_: Literal["folder"] = Field(..., validation_alias="type", serialization_alias="type", description="Type of the mapped item referenced in `id`.")
    id_: str = Field(..., validation_alias="id", serialization_alias="id", description="ID of the mapped item (of type referenced in `type`).")

class PutIntegrationMappingsSlackIdBodyOptions(PermissiveModel):
    is_access_management_disabled: bool | None = Field(None, description="Indicates whether or not channel member\naccess to the underlying box item\nshould be automatically managed.\nDepending on type of channel, access is managed\nthrough creating collaborations or sha...")

class PutIntegrationMappingsTeamsIdBodyBoxItem(PermissiveModel):
    type_: Literal["folder"] = Field(..., validation_alias="type", serialization_alias="type", description="The value will always be `folder`.")
    id_: str = Field(..., validation_alias="id", serialization_alias="id", description="ID of the folder.")

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemDataStaticConfigClassification(PermissiveModel):
    """Additional details for the classification."""
    classification_definition: str | None = Field(None, validation_alias="classificationDefinition", serialization_alias="classificationDefinition", description="A longer description of the classification.")
    color_id: int | None = Field(None, validation_alias="colorID", serialization_alias="colorID", description="An internal Box identifier used to assign a color to\na classification label.\n\nMapping between a `colorID` and a color may change\nwithout notice. Currently, the color mappings are as\nfollows.\n...", json_schema_extra={'format': 'int64'})

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemDataStaticConfig(PermissiveModel):
    """A static configuration for the classification."""
    classification: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemDataStaticConfigClassification | None = Field(None, description="Additional details for the classification.")

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemData(PermissiveModel):
    """The details of the classification to add."""
    key: str = Field(..., description="The label of the classification as shown in the web and\nmobile interfaces. This is the only field required to\nadd a classification.")
    static_config: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemDataStaticConfig | None = Field(None, validation_alias="staticConfig", serialization_alias="staticConfig", description="A static configuration for the classification.")

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItem(PermissiveModel):
    """A single classification to add to the enterprise."""
    op: Literal["addEnumOption"] = Field(..., description="The type of change to perform on the classification\nobject.")
    field_key: Literal["Box__Security__Classification__Key"] = Field(..., validation_alias="fieldKey", serialization_alias="fieldKey", description="Defines classifications \navailable in the enterprise.")
    data: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemData = Field(..., description="The details of the classification to add.")

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemDataStaticConfigClassification(PermissiveModel):
    """Additional details for the classification."""
    classification_definition: str | None = Field(None, validation_alias="classificationDefinition", serialization_alias="classificationDefinition", description="A longer description of the classification.")
    color_id: int | None = Field(None, validation_alias="colorID", serialization_alias="colorID", description="An internal Box identifier used to assign a color to\na classification label.\n\nMapping between a `colorID` and a color may change\nwithout notice. Currently, the color mappings are as\nfollows.\n...", json_schema_extra={'format': 'int64'})

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemDataStaticConfig(PermissiveModel):
    """A static configuration for the classification."""
    classification: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemDataStaticConfigClassification | None = Field(None, description="Additional details for the classification.")

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemData(PermissiveModel):
    """The details of the updated classification."""
    key: str = Field(..., description="A new label for the classification, as it will be\nshown in the web and mobile interfaces.")
    static_config: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemDataStaticConfig | None = Field(None, validation_alias="staticConfig", serialization_alias="staticConfig", description="A static configuration for the classification.")

class PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItem(PermissiveModel):
    """A single classification to update."""
    op: Literal["editEnumOption"] = Field(..., description="The type of change to perform on the classification\nobject.")
    field_key: Literal["Box__Security__Classification__Key"] = Field(..., validation_alias="fieldKey", serialization_alias="fieldKey", description="Defines classifications \navailable in the enterprise.")
    enum_option_key: str = Field(..., validation_alias="enumOptionKey", serialization_alias="enumOptionKey", description="The original label of the classification to change.")
    data: PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemData = Field(..., description="The details of the updated classification.")
...
class SignRequestBase(PermissiveModel):
    ...
    email_message: str | None = Field(None, description="Message to include in sign request email. The field is cleaned through sanitization of specific characters. However, some html tags are allowed. Links included in the message are also converted to ...")
    ...
    days_valid: int | None = Field(None, description="Set the number of days after which the created signature request will automatically expire if not completed. By default, we do not apply any expiration date on signature requests, and the signature...", ge=0, le=730)
...
AiAgentAsk.model_rebuild()
AiAgentBasicGenTool.model_rebuild()
AiAgentBasicTextTool.model_rebuild()
AiAgentBasicTextToolBase.model_rebuild()
AiAgentBasicTextToolTextGen.model_rebuild()
...
AiAgentLongTextToolTextGen.model_rebuild()
AiAgentLongTextToolTextGenEmbeddings.model_rebuild()
AiAgentLongTextToolTextGenEmbeddingsStrategy.model_rebuild()
AiAgentLongTextToolTextGenV1Embeddings.model_rebuild()
AiAgentLongTextToolTextGenV1EmbeddingsStrategy.model_rebuild()
...
AiAgentSpreadsheetTool.model_rebuild()
AiAgentTextGen.model_rebuild()
AiDialogueHistory.model_rebuild()
AiItemAsk.model_rebuild()
...
MetadataTaxonomyLevel.model_rebuild()
OptionsFilesContentBodyParent.model_rebuild()
...
PostAiTextGenBodyItemsItem.model_rebuild()
PostFilesIdBodyParent.model_rebuild()
PostFoldersBodyFolderUploadEmail.model_rebuild()
PostFoldersIdBodyParent.model_rebuild()
PostIntegrationMappingsSlackBodyBoxItem.model_rebuild()
PostIntegrationMappingsSlackBodyOptions.model_rebuild()
PostIntegrationMappingsSlackBodyPartnerItem.model_rebuild()
...
PutAiAgentsIdBodyAskBasicImage.model_rebuild()
PutAiAgentsIdBodyAskBasicImageMulti.model_rebuild()
PutAiAgentsIdBodyAskBasicText.model_rebuild()
PutAiAgentsIdBodyAskBasicTextMulti.model_rebuild()
PutAiAgentsIdBodyAskLongText.model_rebuild()
PutAiAgentsIdBodyAskLongTextEmbeddings.model_rebuild()
PutAiAgentsIdBodyAskLongTextEmbeddingsStrategy.model_rebuild()
PutAiAgentsIdBodyAskLongTextMulti.model_rebuild()
PutAiAgentsIdBodyAskLongTextMultiEmbeddings.model_rebuild()
PutAiAgentsIdBodyAskLongTextMultiEmbeddingsStrategy.model_rebuild()
PutAiAgentsIdBodyAskSpreadsheet.model_rebuild()
PutAiAgentsIdBodyExtractBasicImage.model_rebuild()
PutAiAgentsIdBodyExtractBasicText.model_rebuild()
PutAiAgentsIdBodyExtractLongText.model_rebuild()
PutAiAgentsIdBodyExtractLongTextEmbeddings.model_rebuild()
PutAiAgentsIdBodyExtractLongTextEmbeddingsStrategy.model_rebuild()
PutAiAgentsIdBodyTextGenBasicGen.model_rebuild()
PutAiAgentsIdBodyTextGenBasicGenEmbeddings.model_rebuild()
PutAiAgentsIdBodyTextGenBasicGenEmbeddingsStrategy.model_rebuild()
...
PutIntegrationMappingsSlackIdBodyBoxItem.model_rebuild()
PutIntegrationMappingsSlackIdBodyOptions.model_rebuild()
PutIntegrationMappingsTeamsIdBodyBoxItem.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItem.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemData.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemDataStaticConfig.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaAddBodyItemDataStaticConfigClassification.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItem.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemData.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemDataStaticConfig.model_rebuild()
PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUWoSchemaUpdateBodyItemDataStaticConfigClassification.model_rebuild()
