...
class OAuth2Auth:
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://api.figma.com/v1/oauth/token")
        self.auth_url = self._resolve_url_template("https://www.figma.com/oauth")
        self.refresh_url = self._resolve_url_template("https://api.figma.com/v1/oauth/refresh")
...
class OrgOAuth2Auth:
    ...
    Redirect URI:
        - Default: http://localhost:<ORG_OAUTH2_CALLBACK_PORT>/callback
        - Configured via ORG_OAUTH2_CALLBACK_PORT in .env (default: 9400)        - Must match redirect URI in your OAuth application configuration
    Token Storage:
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "export_file_json": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "get_file_nodes": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "render_node_images": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_image_fills": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "get_file_metadata": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_team_projects": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_project_files": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_file_versions": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_file_comments": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "add_file_comment": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "delete_comment": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_comment_reactions": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "add_comment_reaction": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "remove_comment_reaction": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "get_current_user": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_team_components": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_file_components": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "get_component": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_component_sets": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_component_sets_file": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "get_component_set": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_team_styles": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_file_styles": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "get_style": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_webhooks": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "get_webhook": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_activity_logs": [["OrgOAuth2"], ["PersonalAccessToken"], ["OAuth2"]],
    "list_payments": [["PersonalAccessToken"], ["OAuth2"], ["OrgOAuth2"]],
    "list_local_variables": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_published_variables": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "bulk_modify_variables": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_dev_resources": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "create_dev_resources": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "update_dev_resources": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "remove_dev_resource": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_library_component_actions": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_library_component_usages": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_library_style_actions": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_library_style_usages": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_library_variable_actions": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]],
    "list_library_variable_usages": [["OAuth2"], ["PersonalAccessToken"], ["OrgOAuth2"]]
}
