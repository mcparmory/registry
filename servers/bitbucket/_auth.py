...
class OAuth2Auth:
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://bitbucket.org/site/oauth2/access_token")
        self.auth_url = self._resolve_url_template("https://bitbucket.org/site/oauth2/authorize")
