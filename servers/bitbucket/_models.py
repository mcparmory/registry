"""
Bitbucket Api MCP Server - Pydantic Models
...
__all__ = [
    ...
    "DeleteRepositoriesPermissionsConfigGroupsRequest",
    ...
    "DeleteWorkspacesProjectsPermissionsConfigGroupsRequest",
    "DeleteWorkspacesProjectsPermissionsConfigUsersRequest",
    "DeleteWorkspacesProjectsRequest",
    "GetHookEventsBySubjectTypeRequest",
    "GetHookEventsRequest",
    ...
    "GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigGroupsByGroupSlugRequest",
    "GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigGroupsRequest",
    "GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigUsersBySelectedUserIdRequest",
    ...
    "GetWorkspacesPipelinesConfigIdentityOidcKeysJsonRequest",
    "GetWorkspacesPipelinesConfigIdentityOidcWellKnownOpenidConfigurationRequest",
    ...
    "PutRepositoriesPermissionsConfigGroupsRequest",
    "PutRepositoriesPermissionsConfigUsersRequest",
    "PutRepositoriesPipelinesConfigBuildNumberRequest",
    "PutRepositoriesPipelinesConfigRequest",
    ...
    "PutWorkspacesProjectsBranchingModelSettingsRequest",
    "PutWorkspacesProjectsDefaultReviewersRequest",
    "PutWorkspacesProjectsPermissionsConfigGroupsRequest",
    "PutWorkspacesProjectsPermissionsConfigUsersRequest",
    ...
    "PutRepositoriesPipelinesConfigBody",
...
class PutAddonRequest(StrictModel):
...
class DeleteAddonRequest(StrictModel):
...
# Operation: list_webhook_event_types
class GetHookEventsRequest(StrictModel):
...
class PostRepositoriesHooksRequestPath(StrictModel):
    repo_slug: str = Field(default=..., description="The repository slug or UUID identifying the target repository. UUIDs must be surrounded by curly-braces.")
    workspace: str = Field(default=..., description="The workspace ID (slug) or UUID identifying the workspace that owns the repository. UUIDs must be surrounded by curly-braces.")
class PostRepositoriesHooksRequest(StrictModel):
    ...
    path: PostRepositoriesHooksRequestPath
...
# Operation: set_group_repository_permission
class PutRepositoriesPermissionsConfigGroupsRequestPath(StrictModel):
    group_slug: str = Field(default=..., description="The slug identifier of the group whose repository permission is being set or updated.")
    repo_slug: str = Field(default=..., description="The repository slug or UUID identifying the target repository; UUIDs must be surrounded by curly-braces.")
    workspace: str = Field(default=..., description="The workspace slug or UUID identifying the workspace that owns the repository; UUIDs must be surrounded by curly-braces.")
class PutRepositoriesPermissionsConfigGroupsRequest(StrictModel):
    ...
    path: PutRepositoriesPermissionsConfigGroupsRequestPath

# Operation: delete_repository_group_permission
class DeleteRepositoriesPermissionsConfigGroupsRequestPath(StrictModel):
    group_slug: str = Field(default=..., description="The slug identifier of the group whose repository permission should be deleted.")
    ...
    workspace: str = Field(default=..., description="The workspace ID (slug) or UUID (surrounded by curly-braces) that owns the repository.")
class DeleteRepositoriesPermissionsConfigGroupsRequest(StrictModel):
    ...
    path: DeleteRepositoriesPermissionsConfigGroupsRequestPath
...
# Operation: set_repository_user_permission
class PutRepositoriesPermissionsConfigUsersRequestPath(StrictModel):
    repo_slug: str = Field(default=..., description="The repository slug or UUID identifying the target repository within the workspace.")
    selected_user_id: str = Field(default=..., description="The account identifier for the user whose permission is being updated, either as an Atlassian Account ID or a UUID wrapped in curly-braces.")
    workspace: str = Field(default=..., description="The workspace identifier, either as a slug or a UUID wrapped in curly-braces, that contains the repository.")
class PutRepositoriesPermissionsConfigUsersRequest(StrictModel):
    ...
    path: PutRepositoriesPermissionsConfigUsersRequestPath
...
# Operation: update_pipelines_config
class PutRepositoriesPipelinesConfigRequestPath(StrictModel):
    workspace: str = Field(default=..., description="The workspace identifier, either as a slug (short name) or as a UUID surrounded by curly braces.")
    repo_slug: str = Field(default=..., description="The repository slug (URL-friendly name) that uniquely identifies the repository within the workspace.")
class PutRepositoriesPipelinesConfigRequestBody(StrictModel):
    """The updated repository pipelines configuration."""
    body: PutRepositoriesPipelinesConfigBody | None = Field(default=None, description="The pipelines configuration object containing the settings to apply to the repository.")
class PutRepositoriesPipelinesConfigRequest(StrictModel):
    ...
    path: PutRepositoriesPipelinesConfigRequestPath
    body: PutRepositoriesPipelinesConfigRequestBody | None = None
...
class PostSnippetsRequest(StrictModel):
...
# Operation: list_user_emails
class GetUserEmailsRequest(StrictModel):
...
# Operation: create_workspace_webhook
class PostWorkspacesHooksRequestPath(StrictModel):
    workspace: str = Field(default=..., description="The workspace identifier, either the workspace slug (e.g. my-workspace) or the workspace UUID surrounded by curly braces.")
class PostWorkspacesHooksRequest(StrictModel):
    ...
    path: PostWorkspacesHooksRequestPath
...
# Operation: get_oidc_openid_configuration
class GetWorkspacesPipelinesConfigIdentityOidcWellKnownOpenidConfigurationRequestPath(StrictModel):
    workspace: str = Field(default=..., description="The workspace identifier, either as a slug (human-readable short name) or as a UUID surrounded by curly braces.")
class GetWorkspacesPipelinesConfigIdentityOidcWellKnownOpenidConfigurationRequest(StrictModel):
    ...
    path: GetWorkspacesPipelinesConfigIdentityOidcWellKnownOpenidConfigurationRequestPath

# Operation: get_oidc_public_keys
class GetWorkspacesPipelinesConfigIdentityOidcKeysJsonRequestPath(StrictModel):
    workspace: str = Field(default=..., description="The workspace identifier, either as a slug (human-readable short name) or as a UUID surrounded by curly-braces.")
class GetWorkspacesPipelinesConfigIdentityOidcKeysJsonRequest(StrictModel):
    ...
    path: GetWorkspacesPipelinesConfigIdentityOidcKeysJsonRequestPath
...
# Operation: update_project_branching_model_settings
class PutWorkspacesProjectsBranchingModelSettingsRequestPath(StrictModel):
    project_key: str = Field(default=..., description="The unique key assigned to the project within the workspace, used to identify which project's branching model settings to update.")
    workspace: str = Field(default=..., description="The workspace identifier, which can be either the workspace slug or the workspace UUID enclosed in curly braces.")
class PutWorkspacesProjectsBranchingModelSettingsRequest(StrictModel):
    ...
    path: PutWorkspacesProjectsBranchingModelSettingsRequestPath
...
# Operation: get_project_group_permission
class GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigGroupsByGroupSlugRequestPath(StrictModel):
    group_slug: str = Field(default=..., description="The slug identifier of the group whose project permission is being retrieved.")
    project_key: str = Field(default=..., description="The unique key assigned to the project within the workspace.")
    workspace: str = Field(default=..., description="The workspace identifier, either as a slug or as a UUID surrounded by curly-braces.")
class GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigGroupsByGroupSlugRequest(StrictModel):
    ...
    path: GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigGroupsByGroupSlugRequestPath

# Operation: set_project_group_permission
class PutWorkspacesProjectsPermissionsConfigGroupsRequestPath(StrictModel):
    group_slug: str = Field(default=..., description="The slug identifier of the group whose project permission is being set or updated.")
    project_key: str = Field(default=..., description="The unique key assigned to the project within the workspace.")
    workspace: str = Field(default=..., description="The workspace identifier, either as a slug or as a UUID surrounded by curly-braces.")
class PutWorkspacesProjectsPermissionsConfigGroupsRequest(StrictModel):
    ...
    path: PutWorkspacesProjectsPermissionsConfigGroupsRequestPath

# Operation: delete_project_group_permission
class DeleteWorkspacesProjectsPermissionsConfigGroupsRequestPath(StrictModel):
    group_slug: str = Field(default=..., description="The slug identifier of the group whose project permission should be deleted.")
    project_key: str = Field(default=..., description="The unique key assigned to the project whose group permission is being removed.")
    workspace: str = Field(default=..., description="The workspace identifier, either as a slug or as a UUID surrounded by curly-braces.")
class DeleteWorkspacesProjectsPermissionsConfigGroupsRequest(StrictModel):
    ...
    path: DeleteWorkspacesProjectsPermissionsConfigGroupsRequestPath
...
# Operation: get_project_user_permission
class GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigUsersBySelectedUserIdRequestPath(StrictModel):
    project_key: str = Field(default=..., description="The unique key assigned to the project, used to identify the project within the workspace.")
    selected_user_id: str = Field(default=..., description="The identifier for the user whose permission is being retrieved; accepts a username, a UUID surrounded by curly-braces, or an Atlassian ID.")
    workspace: str = Field(default=..., description="The identifier for the workspace containing the project; accepts either the workspace slug or a UUID surrounded by curly-braces.")
class GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigUsersBySelectedUserIdRequest(StrictModel):
    ...
    path: GetWorkspacesByWorkspaceProjectsByProjectKeyPermissionsConfigUsersBySelectedUserIdRequestPath

# Operation: update_project_user_permission
class PutWorkspacesProjectsPermissionsConfigUsersRequestPath(StrictModel):
    project_key: str = Field(default=..., description="The unique key assigned to the project whose user permission is being updated.")
    selected_user_id: str = Field(default=..., description="The identifier of the user whose project permission is being updated; accepts a username, a UUID surrounded by curly-braces, or an Atlassian ID.")
    workspace: str = Field(default=..., description="The workspace containing the project; accepts either the workspace slug or a UUID surrounded by curly-braces.")
class PutWorkspacesProjectsPermissionsConfigUsersRequest(StrictModel):
    ...
    path: PutWorkspacesProjectsPermissionsConfigUsersRequestPath

# Operation: delete_project_user_permission
class DeleteWorkspacesProjectsPermissionsConfigUsersRequestPath(StrictModel):
    project_key: str = Field(default=..., description="The unique key assigned to the project whose user permission is being deleted.")
    selected_user_id: str = Field(default=..., description="The identifier of the user whose project permission will be removed; accepts a username, a UUID surrounded by curly-braces, or an Atlassian account ID.")
    workspace: str = Field(default=..., description="The workspace containing the project, specified as either the workspace slug or a UUID surrounded by curly-braces.")
class DeleteWorkspacesProjectsPermissionsConfigUsersRequest(StrictModel):
    ...
    path: DeleteWorkspacesProjectsPermissionsConfigUsersRequestPath
...
class Commitstatus(PermissiveModel):
    ...
    refname: str | None = Field(None, description="\nThe name of the ref that pointed to this commit at the time the status\nobject was created. Note that this the ref may since have moved off of\nthe commit. This optional field can be useful for b...")
    url: str | None = Field(None, description="A URL linking back to the vendor or build system, for providing more information about whatever process produced this status. Accepts context variables `repository` and `commit` that Bitbucket will...")
...
class Participant(PermissiveModel):
    ...
    participated_on: str | None = Field(None, description="The ISO8601 timestamp of the participant's action. For approvers, this is the time of their approval. For commenters and pull request reviewers who are not approvers, this is the time they last com...", json_schema_extra={'format': 'date-time'})
...
class PutRepositoriesCommitReportsAnnotationsBody(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    external_id: str | None = Field(None, description="ID of the annotation provided by the annotation creator. It can be used to identify the annotation as an alternative to it's generated uuid. It is not used by Bitbucket, but only by the annotation ...")
    ...
    path: str | None = Field(None, description="The path of the file on which this annotation should be placed. This is the path of the file relative to the git repository. If no path is provided, then it will appear in the overview modal on all...")
...
class PutRepositoriesPipelinesConfigBodyRepositoryLinksAvatar(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksCloneItem(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksCommits(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksDownloads(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksForks(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksHooks(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksHtml(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksPullrequests(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksSelf(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinksWatchers(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryLinks(StrictModel):
    self: PutRepositoriesPipelinesConfigBodyRepositoryLinksSelf | None = Field(None, description="A link to a resource related to this object.")
    html: PutRepositoriesPipelinesConfigBodyRepositoryLinksHtml | None = Field(None, description="A link to a resource related to this object.")
    avatar: PutRepositoriesPipelinesConfigBodyRepositoryLinksAvatar | None = Field(None, description="A link to a resource related to this object.")
    pullrequests: PutRepositoriesPipelinesConfigBodyRepositoryLinksPullrequests | None = Field(None, description="A link to a resource related to this object.")
    commits: PutRepositoriesPipelinesConfigBodyRepositoryLinksCommits | None = Field(None, description="A link to a resource related to this object.")
    forks: PutRepositoriesPipelinesConfigBodyRepositoryLinksForks | None = Field(None, description="A link to a resource related to this object.")
    watchers: PutRepositoriesPipelinesConfigBodyRepositoryLinksWatchers | None = Field(None, description="A link to a resource related to this object.")
    downloads: PutRepositoriesPipelinesConfigBodyRepositoryLinksDownloads | None = Field(None, description="A link to a resource related to this object.")
    clone: list[PutRepositoriesPipelinesConfigBodyRepositoryLinksCloneItem] | None = None
    hooks: PutRepositoriesPipelinesConfigBodyRepositoryLinksHooks | None = Field(None, description="A link to a resource related to this object.")

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksCommits(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksHtml(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksSelf(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinks(StrictModel):
    self: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksSelf | None = Field(None, description="A link to a resource related to this object.")
    commits: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksCommits | None = Field(None, description="A link to a resource related to this object.")
    html: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksHtml | None = Field(None, description="A link to a resource related to this object.")

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUserLinksAvatar(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUserLinks(PermissiveModel):
    """Links related to an Account."""
    avatar: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUserLinksAvatar | None = Field(None, description="A link to a resource related to this object.")

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUser(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    links: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUserLinks | None = Field(None, description="Links related to an Account.")
    created_on: str | None = Field(None, json_schema_extra={'format': 'date-time'})
    display_name: str | None = None
    uuid_: str | None = Field(None, validation_alias="uuid", serialization_alias="uuid")

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthor(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    raw: str | None = Field(None, description="The raw author value from the repository. This may be the only value available if the author does not match a user in Bitbucket.")
    user: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUser | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUserLinksAvatar(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUserLinks(PermissiveModel):
    """Links related to an Account."""
    avatar: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUserLinksAvatar | None = Field(None, description="A link to a resource related to this object.")

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUser(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    links: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUserLinks | None = Field(None, description="Links related to an Account.")
    created_on: str | None = Field(None, json_schema_extra={'format': 'date-time'})
    display_name: str | None = None
    uuid_: str | None = Field(None, validation_alias="uuid", serialization_alias="uuid")

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitter(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    raw: str | None = Field(None, description="The raw committer value from the repository. This may be the only value available if the committer does not match a user in Bitbucket.")
    user: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUser | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetSummary(StrictModel):
    raw: str | None = Field(None, description="The text as it was typed by a user.")
    markup: Literal["markdown", "creole", "plaintext"] | None = Field(None, description="The type of markup language the raw content is to be interpreted in.")
    html: str | None = Field(None, description="The user's content rendered as HTML.")

class PutRepositoriesPipelinesConfigBodyRepositoryOwnerLinksAvatar(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryOwnerLinks(PermissiveModel):
    """Links related to an Account."""
    avatar: PutRepositoriesPipelinesConfigBodyRepositoryOwnerLinksAvatar | None = Field(None, description="A link to a resource related to this object.")

class PutRepositoriesPipelinesConfigBodyRepositoryOwner(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    links: PutRepositoriesPipelinesConfigBodyRepositoryOwnerLinks | None = Field(None, description="Links related to an Account.")
    created_on: str | None = Field(None, json_schema_extra={'format': 'date-time'})
    display_name: str | None = None
    uuid_: str | None = Field(None, validation_alias="uuid", serialization_alias="uuid")

class PutRepositoriesPipelinesConfigBodyRepositoryProjectLinksAvatar(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectLinksHtml(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectLinks(StrictModel):
    html: PutRepositoriesPipelinesConfigBodyRepositoryProjectLinksHtml | None = Field(None, description="A link to a resource related to this object.")
    avatar: PutRepositoriesPipelinesConfigBodyRepositoryProjectLinksAvatar | None = Field(None, description="A link to a resource related to this object.")

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksAvatar(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksHtml(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksMembers(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksProjects(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksRepositories(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksSelf(StrictModel):
    """A link to a resource related to this object."""
    href: str | None = Field(None, json_schema_extra={'format': 'uri'})
    name: str | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinks(PermissiveModel):
    avatar: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksAvatar | None = Field(None, description="A link to a resource related to this object.")
    self: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksSelf | None = Field(None, description="A link to a resource related to this object.")
    html: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksHtml | None = Field(None, description="A link to a resource related to this object.")
    members: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksMembers | None = Field(None, description="A link to a resource related to this object.")
    projects: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksProjects | None = Field(None, description="A link to a resource related to this object.")
    repositories: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksRepositories | None = Field(None, description="A link to a resource related to this object.")

class PutRepositoriesPipelinesConfigBodyRepositoryProjectOwner(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    links: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinks | None = None
    created_on: str | None = Field(None, json_schema_extra={'format': 'date-time'})
    display_name: str | None = None
    uuid_: str | None = Field(None, validation_alias="uuid", serialization_alias="uuid")

class PutRepositoriesPipelinesConfigBodyRepositoryProject(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    links: PutRepositoriesPipelinesConfigBodyRepositoryProjectLinks | None = None
    uuid_: str | None = Field(None, validation_alias="uuid", serialization_alias="uuid", description="The project's immutable id.")
    key: str | None = Field(None, description="The project's key.")
    owner: PutRepositoriesPipelinesConfigBodyRepositoryProjectOwner | None = None
    name: str | None = Field(None, description="The name of the project.")
    description: str | None = None
    is_private: bool | None = Field(None, description="\nIndicates whether the project is publicly accessible, or whether it is\nprivate to the team and consequently only visible to team members.\nNote that private projects cannot contain public reposi...")
    created_on: str | None = Field(None, json_schema_extra={'format': 'date-time'})
...
class PutRepositoriesCommitReportsBody(PermissiveModel):
    ...
    external_id: str | None = Field(None, description="ID of the report provided by the report creator. It can be used to identify the report as an alternative to it's generated uuid. It is not used by Bitbucket, but only by the report creator for upda...")
...
class User(PermissiveModel):
    ...
    nickname: str | None = Field(None, description="Account name defined by the owner. Should be used instead of the \"username\" field. Note that \"nickname\" cannot be used in place of \"username\" in URLs and queries, as \"nickname\" is not guara...")
...
class PostRepositoriesPipelinesBodyRepository(PermissiveModel):
    ...
    uuid_: str | None = Field(None, validation_alias="uuid", serialization_alias="uuid", description="The repository's immutable id. This can be used as a substitute for the slug segment in URLs. Doing this guarantees your URLs will survive renaming of the repository by its owner, or even transfer ...")
...
class PutRepositoriesPipelinesConfigBody(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    enabled: bool | None = Field(None, description="Whether Pipelines is enabled for the repository.")
    repository: PutRepositoriesPipelinesConfigBodyRepository | None = None

class PutRepositoriesPipelinesConfigBodyRepository(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    links: PutRepositoriesPipelinesConfigBodyRepositoryLinks | None = None
    uuid_: str | None = Field(None, validation_alias="uuid", serialization_alias="uuid", description="The repository's immutable id. This can be used as a substitute for the slug segment in URLs. Doing this guarantees your URLs will survive renaming of the repository by its owner, or even transfer ...")
    full_name: str | None = Field(None, description="The concatenation of the repository owner's username and the slugified name, e.g. \"evzijst/interruptingcow\". This is the same string used in Bitbucket URLs.")
    is_private: bool | None = None
    parent: Repository | None = None
    scm: Literal["git"] | None = None
    owner: PutRepositoriesPipelinesConfigBodyRepositoryOwner | None = None
    name: str | None = None
    description: str | None = None
    created_on: str | None = Field(None, json_schema_extra={'format': 'date-time'})
    updated_on: str | None = Field(None, json_schema_extra={'format': 'date-time'})
    ...
    has_wiki: bool | None = Field(None, description="\nThe wiki for this repository is enabled. Wiki\nfeatures are not supported for repositories in workspaces\nadministered through admin.atlassian.com.\n")
    fork_policy: Literal["allow_forks", "no_public_forks", "no_forks"] | None = Field(None, description="\nControls the rules for forking this repository.\n\n* **allow_forks**: unrestricted forking\n* **no_public_forks**: restrict forking to private forks (forks cannot\n  be made public later)\n* **no...")
    project: PutRepositoriesPipelinesConfigBodyRepositoryProject | None = None
    mainbranch: PutRepositoriesPipelinesConfigBodyRepositoryMainbranch | None = None

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranch(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    links: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinks | None = None
    name: str | None = Field(None, description="The name of the ref.")
    target: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTarget | None = None
    merge_strategies: list[Literal["merge_commit", "squash", "fast_forward", "squash_fast_forward", "rebase_fast_forward", "rebase_merge"]] | None = Field(None, description="Available merge strategies for pull requests targeting this branch.")
    default_merge_strategy: str | None = Field(None, description="The default merge strategy for pull requests targeting this branch.")

class PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTarget(PermissiveModel):
    type_: str = Field(..., validation_alias="type", serialization_alias="type")
    hash_: str | None = Field(None, validation_alias="hash", serialization_alias="hash", pattern="[0-9a-f]{7,}?")
    date: str | None = Field(None, json_schema_extra={'format': 'date-time'})
    author: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthor | None = None
    committer: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitter | None = None
    message: str | None = None
    summary: PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetSummary | None = None
    parents: list[BaseCommit] | None = Field(None, min_length=0)
    repository: Repository | None = None
    participants: list[Participant] | None = Field(None, min_length=0)
...
PutRepositoriesPipelinesConfigBody.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepository.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksAvatar.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksCloneItem.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksCommits.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksDownloads.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksForks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksHooks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksHtml.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksPullrequests.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksSelf.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryLinksWatchers.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranch.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksCommits.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksHtml.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchLinksSelf.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTarget.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthor.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUser.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUserLinks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetAuthorUserLinksAvatar.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitter.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUser.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUserLinks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetCommitterUserLinksAvatar.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryMainbranchTargetSummary.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryOwner.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryOwnerLinks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryOwnerLinksAvatar.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProject.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectLinks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectLinksAvatar.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectLinksHtml.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwner.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinks.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksAvatar.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksHtml.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksMembers.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksProjects.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksRepositories.model_rebuild()
PutRepositoriesPipelinesConfigBodyRepositoryProjectOwnerLinksSelf.model_rebuild()
