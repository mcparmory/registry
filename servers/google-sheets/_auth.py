...
class OAuth2Auth:
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://oauth2.googleapis.com/token")
        self.auth_url = self._resolve_url_template("https://accounts.google.com/o/oauth2/v2/auth")
...
class APIKeyAuth:
    """
    API Key authentication for Google Sheets API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "apply_spreadsheet_updates": [["OAuth2"], ["ApiKeyAuth"]],
    "create_spreadsheet": [["OAuth2"], ["ApiKeyAuth"]],
    "get_spreadsheet": [["OAuth2"], ["ApiKeyAuth"]],
    "retrieve_spreadsheet_by_data_filter": [["OAuth2"], ["ApiKeyAuth"]],
    "get_developer_metadata": [["OAuth2"], ["ApiKeyAuth"]],
    "search_developer_metadata": [["OAuth2"], ["ApiKeyAuth"]],
    "copy_sheet": [["OAuth2"], ["ApiKeyAuth"]],
    "append_sheet_values": [["OAuth2"], ["ApiKeyAuth"]],
    "clear_spreadsheet_values": [["OAuth2"], ["ApiKeyAuth"]],
    "clear_spreadsheet_values_by_filter": [["OAuth2"], ["ApiKeyAuth"]],
    "get_spreadsheet_values_batch": [["OAuth2"], ["ApiKeyAuth"]],
    "get_spreadsheet_values_by_filter": [["OAuth2"], ["ApiKeyAuth"]],
    "update_sheet_values_batch": [["OAuth2"], ["ApiKeyAuth"]],
    "update_spreadsheet_values_by_filter": [["OAuth2"], ["ApiKeyAuth"]],
    "clear_spreadsheet_values_range": [["OAuth2"], ["ApiKeyAuth"]],
    "read_spreadsheet_range": [["OAuth2"], ["ApiKeyAuth"]],
    "update_sheet_values": [["OAuth2"], ["ApiKeyAuth"]]
}
