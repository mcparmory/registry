"""
Authentication module for Google Sheets API MCP server.

Generated: 2026-04-07 12:04:54 UTC
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "apply_spreadsheet_updates": [["OAuth2"]],
    "create_spreadsheet": [["OAuth2"]],
    "get_spreadsheet": [["OAuth2"]],
    "retrieve_spreadsheet_by_data_filter": [["OAuth2"]],
    "get_developer_metadata": [["OAuth2"]],
    "search_developer_metadata": [["OAuth2"]],
    "copy_sheet": [["OAuth2"]],
    "append_sheet_values": [["OAuth2"]],
    "clear_spreadsheet_values": [["OAuth2"]],
    "clear_spreadsheet_values_by_filter": [["OAuth2"]],
    "get_spreadsheet_values_batch": [["OAuth2"]],
    "get_spreadsheet_values_by_filter": [["OAuth2"]],
    "update_sheet_values_batch": [["OAuth2"]],
    "update_spreadsheet_values_by_filter": [["OAuth2"]],
    "clear_spreadsheet_values_range": [["OAuth2"]],
    "read_spreadsheet_range": [["OAuth2"]],
    "update_sheet_values": [["OAuth2"]]
}
