"""
Authentication module for Ramp Developer API MCP server.
...
class OAuth2Auth:
    """
    OAuth 2.0 authentication for Ramp Developer API.
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://api.ramp.com/developer/v1/token")
        self.auth_url = self._resolve_url_template("https://app.ramp.com/v1/authorize")
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "list_gl_accounts": [["oauth2"]],
    "create_gl_accounts": [["oauth2"]],
    "get_gl_account": [["oauth2"]],
    "update_gl_account": [["oauth2"]],
    "delete_gl_account": [["oauth2"]],
    "list_accounting_connections": [["oauth2"]],
    "create_accounting_connection": [["oauth2"]],
    "disconnect_accounting_connection": [["oauth2"]],
    "get_accounting_connection": [["oauth2"]],
    "update_accounting_connection": [["oauth2"]],
    "reactivate_accounting_connection": [["oauth2"]],
    "list_custom_field_options": [["oauth2"]],
    "create_custom_field_options": [["oauth2"]],
    "get_custom_field_option": [["oauth2"]],
    "update_custom_field_option": [["oauth2"]],
    "update_custom_field_option_partial": [["oauth2"]],
    "delete_custom_field_option": [["oauth2"]],
    "list_custom_accounting_fields": [["oauth2"]],
    "create_accounting_custom_field": [["oauth2"]],
    "get_custom_field": [["oauth2"]],
    "update_custom_accounting_field": [["oauth2"]],
    "delete_custom_field": [["oauth2"]],
    "list_inventory_item_accounting_fields": [["oauth2"]],
    "create_inventory_item_accounting_field": [["oauth2"]],
    "update_inventory_item_field": [["oauth2"]],
    "delete_inventory_item_accounting_field": [["oauth2"]],
    "list_inventory_item_options": [["oauth2"]],
    "add_inventory_item_options": [["oauth2"]],
    "update_inventory_item_option": [["oauth2"]],
    "delete_inventory_item_option": [["oauth2"]],
    "mark_transactions_ready_to_sync": [["oauth2"]],
    "report_sync_results": [["oauth2"]],
    "get_tax_code_field": [["oauth2"]],
    "create_tax_code_field": [["oauth2"]],
    "update_tax_code_field": [["oauth2"]],
    "delete_tax_code": [["oauth2"]],
    "list_tax_code_options": [["oauth2"]],
    "add_tax_code_options": [["oauth2"]],
    "update_tax_code_option": [["oauth2"]],
    "delete_tax_code_option": [["oauth2"]],
    "list_tax_rates": [["oauth2"]],
    "upload_tax_rates": [["oauth2"]],
    "update_tax_rate": [["oauth2"]],
    "delete_tax_rate": [["oauth2"]],
    "list_vendors_accounting": [["oauth2"]],
    "create_vendors": [["oauth2"]],
    "get_vendor_accounting": [["oauth2"]],
    "update_vendor_accounting": [["oauth2"]],
    "delete_vendor_accounting": [["oauth2"]],
    "get_application_resource": [["oauth2"]],
    "create_financing_application": [["oauth2"]],
    "list_audit_log_events": [["oauth2"]],
    "list_bank_accounts": [["oauth2"]],
    "get_bank_account": [["oauth2"]],
    "list_bills_with_pagination": [["oauth2"]],
    "create_bill": [["oauth2"]],
    "list_draft_bills": [["oauth2"]],
    "create_draft_bill": [["oauth2"]],
    "get_draft_bill": [["oauth2"]],
    "update_draft_bill": [["oauth2"]],
    "add_draft_bill_attachment": [["oauth2"]],
    "get_bill": [["oauth2"]],
    "update_bill": [["oauth2"]],
    "archive_bill": [["oauth2"]],
    "add_bill_attachment": [["oauth2"]],
    "get_business": [["oauth2"]],
    "get_business_balance": [["oauth2"]],
    "list_cards": [["oauth2"]],
    "create_physical_card": [["oauth2"]],
    "get_card_deferred_task_status": [["oauth2"]],
    "create_virtual_card": [["oauth2"]],
    "get_card": [["oauth2"]],
    "update_card": [["oauth2"]],
    "suspend_card": [["oauth2"]],
    "delete_card": [["oauth2"]],
    "unsuspend_card": [["oauth2"]],
    "list_cashbacks": [["oauth2"]],
    "get_cashback": [["oauth2"]],
    "list_custom_tables": [["oauth2"]],
    "list_custom_table_columns": [["oauth2"]],
    "list_custom_table_rows": [["oauth2"]],
    "update_custom_table_rows": [["oauth2"]],
    "delete_custom_table_rows": [["oauth2"]],
    "update_custom_table_row_external_key": [["oauth2"]],
    "append_custom_table_rows": [["oauth2"]],
    "remove_custom_table_row_cells": [["oauth2"]],
    "list_matrix_tables": [["oauth2"]],
    "create_matrix_table": [["oauth2"]],
    "add_result_column_to_matrix_table": [["oauth2"]],
    "rename_matrix_column": [["oauth2"]],
    "list_matrix_table_rows": [["oauth2"]],
    "rename_matrix_table": [["oauth2"]],
    "upsert_matrix_table_rows": [["oauth2"]],
    "append_matrix_table_cells": [["oauth2"]],
    "remove_matrix_table_cells": [["oauth2"]],
    "delete_matrix_row": [["oauth2"]],
    "list_native_tables": [["oauth2"]],
    "list_native_table_columns": [["oauth2"]],
    "list_native_table_rows": [["oauth2"]],
    "update_native_table_rows": [["oauth2"]],
    "append_native_table_rows": [["oauth2"]],
    "remove_native_table_row_cells": [["oauth2"]],
    "list_departments": [["oauth2"]],
    "create_department": [["oauth2"]],
    "get_department": [["oauth2"]],
    "update_department": [["oauth2"]],
    "create_card_embed_token": [["oauth2"]],
    "list_entities_with_pagination": [["oauth2"]],
    "get_entity": [["oauth2"]],
    "list_item_receipts": [["oauth2"]],
    "create_item_receipt": [["oauth2"]],
    "get_item_receipt": [["oauth2"]],
    "delete_item_receipt": [["oauth2"]],
    "list_spend_limits": [["oauth2"]],
    "create_spend_limit": [["oauth2"]],
    "get_spend_limit_deferred_task_status": [["oauth2"]],
    "get_spend_limit": [["oauth2"]],
    "update_spend_limit": [["oauth2"]],
    "update_spend_limit_partial": [["oauth2"]],
    "add_users_to_spend_limit": [["oauth2"]],
    "terminate_spend_limit": [["oauth2"]],
    "remove_users_from_spend_limit": [["oauth2"]],
    "suspend_spend_limit": [["oauth2"]],
    "unsuspend_spend_limit": [["oauth2"]],
    "list_locations": [["oauth2"]],
    "create_location": [["oauth2"]],
    "get_location": [["oauth2"]],
    "update_location": [["oauth2"]],
    "list_memos": [["oauth2"]],
    "get_memo": [["oauth2"]],
    "create_memo_for_transaction": [["oauth2"]],
    "list_merchants": [["oauth2"]],
    "list_purchase_orders": [["oauth2"]],
    "create_purchase_order": [["oauth2"]],
    "get_purchase_order": [["oauth2"]],
    "update_purchase_order": [["oauth2"]],
    "archive_purchase_order": [["oauth2"]],
    "add_line_items_to_purchase_order": [["oauth2"]],
    "update_purchase_order_line_item": [["oauth2"]],
    "delete_purchase_order_line_item": [["oauth2"]],
    "list_receipt_integration_opted_out_emails": [["oauth2"]],
    "remove_opted_out_email_from_receipt_integration": [["oauth2"]],
    "list_receipts": [["oauth2"]],
    "upload_receipt": [["oauth2"]],
    "get_receipt": [["oauth2"]],
    "list_reimbursements": [["oauth2"]],
    "create_mileage_reimbursement": [["oauth2"]],
    "upload_receipt_for_reimbursement": [["oauth2"]],
    "get_reimbursement": [["oauth2"]],
    "list_spend_programs": [["oauth2"]],
    "create_spend_program": [["oauth2"]],
    "get_spend_program": [["oauth2"]],
    "list_statements": [["oauth2"]],
    "get_statement": [["oauth2"]],
    "list_transactions": [["oauth2"]],
    "get_transaction": [["oauth2"]],
    "list_transfers_with_pagination": [["oauth2"]],
    "get_transfer": [["oauth2"]],
    "list_trips": [["oauth2"]],
    "get_trip": [["oauth2"]],
    "list_users": [["oauth2"]],
    "send_user_invite": [["oauth2"]],
    "get_deferred_task_status": [["oauth2"]],
    "get_user": [["oauth2"]],
    "update_user": [["oauth2"]],
    "deactivate_user": [["oauth2"]],
    "reactivate_user": [["oauth2"]],
    "create_card_vault": [["oauth2"]],
    "get_card_vault_details": [["oauth2"]],
    "list_vendors": [["oauth2"]],
    "create_vendor": [["oauth2"]],
    "list_vendor_agreements": [["oauth2"]],
    "list_vendor_credits": [["oauth2"]],
    "get_vendor_credit": [["oauth2"]],
    "get_vendor": [["oauth2"]],
    "update_vendor": [["oauth2"]],
    "delete_vendor": [["oauth2"]],
    "list_vendor_bank_accounts": [["oauth2"]],
    "get_vendor_bank_account": [["oauth2"]],
    "archive_vendor_bank_account": [["oauth2"]],
    "list_vendor_contacts": [["oauth2"]],
    "get_vendor_contact": [["oauth2"]],
    "list_vendor_credits_by_vendor": [["oauth2"]],
    "add_vendor_bank_account": [["oauth2"]],
    "get_webhook_subscription": [["oauth2"]],
    "delete_webhook": [["oauth2"]]
}
