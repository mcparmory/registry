"""
Codacy Api MCP Server - Pydantic Models
...
__all__ = [
    ...
    "CreateOrUpdateJiraIntegrationRequest",
    "CreateOrUpdateSlackIntegrationRequest",
    ...
    "ListAdminEntityResourcesRequest",
    ...
    "ListConfiguredLoginIntegrationsRequest",
    "ListCoverageReportsRequest",
    "ListDastReportsRequest",
    "ListDuplicationToolsRequest",
    ...
    "ListLanguagesWithToolsRequest",
    "ListMetricsToolsRequest",
    ...
    "ListToolsRequest",
    "ListUserEmailsRequest",
    "ListUserEnterpriseProviderTokensRequest",
    ...
    "ResetPullRequestsQualitySettingsRequest",
    ...
    "UpdatePullRequestQualitySettingsRequest",
...
# Operation: get_repository_quality_settings
class GetQualitySettingsForRepositoryRequestPath(StrictModel):
    provider: str = Field(default=..., description="The Git provider hosting the repository, identified by a short code (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    ...
    repository_name: str = Field(default=..., validation_alias="repositoryName", serialization_alias="repositoryName", description="The name of the repository within the specified Git provider organization for which quality settings are being retrieved.")
class GetQualitySettingsForRepositoryRequest(StrictModel):
    ...
    path: GetQualitySettingsForRepositoryRequestPath
...
# Operation: set_build_server_analysis
class UpdateBuildServerAnalysisSettingRequestPath(StrictModel):
    provider: str = Field(default=..., description="Short identifier for the Git provider hosting the repository (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The organization or account name as it appears on the Git provider.")
...
class UpdateBuildServerAnalysisSettingRequestBody(StrictModel):
    """New value for the repository setting **Run analysis on your build server**"""
    build_server_analysis_setting: bool = Field(default=..., validation_alias="buildServerAnalysisSetting", serialization_alias="buildServerAnalysisSetting", description="Set to true to have Codacy wait for your build server to upload local analysis results before processing commits; set to false to have Codacy analyze commits directly on its cloud infrastructure.")
class UpdateBuildServerAnalysisSettingRequest(StrictModel):
    ...
    path: UpdateBuildServerAnalysisSettingRequestPath
    body: UpdateBuildServerAnalysisSettingRequestBody
...
# Operation: update_repository_commit_quality_settings
class UpdateCommitQualitySettingsRequestPath(StrictModel):
    provider: str = Field(default=..., description="The Git provider hosting the repository, identified by a short code (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The name of the organization or account on the Git provider that owns the repository.")
    repository_name: str = Field(default=..., validation_alias="repositoryName", serialization_alias="repositoryName", description="The name of the repository within the Git provider organization.")
class UpdateCommitQualitySettingsRequestBodyIssueThreshold(StrictModel):
    ...
    minimum_severity: Literal["Info", "Warning", "High", "Error"] | None = Field(default=None, validation_alias="minimumSeverity", serialization_alias="minimumSeverity", description="The minimum severity level of issues that count toward the quality gate threshold. Severity levels map to the UI as follows: Info → Minor, Warning → Medium, High → High, Error → Critical.")
class UpdateCommitQualitySettingsRequestBody(StrictModel):
    """The new value for the quality settings of commits in a repository"""
    security_issue_threshold: int | None = Field(default=None, validation_alias="securityIssueThreshold", serialization_alias="securityIssueThreshold", description="The maximum number of new security issues permitted before the quality gate fails. Must be zero or greater.", ge=0, json_schema_extra={'format': 'int32'})
    ...
    coverage_threshold_with_decimals: float | None = Field(default=None, validation_alias="coverageThresholdWithDecimals", serialization_alias="coverageThresholdWithDecimals", description="The minimum required change in coverage percentage; the quality gate fails if coverage varies by less than this value. Accepts negative values to allow coverage decreases, with a maximum of 1.00 (representing 1%).", json_schema_extra={'format': 'double'})
    diff_coverage_threshold: int | None = Field(default=None, validation_alias="diffCoverageThreshold", serialization_alias="diffCoverageThreshold", description="The minimum acceptable diff coverage percentage for the commit; the quality gate fails if diff coverage falls below this value. Must be between 0 and 100 inclusive.", ge=0, le=100, json_schema_extra={'format': 'int32'})
    complexity_threshold: int | None = Field(default=None, validation_alias="complexityThreshold", serialization_alias="complexityThreshold", description="The maximum complexity value allowed before the quality gate fails. Must be zero or greater.", ge=0, json_schema_extra={'format': 'int32'})
    issue_threshold: UpdateCommitQualitySettingsRequestBodyIssueThreshold = Field(default=..., validation_alias="issueThreshold", serialization_alias="issueThreshold")
class UpdateCommitQualitySettingsRequest(StrictModel):
    ...
    path: UpdateCommitQualitySettingsRequestPath
    body: UpdateCommitQualitySettingsRequestBody
...
# Operation: reset_pull_request_quality_settings
class ResetPullRequestsQualitySettingsRequestPath(StrictModel):
    provider: str = Field(default=..., description="The Git provider hosting the repository, identified by a short code (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The name of the organization or account on the Git provider that owns the repository.")
    repository_name: str = Field(default=..., validation_alias="repositoryName", serialization_alias="repositoryName", description="The name of the repository within the specified Git provider organization.")
class ResetPullRequestsQualitySettingsRequest(StrictModel):
    ...
    path: ResetPullRequestsQualitySettingsRequestPath
...
# Operation: get_pull_request_quality_settings
class GetPullRequestQualitySettingsRequestPath(StrictModel):
    provider: str = Field(default=..., description="The Git provider hosting the repository, identified by a short code (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The name of the organization or account on the Git provider that owns the repository.")
    repository_name: str = Field(default=..., validation_alias="repositoryName", serialization_alias="repositoryName", description="The name of the repository within the specified Git provider organization.")
class GetPullRequestQualitySettingsRequest(StrictModel):
    ...
    path: GetPullRequestQualitySettingsRequestPath

# Operation: update_pull_request_quality_settings
class UpdatePullRequestQualitySettingsRequestPath(StrictModel):
    provider: str = Field(default=..., description="The Git provider hosting the repository, identified by a short code (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The name of the organization or account on the Git provider that owns the repository.")
    repository_name: str = Field(default=..., validation_alias="repositoryName", serialization_alias="repositoryName", description="The name of the repository within the Git provider organization whose pull request quality settings will be updated.")
class UpdatePullRequestQualitySettingsRequestBodyIssueThreshold(StrictModel):
    threshold: int = Field(default=..., validation_alias="threshold", serialization_alias="threshold", description="The maximum number of new issues allowed before the quality gate fails. Must be zero or greater.", ge=0, json_schema_extra={'format': 'int32'})
    minimum_severity: Literal["Info", "Warning", "High", "Error"] | None = Field(default=None, validation_alias="minimumSeverity", serialization_alias="minimumSeverity", description="The minimum severity level of issues that count toward the quality gate threshold. Severity levels map to the UI as: Info → Minor, Warning → Medium, High → High, Error → Critical.")
class UpdatePullRequestQualitySettingsRequestBody(StrictModel):
    """The new value for the quality settings of pull requests in the repository"""
    security_issue_threshold: int | None = Field(default=None, validation_alias="securityIssueThreshold", serialization_alias="securityIssueThreshold", description="The maximum number of new security issues permitted before the quality gate fails. Must be zero or greater.", ge=0, json_schema_extra={'format': 'int32'})
    security_issue_minimum_severity: Literal["Info", "Warning", "High", "Error"] | None = Field(default=None, validation_alias="securityIssueMinimumSeverity", serialization_alias="securityIssueMinimumSeverity", description="The minimum severity level of security issues that count toward the security issue threshold. Severity levels map to the UI as: Info → Minor, Warning → Medium, High → High, Error → Critical.")
    duplication_threshold: int | None = Field(default=None, validation_alias="duplicationThreshold", serialization_alias="duplicationThreshold", description="The maximum number of new duplicated blocks allowed before the quality gate fails.", json_schema_extra={'format': 'int32'})
    coverage_threshold_with_decimals: float | None = Field(default=None, validation_alias="coverageThresholdWithDecimals", serialization_alias="coverageThresholdWithDecimals", description="The minimum required change in coverage percentage; the quality gate fails if coverage varies by less than this value. Accepts negative values to allow coverage decreases up to a limit, with a maximum value of 1.00.", json_schema_extra={'format': 'double'})
    diff_coverage_threshold: int | None = Field(default=None, validation_alias="diffCoverageThreshold", serialization_alias="diffCoverageThreshold", description="The minimum required diff coverage percentage for the pull request; the quality gate fails if diff coverage falls below this value. Must be between 0 and 100 inclusive.", ge=0, le=100, json_schema_extra={'format': 'int32'})
    complexity_threshold: int | None = Field(default=None, validation_alias="complexityThreshold", serialization_alias="complexityThreshold", description="The maximum allowed complexity value introduced by the pull request; the quality gate fails if complexity exceeds this threshold. Must be zero or greater.", ge=0, json_schema_extra={'format': 'int32'})
    issue_threshold: UpdatePullRequestQualitySettingsRequestBodyIssueThreshold = Field(default=..., validation_alias="issueThreshold", serialization_alias="issueThreshold")
class UpdatePullRequestQualitySettingsRequest(StrictModel):
    ...
    path: UpdatePullRequestQualitySettingsRequestPath
    body: UpdatePullRequestQualitySettingsRequestBody
...
class ListUserEmailsRequest(StrictModel):
...
# Operation: remove_user_email
class RemoveUserEmailRequest(StrictModel):
...
# Operation: get_email_notification_settings
class GetEmailSettingsRequest(StrictModel):
...
# Operation: update_email_notification_settings
class UpdateEmailSettingsRequest(StrictModel):
...
# Operation: set_default_email
class SetDefaultEmailRequest(StrictModel):
...
# Operation: sync_organization_billing
class SyncMarketplaceBillingRequestPath(StrictModel):
    provider: str = Field(default=..., description="Identifier for the Git provider hosting the organization. Accepted values include short codes for major providers such as GitHub, GitLab, and Bitbucket.")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The organization's name as it appears on the specified Git provider. This must exactly match the organization's remote name on the platform.")
class SyncMarketplaceBillingRequest(StrictModel):
    ...
    path: SyncMarketplaceBillingRequestPath
...
# Operation: set_organization_minimum_analysis_permission
class PatchOrganizationSettingsRequestPath(StrictModel):
...
class PatchOrganizationSettingsRequestBody(StrictModel):
    """New permission level"""
    permission: Literal["RepoAdmin", "RepoWrite", "RepoRead"] | None = Field(default=None, description="The minimum repository permission level members must have to configure analysis settings. Accepted values are RepoAdmin (highest restriction), RepoWrite, or RepoRead (lowest restriction).")
class PatchOrganizationSettingsRequest(StrictModel):
    ...
    path: PatchOrganizationSettingsRequestPath
    body: PatchOrganizationSettingsRequestBody | None = None
...
# Operation: clean_organization_cache
class CleanCacheRequestPath(StrictModel):
    provider: str = Field(default=..., description="Short code identifying the Git provider hosting the organization. Each provider has a unique identifier (e.g., GitHub, GitLab, Bitbucket each have distinct codes).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The exact name of the organization as it appears on the Git provider platform.")
class CleanCacheRequest(StrictModel):
...
# Operation: clear_enterprise_cache
class CleanEnterpriseCacheRequestPath(StrictModel):
    provider: str = Field(default=..., description="Identifier for the Git provider hosting the enterprise, such as GitHub, GitLab, or Bitbucket. Use the short code corresponding to the desired provider.")
class CleanEnterpriseCacheRequest(StrictModel):
    ...
    path: CleanEnterpriseCacheRequestPath

# Operation: list_enterprise_provider_tokens
class ListUserEnterpriseProviderTokensRequest(StrictModel):
...
# Operation: list_login_integrations
class ListConfiguredLoginIntegrationsRequestQuery(StrictModel):
    limit: int | None = Field(default=None, description="Maximum number of login integrations to return in a single response. Accepts values between 1 and 100.", ge=1, le=100, json_schema_extra={'format': 'int32'})
class ListConfiguredLoginIntegrationsRequest(StrictModel):
    ...
    query: ListConfiguredLoginIntegrationsRequestQuery | None = None
...
# Operation: get_configuration_status
class GetConfigurationStatusRequest(StrictModel):
...
# Operation: get_admin_entity
class GetAdminEntityRequestPath(StrictModel):
    admin_entity_group_slug: str = Field(default=..., validation_alias="adminEntityGroupSlug", serialization_alias="adminEntityGroupSlug", description="The slug identifying the category or group of admin entities to query, such as a resource type grouping.")
    admin_entity_identifier: int = Field(default=..., validation_alias="adminEntityIdentifier", serialization_alias="adminEntityIdentifier", description="The unique numeric identifier of the specific admin entity to retrieve within the specified group.", json_schema_extra={'format': 'int64'})
class GetAdminEntityRequest(StrictModel):
    """Retrieves a specific admin entity by its identifier within a given entity group. Restricted to Codacy admins only."""
    path: GetAdminEntityRequestPath

# Operation: list_admin_entity_resources
class ListAdminEntityResourcesRequestPath(StrictModel):
    admin_entity_group_slug: str = Field(default=..., validation_alias="adminEntityGroupSlug", serialization_alias="adminEntityGroupSlug", description="The slug identifying the category or group of the admin entity, such as a resource type grouping.")
    admin_entity_identifier: int = Field(default=..., validation_alias="adminEntityIdentifier", serialization_alias="adminEntityIdentifier", description="The unique numeric identifier of the specific admin entity within the group.", json_schema_extra={'format': 'int64'})
    admin_resource_slug: str = Field(default=..., validation_alias="adminResourceSlug", serialization_alias="adminResourceSlug", description="The slug identifying the type of resources to retrieve for the given admin entity.")
class ListAdminEntityResourcesRequestQuery(StrictModel):
    limit: int | None = Field(default=None, description="Maximum number of resource items to return in a single response. Accepts values between 1 and 100.", ge=1, le=100, json_schema_extra={'format': 'int32'})
class ListAdminEntityResourcesRequest(StrictModel):
    ...
    path: ListAdminEntityResourcesRequestPath
    query: ListAdminEntityResourcesRequestQuery | None = None

# Operation: generate_license
class GenerateLicenseRequestBody(StrictModel):
    number_of_seats: int = Field(default=..., validation_alias="numberOfSeats", serialization_alias="numberOfSeats", description="The maximum number of user seats permitted under this license.", json_schema_extra={'format': 'int32'})
    email: str = Field(default=..., description="The email address of the license holder or organization contact.")
    expiration_date: str = Field(default=..., validation_alias="expirationDate", serialization_alias="expirationDate", description="The date and time at which the license expires, in ISO 8601 format.", json_schema_extra={'format': 'date-time'})
    inactivity_threshold: int | None = Field(default=None, validation_alias="inactivityThreshold", serialization_alias="inactivityThreshold", description="The number of months of user inactivity after which a seat is automatically released.", json_schema_extra={'format': 'int32'})
    auto_add_authors: bool | None = Field(default=None, validation_alias="autoAddAuthors", serialization_alias="autoAddAuthors", description="When enabled, new commit authors are automatically added as licensed users without manual provisioning.")
    allow_seats_overflow: bool | None = Field(default=None, validation_alias="allowSeatsOverflow", serialization_alias="allowSeatsOverflow", description="When enabled, the instance may exceed the licensed seat count rather than blocking additional users.")
class GenerateLicenseRequest(StrictModel):
    ...
    body: GenerateLicenseRequestBody
...
# Operation: upload_pentest_report
class UploadPenTestReportRequestBody(StrictModel):
    csvdata: str = Field(default=..., description="The penetration test report data in CSV format, provided as a binary file upload.", json_schema_extra={'format': 'binary'})
    provider: str = Field(default=..., description="The Git provider that hosts the organization's repositories, used to identify the correct organizational context.")
    organization_name: str = Field(default=..., validation_alias="organizationName", serialization_alias="organizationName", description="The exact name of the organization to which the penetration test results belong.")
class UploadPenTestReportRequest(StrictModel):
    ...
    body: UploadPenTestReportRequestBody

# Operation: list_tool_supported_languages
class ListLanguagesWithToolsRequest(StrictModel):
...
# Operation: list_duplication_tools
class ListDuplicationToolsRequest(StrictModel):
...
# Operation: list_metrics_tools
class ListMetricsToolsRequest(StrictModel):
...
# Operation: configure_jira_integration
class CreateOrUpdateJiraIntegrationRequestPath(StrictModel):
    provider: str = Field(default=..., description="Short code identifying the Git provider hosting the organization (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The organization's name as it appears on the Git provider platform.")
class CreateOrUpdateJiraIntegrationRequestQuery(StrictModel):
    oauth_code: str = Field(default=..., validation_alias="oauthCode", serialization_alias="oauthCode", description="The OAuth authorization code issued during the Jira App installation, used to authenticate and link the integration on behalf of the installing user.")
class CreateOrUpdateJiraIntegrationRequest(StrictModel):
    ...
    path: CreateOrUpdateJiraIntegrationRequestPath
    query: CreateOrUpdateJiraIntegrationRequestQuery
...
# Operation: configure_slack_integration
class CreateOrUpdateSlackIntegrationRequestPath(StrictModel):
    provider: str = Field(default=..., description="Short code identifying the Git provider hosting the organization. Use 'gh' for GitHub, 'gl' for GitLab, or 'bb' for Bitbucket.")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The organization's name as it appears on the Git provider (case-sensitive).")
class CreateOrUpdateSlackIntegrationRequestBody(StrictModel):
    webhook_url: str = Field(default=..., description="A valid Slack Incoming Webhook URL used to post notifications to a Slack channel. Must follow the standard Slack webhook URL format beginning with https://hooks.slack.com/services/.", pattern='https:\\/\\/hooks\\.slack\\.com\\/services\\/T[a-zA-Z0-9_]{8,10}\\/B[a-zA-Z0-9_]{8,10}\\/[a-zA-Z0-9_]{24}')
class CreateOrUpdateSlackIntegrationRequest(StrictModel):
    ...
    path: CreateOrUpdateSlackIntegrationRequestPath
    body: CreateOrUpdateSlackIntegrationRequestBody

# Operation: delete_slack_integration
class DeleteSlackIntegrationRequestPath(StrictModel):
    provider: str = Field(default=..., description="Short code identifying the Git provider for the organization (e.g., GitHub, GitLab, or Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The organization's name as it appears on the Git provider platform.")
class DeleteSlackIntegrationRequest(StrictModel):
    ...
    path: DeleteSlackIntegrationRequestPath
...
# Operation: send_session_heartbeat
class HeartbeatRequestBody(StrictModel):
    was_active: bool = Field(default=..., validation_alias="wasActive", serialization_alias="wasActive", description="Indicates whether the user performed any activity during the last heartbeat interval. Set to true if the user was active, or false if the session was idle.")
...
# Operation: sync_organization_segments
class SyncSegmentsRequestPath(StrictModel):
    provider: str = Field(default=..., description="Identifier for the Git provider hosting the organization. Use the short code for the desired provider.")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The organization's name as it appears on the Git provider, used to identify which organization's segments to synchronize.")
class SyncSegmentsRequest(StrictModel):
...
# Operation: get_organization_sla_config
class GetSlaConfigRequestPath(StrictModel):
    provider: str = Field(default=..., description="Identifier for the Git provider hosting the organization. Use the short code for the target platform (e.g., GitHub, GitLab, Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The organization's name as it appears on the Git provider. This must match the exact organization slug used in the provider's URL.")
class GetSlaConfigRequest(StrictModel):
    ...
    path: GetSlaConfigRequestPath

# Operation: update_security_sla
class UpdateSlaConfigRequestPath(StrictModel):
    provider: str = Field(default=..., description="The Git provider hosting the organization, identified by a short code (e.g., gh for GitHub, gl for GitLab, bb for Bitbucket).")
    remote_organization_name: str = Field(default=..., validation_alias="remoteOrganizationName", serialization_alias="remoteOrganizationName", description="The exact organization name as it appears on the Git provider platform.")
class UpdateSlaConfigRequestBodySlaConfig(StrictModel):
    critical_sla: int = Field(default=..., validation_alias="criticalSla", serialization_alias="criticalSla", description="Maximum number of days allowed to remediate critical severity security issues before the SLA is considered breached. Must be a positive integer.", json_schema_extra={'format': 'int32'})
    high_sla: int = Field(default=..., validation_alias="highSla", serialization_alias="highSla", description="Maximum number of days allowed to remediate high severity security issues before the SLA is considered breached. Must be a positive integer.", json_schema_extra={'format': 'int32'})
    medium_sla: int = Field(default=..., validation_alias="mediumSla", serialization_alias="mediumSla", description="Maximum number of days allowed to remediate medium severity security issues before the SLA is considered breached. Must be a positive integer.", json_schema_extra={'format': 'int32'})
    low_sla: int = Field(default=..., validation_alias="lowSla", serialization_alias="lowSla", description="Maximum number of days allowed to remediate low severity security issues before the SLA is considered breached. Must be a positive integer.", json_schema_extra={'format': 'int32'})
class UpdateSlaConfigRequestBody(StrictModel):
    """SLA Configuration Values"""
    sla_config: UpdateSlaConfigRequestBodySlaConfig = Field(default=..., validation_alias="slaConfig", serialization_alias="slaConfig")
class UpdateSlaConfigRequest(StrictModel):
    ...
    path: UpdateSlaConfigRequestPath
    body: UpdateSlaConfigRequestBody
...
# Operation: list_payment_plans
class ListPaymentPlansRequest(StrictModel):
    """Retrieves all available payment plans offered in Codacy, allowing users to review pricing tiers and subscription options."""

# Operation: get_ossf_scorecard
class GetOssfScorecardRequest(StrictModel):
...
class ConfiguredParametersList(PermissiveModel):
    value: list[ConfiguredParameter]
