"""
Authentication module for Codacy API MCP server.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    ...
    "get_repository_quality_settings": [["ApiKeyAuth"]],
    ...
    "set_build_server_analysis": [["ApiKeyAuth"]],
    ...
    "update_repository_commit_quality_settings": [["ApiKeyAuth"]],
    "reset_repository_commit_quality_settings": [["ApiKeyAuth"]],
    "reset_pull_request_quality_settings": [["ApiKeyAuth"]],
    "reset_repository_quality_settings": [["ApiKeyAuth"]],
    "get_pull_request_quality_settings": [["ApiKeyAuth"]],
    "update_pull_request_quality_settings": [["ApiKeyAuth"]],
    ...
    "delete_current_user": [["ApiKeyAuth"]],
    ...
    "get_email_notification_settings": [["ApiKeyAuth"]],
    "update_email_notification_settings": [["ApiKeyAuth"]],
    ...
    "sync_organization_billing": [["ApiKeyAuth"]],
    ...
    "set_organization_minimum_analysis_permission": [["ApiKeyAuth"]],
    ...
    "list_login_integrations": [],
    "list_provider_integrations": [],
    "get_configuration_status": [],
    "check_health": [],
    "search_entities": [["ApiKeyAuth"]],
    "get_admin_entity": [["ApiKeyAuth"]],
    "list_admin_entity_resources": [["ApiKeyAuth"]],
    "generate_license": [["ApiKeyAuth"]],
    "delete_dormant_accounts": [["ApiKeyAuth"]],
    "upload_pentest_report": [["ApiKeyAuth"]],
    ...
    "configure_jira_integration": [["ApiKeyAuth"]],
    ...
    "configure_slack_integration": [["ApiKeyAuth"]],
    "delete_slack_integration": [["ApiKeyAuth"]],
    ...
    "send_session_heartbeat": [["ApiKeyAuth"]],
    ...
    "sync_organization_segments": [["ApiKeyAuth"]],
    ...
    "get_organization_sla_config": [["ApiKeyAuth"]],
    "update_security_sla": [["ApiKeyAuth"]],
