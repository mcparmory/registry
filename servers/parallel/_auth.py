"""
Authentication module for Parallel MCP server.
...
class APIKeyAuth:
    """
    API Key authentication for Parallel API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "search_web": [["ApiKeyAuth"]],
    "extract_content_from_urls": [["ApiKeyAuth"]],
    "create_task_run": [["ApiKeyAuth"]],
    "get_task_run": [["ApiKeyAuth"]],
    "get_task_run_input": [["ApiKeyAuth"]],
    "get_task_run_result": [["ApiKeyAuth"]],
    "stream_task_run_events": [["ApiKeyAuth"]],
    "create_task_group": [["ApiKeyAuth"]],
    "get_taskgroup": [["ApiKeyAuth"]],
    "stream_task_group_events": [["ApiKeyAuth"]],
    "list_task_group_runs": [["ApiKeyAuth"]],
    "add_runs_to_task_group": [["ApiKeyAuth"]],
    "get_task_group_run": [["ApiKeyAuth"]],
    "create_findall_spec_from_objective": [["ApiKeyAuth"]],
    "create_findall_run": [["ApiKeyAuth"]],
    "list_monitors": [["ApiKeyAuth"]],
    "create_monitor": [["ApiKeyAuth"]],
    "list_monitors_paginated": [["ApiKeyAuth"]],
    "get_monitor": [["ApiKeyAuth"]],
    "update_monitor": [["ApiKeyAuth"]],
    "delete_monitor": [["ApiKeyAuth"]],
    "get_event_group": [["ApiKeyAuth"]],
    "list_monitor_events": [["ApiKeyAuth"]],
    "simulate_monitor_event": [["ApiKeyAuth"]]
}
