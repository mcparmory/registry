...
Generated: 2026-03-25 21:34:34 UTC
...
class PropertiesReRankingApplyFilter(PermissiveModel):
...
class BaseRecommendIndexSettings(StrictModel):
    ...
    re_ranking_apply_filter: PropertiesReRankingApplyFilter | None = Field(None, validation_alias="reRankingApplyFilter", serialization_alias="reRankingApplyFilter")
...
Order.model_rebuild()
PropertiesReRankingApplyFilter.model_rebuild()
