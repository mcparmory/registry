"""
Authentication module for Algolia Search MCP server.
...
class APIKeyAuth:
    """
    API Key authentication for Search API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "send_custom_post_request": [["appId", "apiKey"]],
    "search_multiple_indices": [["appId", "apiKey"]],
    "get_recommendations": [["appId", "apiKey"]]
}
