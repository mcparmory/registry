...
- `API_KEY` — API Key Authentication (xi-api-key)
...
Example (if server is at `/home/user/mcp-servers/elevenlabs`):
```json
{
  "mcpServers": {
    "elevenlabs": {
      "command": "python",
      "args": ["/home/user/mcp-servers/elevenlabs/server.py"]
    }
  }
}
```
