"""
Authentication module for Scrapingant MCP server.
...
class APIKeyAuth:
    """
    API Key authentication for Scrapingant API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "scrape_webpage": [["ApiKeyAuth"]],
    "scrape_webpage_submit": [["ApiKeyAuth"]],
    "scrape_webpage_replace": [["ApiKeyAuth"]],
    "scrape_webpage_modify": [["ApiKeyAuth"]],
    "scrape_webpage_remove": [["ApiKeyAuth"]],
