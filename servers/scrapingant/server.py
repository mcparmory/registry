...
mcp = FastMCP("Scrapingant API", middleware=[_JsonCoercionMiddleware()])
...
def validate_environment() -> None:
    ...
    if errors:
        ...
        print("  python scrapingant_api_server.py", file=sys.stderr)
        print("=" * 70, file=sys.stderr)
        sys.exit(1)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Scrapingant API MCP Server")
    ...
    logger = logging.getLogger(__name__)
    logger.info("Starting Scrapingant API MCP Server")
