...
- **Contact:** Canva Developer Community — [https://community.canva.dev/](https://community.canva.dev/)
- **Terms of Service:** [https://www.canva.com/trust/legal/](https://www.canva.com/trust/legal/)
...
Example (if server is at `/home/user/mcp-servers/canva`):
```json
{
  "mcpServers": {
    "canva": {
      "command": "python",
      "args": ["/home/user/mcp-servers/canva/server.py"]
    }
  }
}
```
...
```bash
docker build -t canva .
mkdir -p tokens
docker run -p 8000:8000 -p 9400:9400 -v ./tokens:/app/tokens --env-file .env canva
```
