...
class OAuth2Auth:
    """
    OAuth 2.0 authentication for Canva Connect API.
    ...
    Token Storage:
        Location: ./tokens/oauthauthcode_tokens.json
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://api.canva.com/rest/v1/oauth/token")
        self.auth_url = self._resolve_url_template("https://www.canva.com/api/oauth/authorize")
        self.refresh_url = None

        # Token storage (secure file-based, unique per scheme)
        self.token_dir = Path(__file__).parent / "tokens"
        self.token_file = self.token_dir / "oauthauthcode_tokens.json"
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "get_asset": [["oauthAuthCode"]],
    "update_asset": [["oauthAuthCode"]],
    "delete_asset": [["oauthAuthCode"]],
    "upload_asset": [["oauthAuthCode"]],
    "get_asset_upload_job": [["oauthAuthCode"]],
    "initiate_url_asset_upload": [["oauthAuthCode"]],
    "get_asset_upload_job_from_url": [["oauthAuthCode"]],
    "autofill_design": [["oauthAuthCode"]],
    "get_autofill_job": [["oauthAuthCode"]],
    "list_brand_templates": [["oauthAuthCode"]],
    "get_brand_template": [["oauthAuthCode"]],
    "get_brand_template_dataset": [["oauthAuthCode"]],
    "list_comment_replies": [["oauthAuthCode"]],
    "create_comment_reply": [["oauthAuthCode"]],
    "get_comment_thread": [["oauthAuthCode"]],
    "get_comment_reply": [["oauthAuthCode"]],
    "create_comment": [["oauthAuthCode"]],
    "list_designs": [["oauthAuthCode"]],
    "create_design": [["oauthAuthCode"]],
    "get_design": [["oauthAuthCode"]],
    "list_design_pages": [["oauthAuthCode"]],
    "list_design_export_formats": [["oauthAuthCode"]],
    "import_design": [["oauthAuthCode"]],
    "get_design_import_job": [["oauthAuthCode"]],
    "import_design_from_url": [["oauthAuthCode"]],
    "get_url_import_job": [["oauthAuthCode"]],
    "start_design_export": [["oauthAuthCode"]],
    "get_design_export_job": [["oauthAuthCode"]],
    "get_folder": [["oauthAuthCode"]],
    "rename_folder": [["oauthAuthCode"]],
    "delete_folder": [["oauthAuthCode"]],
    "list_folder_items": [["oauthAuthCode"]],
    "move_item": [["oauthAuthCode"]],
    "create_folder": [["oauthAuthCode"]],
    "get_current_user_info": [["oauthAuthCode"]],
    "start_design_resize_job": [["oauthAuthCode"]],
    "get_resize_job": [["oauthAuthCode"]],
    "get_current_user": [["oauthAuthCode"]],
    "list_user_capabilities": [["oauthAuthCode"]],
    "get_user_profile": [["oauthAuthCode"]]
}
