"""
E2b Api MCP Server - Pydantic Models
...
class PostV2TemplatesBuildsRequestBody(StrictModel):
    ...
    from_image_registry: Annotated[AwsRegistry | GcpRegistry | GeneralRegistry, Field(discriminator="type_")] | None = Field(default=None, validation_alias="fromImageRegistry", serialization_alias="fromImageRegistry", description="Optional image registry configuration for sourcing or pushing build artifacts. Pass as a JSON-encoded string with a \"type\" discriminator field, e.g. '{\"type\": \"value\", ...}'.")
