"""
Bright Data Api MCP Server - Pydantic Models
...
__all__ = [
    ...
    "GetZoneGetActiveZonesRequest",
    "GetZoneGetAllZonesRequest",
    "GetZoneIpsRequest",
    "GetZoneIpsUnavailableRequest",
    "GetZonePasswordsRequest",
    "GetZonePermissionsRequest",
...
# Operation: list_countries_by_zone
class GetCountrieslistRequest(StrictModel):
...
class GetCustomerBalanceRequest(StrictModel):
...
class GetNetworkStatusRequestPath(StrictModel):
    network_type: Literal["all", "res", "dc", "mobile"] = Field(default=..., validation_alias="NETWORK_TYPE", serialization_alias="NETWORK_TYPE", description="The category of proxy network to retrieve status for. Use 'all' to get a combined status overview, or specify a network type to narrow results to residential, datacenter, or mobile proxies.")
class GetNetworkStatusRequest(StrictModel):
    ...
    path: GetNetworkStatusRequestPath
...
class PutStatusRequestBody(StrictModel):
    status: Literal["suspend_manual", "active"] | None = Field(default=None, description="The desired status to apply: use 'suspend_manual' to manually suspend the resource, or 'active' to activate it.")
class PutStatusRequest(StrictModel):
    """Updates the operational status of the resource, allowing it to be either manually suspended or set back to active."""
    body: PutStatusRequestBody | None = None
...
# Operation: remove_zone_domain_permission
class DeleteZoneDomainPermRequestBody(StrictModel):
    zone: str = Field(default=..., description="The name of the zone from which the domain permission will be removed.")
    type_: Literal["whitelist", "blacklist"] = Field(default=..., validation_alias="type", serialization_alias="type", description="Specifies whether to remove the domain(s) from the allowlist ('whitelist') or the denylist ('blacklist').")
    domain: str = Field(default=..., description="One or more domains to remove from the specified list, provided as a space-separated string.")
class DeleteZoneDomainPermRequest(StrictModel):
    ...
    body: DeleteZoneDomainPermRequestBody

# Operation: list_active_zones
class GetZoneGetActiveZonesRequest(StrictModel):
...
class GetZoneGetAllZonesRequest(StrictModel):
...
# Operation: list_unavailable_zone_ips
class GetZoneIpsUnavailableRequest(StrictModel):
...
# Operation: list_zone_permissions
class GetZonePermissionsRequestQuery(StrictModel):
    zone: str = Field(default=..., description="The identifier of the zone whose permissions should be retrieved.")
class GetZonePermissionsRequest(StrictModel):
    ...
    query: GetZonePermissionsRequestQuery
