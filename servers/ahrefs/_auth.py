...
class OAuth2Auth:
    """
    OAuth 2.0 authentication for Ahrefs API.
    ...
    Token Storage:
        Location: ./tokens/ahrefsconnectoauth_tokens.json
        Permissions: 0o600 (owner read/write only)
        Format: JSON with access_token, refresh_token, expires_at

    URLs:
        Authorization URL: https://app.ahrefs.com/web/oauth/authorize
        Token URL: https://ahrefs.com/oauth/token
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://ahrefs.com/oauth/token")
        self.auth_url = self._resolve_url_template("https://app.ahrefs.com/web/oauth/authorize")
        self.refresh_url = None

        # Token storage (secure file-based, unique per scheme)
        self.token_dir = Path(__file__).parent / "tokens"
        self.token_file = self.token_dir / "ahrefsconnectoauth_tokens.json"
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "get_domain_rating": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_backlinks_stats": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_outlinks_stats": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_domain_metrics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_refdomains_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_domain_rating_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_url_rating_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_page_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_domain_metrics_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_keyword_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_country_metrics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_pages_by_traffic": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_search_volume_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_backlinks": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_broken_backlinks": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_refdomains": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_anchor_text": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_organic_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_organic_competitors": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_top_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_paid_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_pages_by_backlinks": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_pages_by_internal_links": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_linked_domains": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_external_anchors": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_internal_anchors": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_keyword_metrics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_keyword_volume_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_keyword_volume_by_country": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "search_matching_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_related_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "search_keyword_suggestions": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_audit_projects": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_audit_issues": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_page_content": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_audit_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_rank_tracker_overview": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_serp_overview": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_competitor_rankings": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_competitor_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_competitor_stats": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_serp_overview_keyword": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "analyze_targets_batch": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_subscription_limits_and_usage": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_projects": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "create_project": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "update_project_access": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_project_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "add_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "delete_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_project_competitors": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "add_competitors": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "delete_competitors": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_locations": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_keyword_list_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "add_keywords_to_list": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "delete_keyword_list_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_brand_radar_prompts": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "create_brand_radar_prompt": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "delete_brand_radar_prompts": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_brand_radar_reports": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "create_brand_radar_report": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "update_brand_radar_report": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_ai_responses": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_cited_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_cited_domains": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_brand_radar_impression_overviews": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_brand_mentions_overview": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_share_of_voice_overview": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_brand_mention_impressions_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_brand_mention_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_brand_sov_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_web_analytics_stats": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_web_analytics_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_source_channels": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_source_channels_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_traffic_sources": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_traffic_sources_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_referrers": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_referrers_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_utm_parameters": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_utm_params_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_entry_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_entry_pages_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_exit_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_exit_pages_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_top_pages_by_pageviews": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_top_pages_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_web_analytics_by_city": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_web_analytics_cities_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_continent_analytics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_continents_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_web_analytics_by_country": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_countries_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_language_analytics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_language_analytics_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_browser_analytics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_browser_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_browser_versions": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_browser_versions_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_device_analytics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_devices_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_operating_systems_analytics": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_operating_systems_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_operating_system_versions": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_operating_system_versions_chart": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_search_performance_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_keyword_position_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_page_history_gsc": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_device_performance": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_gsc_metrics_by_country": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_ctr_by_position": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_search_performance_by_position": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_keyword_history_gsc": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_gsc_keywords": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "get_page_history": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_gsc_pages": [["bearerAuth"], ["AhrefsConnectOAuth"]],
    "list_anonymous_queries": [["bearerAuth"], ["AhrefsConnectOAuth"]]
}
