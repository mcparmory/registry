...
class OAuth2Auth:
    """
    OAuth 2.0 authentication for Outline API.
    ...
    URLs:
        ...
        Token URL: https://app.getoutline.com/oauth/token
        Refresh URL: https://app.getoutline.com/oauth/token
    ...
    def __init__(self):
        ...
        self.token_url = self._resolve_url_template("https://app.getoutline.com/oauth/token")
        self.auth_url = self._resolve_url_template("https://app.getoutline.com/oauth/authorize")
        self.refresh_url = self._resolve_url_template("https://app.getoutline.com/oauth/token")
...
class BearerTokenAuth:
    """
    Bearer token authentication for Outline API.
...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    "create_attachment": [["OAuth2"], ["BearerAuth"]],
    "get_attachment": [["OAuth2"], ["BearerAuth"]],
    "delete_attachment": [["OAuth2"], ["BearerAuth"]],
    "get_auth_info": [["OAuth2"], ["BearerAuth"]],
    "get_collection": [["OAuth2"], ["BearerAuth"]],
    "get_collection_document_structure": [["OAuth2"], ["BearerAuth"]],
    "list_collections": [["OAuth2"], ["BearerAuth"]],
    "create_collection": [["OAuth2"], ["BearerAuth"]],
    "update_collection": [["OAuth2"], ["BearerAuth"]],
    "add_user_to_collection": [["OAuth2"], ["BearerAuth"]],
    "remove_user_from_collection": [["OAuth2"], ["BearerAuth"]],
    "list_collection_memberships": [["OAuth2"], ["BearerAuth"]],
    "add_group_to_collection": [["OAuth2"], ["BearerAuth"]],
    "remove_group_from_collection": [["OAuth2"], ["BearerAuth"]],
    "list_collection_group_memberships": [["OAuth2"], ["BearerAuth"]],
    "delete_collection": [["OAuth2"], ["BearerAuth"]],
    "export_collection": [["OAuth2"], ["BearerAuth"]],
    "export_all_collections": [["OAuth2"], ["BearerAuth"]],
    "create_comment_on_document": [["OAuth2"], ["BearerAuth"]],
    "get_comment": [["OAuth2"], ["BearerAuth"]],
    "update_comment": [["OAuth2"], ["BearerAuth"]],
    "delete_comment": [["OAuth2"], ["BearerAuth"]],
    "list_comments": [["OAuth2"], ["BearerAuth"]],
    "get_data_attribute": [["OAuth2"], ["BearerAuth"]],
    "list_data_attributes": [["OAuth2"], ["BearerAuth"]],
    "update_data_attribute": [["OAuth2"], ["BearerAuth"]],
    "delete_data_attribute": [["OAuth2"], ["BearerAuth"]],
    "get_document": [["OAuth2"], ["BearerAuth"]],
    "create_document_from_file": [["OAuth2"], ["BearerAuth"]],
    "export_document": [["OAuth2"], ["BearerAuth"]],
    "list_documents": [["OAuth2"], ["BearerAuth"]],
    "get_document_children": [["OAuth2"], ["BearerAuth"]],
    "list_draft_documents": [["OAuth2"], ["BearerAuth"]],
    "list_viewed_documents": [["OAuth2"], ["BearerAuth"]],
    "search_documents_with_question": [["OAuth2"], ["BearerAuth"]],
    "search_document_titles": [["OAuth2"], ["BearerAuth"]],
    "search_documents": [["OAuth2"], ["BearerAuth"]],
    "create_document": [["OAuth2"], ["BearerAuth"]],
    "update_document": [["OAuth2"], ["BearerAuth"]],
    "create_template_from_document": [["OAuth2"], ["BearerAuth"]],
    "unpublish_document": [["OAuth2"], ["BearerAuth"]],
    "move_document": [["OAuth2"], ["BearerAuth"]],
    "archive_document": [["OAuth2"], ["BearerAuth"]],
    "restore_document": [["OAuth2"], ["BearerAuth"]],
    "delete_document": [["OAuth2"], ["BearerAuth"]],
    "list_document_users": [["OAuth2"], ["BearerAuth"]],
    "list_document_memberships": [["OAuth2"], ["BearerAuth"]],
    "add_user_to_document": [["OAuth2"], ["BearerAuth"]],
    "remove_user_from_document": [["OAuth2"], ["BearerAuth"]],
    "list_archived_documents": [["OAuth2"], ["BearerAuth"]],
    "list_deleted_documents": [["OAuth2"], ["BearerAuth"]],
    "duplicate_document": [["OAuth2"], ["BearerAuth"]],
    "add_group_to_document": [["OAuth2"], ["BearerAuth"]],
    "remove_group_from_document": [["OAuth2"], ["BearerAuth"]],
    "list_document_group_memberships": [["OAuth2"], ["BearerAuth"]],
    "delete_all_trash": [["OAuth2"], ["BearerAuth"]],
    "list_events": [["OAuth2"], ["BearerAuth"]],
    "get_file_operation": [["OAuth2"], ["BearerAuth"]],
    "delete_file_operation": [["OAuth2"], ["BearerAuth"]],
    "get_file_redirect": [["OAuth2"], ["BearerAuth"]],
    "list_file_operations": [["OAuth2"], ["BearerAuth"]],
    ...
    "list_group_memberships": [["OAuth2"], ["BearerAuth"]],
    "add_user_to_group": [["OAuth2"], ["BearerAuth"]],
    "remove_user_from_group": [["OAuth2"], ["BearerAuth"]],
    "get_oauth_client": [["OAuth2"], ["BearerAuth"]],
    "list_oauth_clients": [["OAuth2"], ["BearerAuth"]],
    "update_oauth_client": [["OAuth2"], ["BearerAuth"]],
    "rotate_oauth_client_secret": [["OAuth2"], ["BearerAuth"]],
    "delete_oauth_client": [["OAuth2"], ["BearerAuth"]],
    "list_oauth_authentications": [["OAuth2"], ["BearerAuth"]],
    "revoke_oauth_authentication": [["OAuth2"], ["BearerAuth"]],
    "get_revision": [["OAuth2"], ["BearerAuth"]],
    "list_revisions": [["OAuth2"], ["BearerAuth"]],
    "get_share_by_document": [["OAuth2"], ["BearerAuth"]],
    "list_shares": [["OAuth2"], ["BearerAuth"]],
    "create_share": [["OAuth2"], ["BearerAuth"]],
    "update_share_published_status": [["OAuth2"], ["BearerAuth"]],
    "revoke_share": [["OAuth2"], ["BearerAuth"]],
    "add_star": [["OAuth2"], ["BearerAuth"]],
    "list_starred_documents": [["OAuth2"], ["BearerAuth"]],
    "update_star": [["OAuth2"], ["BearerAuth"]],
    "remove_star": [["OAuth2"], ["BearerAuth"]],
    "send_user_invites": [["OAuth2"], ["BearerAuth"]],
    "get_user": [["OAuth2"], ["BearerAuth"]],
    "list_users": [["OAuth2"], ["BearerAuth"]],
    "update_user": [["OAuth2"], ["BearerAuth"]],
    "update_user_role": [["OAuth2"], ["BearerAuth"]],
    "suspend_user": [["OAuth2"], ["BearerAuth"]],
    "activate_user": [["OAuth2"], ["BearerAuth"]],
    "delete_user": [["OAuth2"], ["BearerAuth"]],
    "list_document_views": [["OAuth2"], ["BearerAuth"]],
    "create_view_for_document": [["OAuth2"], ["BearerAuth"]],
    "create_template": [["OAuth2"], ["BearerAuth"]],
    "list_templates": [["OAuth2"], ["BearerAuth"]],
    "get_template": [["OAuth2"], ["BearerAuth"]],
    "update_template": [["OAuth2"], ["BearerAuth"]],
    "delete_template": [["OAuth2"], ["BearerAuth"]],
    "restore_template": [["OAuth2"], ["BearerAuth"]],
    "duplicate_template": [["OAuth2"], ["BearerAuth"]]
}
