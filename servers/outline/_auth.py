...
class OAuth2Auth:
    ...
    def __init__(self):
        ...
        self.token_url = "https://app.getoutline.com/oauth/token"
        self.auth_url = "https://app.getoutline.com/oauth/authorize"
        self.refresh_url = "https://app.getoutline.com/oauth/token"
