...
OPERATION_AUTH_MAP: dict[str, list[list[str]]] = {
    ...
    "list_call_activities": [["oauth2"], ["basicAuth"]],
    "log_call_activity": [["oauth2"], ["basicAuth"]],
    "get_call_activity": [["oauth2"], ["basicAuth"]],
    "update_call_activity": [["oauth2"], ["basicAuth"]],
    "delete_call_activity": [["oauth2"], ["basicAuth"]],
    "list_created_activities": [["oauth2"], ["basicAuth"]],
    "get_activity_created": [["oauth2"], ["basicAuth"]],
    "list_email_activities": [["oauth2"], ["basicAuth"]],
    "create_email_activity": [["oauth2"], ["basicAuth"]],
    ...
    "search_meeting_by_calendar_event": [["oauth2"], ["basicAuth"]],
    ...
    "list_activity_notes": [["oauth2"], ["basicAuth"]],
    "create_note": [["oauth2"], ["basicAuth"]],
    "get_activity_note": [["oauth2"], ["basicAuth"]],
    ...
    "list_completed_tasks": [["oauth2"], ["basicAuth"]],
    ...
    "bulk_update_tasks": [["oauth2"], ["basicAuth"]],
    ...
    "get_dialer_session": [["oauth2"], ["basicAuth"]],
    ...
    "bulk_subscribe_sequence": [["oauth2"], ["basicAuth"]],
    "get_bulk_sequence_subscription": [["oauth2"], ["basicAuth"]],
    "list_bulk_deletes": [["oauth2"], ["basicAuth"]],
    "delete_leads_bulk": [["oauth2"], ["basicAuth"]],
    "get_bulk_delete_action": [["oauth2"], ["basicAuth"]],
    ...
    "export_records": [["oauth2"], ["basicAuth"]],
    ...
    "create_or_update_scheduling_link": [["oauth2"], ["basicAuth"]],
    "delete_scheduling_link_integration": [["oauth2"], ["basicAuth"]],
    ...
    "map_shared_scheduling_link": [["oauth2"], ["basicAuth"]],
    "unmap_shared_scheduling_link": [["oauth2"], ["basicAuth"]],
    ...
    "update_custom_object_field": [["oauth2"], ["basicAuth"]],
    "delete_custom_object_field": [["oauth2"], ["basicAuth"]],
